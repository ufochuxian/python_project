...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/k;->ae:Ljava/util/ArrayList;
...
.method public static b(Ljava/util/ArrayList;)Landroid/support/constraint/solver/widgets/h;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->z()I
    ...
    .line 206
    :cond_1
    invoke-virtual {v6}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->A()I
    ...
    invoke-virtual {v0, v4, v5, v8, v9}, Landroid/support/constraint/solver/widgets/h;->a(IIII)V
...
.method public Z()V
    ...
    .line 248
    iget-object v3, p0, Landroid/support/constraint/solver/widgets/k;->ae:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->F()I

    move-result v3

    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->G()I
...
.method public a(FF)Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 136
    .local v7, "t":I
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->B()I
    ...
    .line 137
    .local v6, "r":I
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->D()I
    ...
    .local v3, "i":I
    iget-object v9, p0, Landroid/support/constraint/solver/widgets/k;->ae:Ljava/util/ArrayList;
    ...
    instance-of v9, v8, Landroid/support/constraint/solver/widgets/k;

    if-eqz v9, :cond_2

    .line 144
    check-cast v8, Landroid/support/constraint/solver/widgets/k;

    .end local v8    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    invoke-virtual {v8, p1, p2}, Landroid/support/constraint/solver/widgets/k;->a(FF)Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    :cond_2
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->F()I

    move-result v4

    .line 150
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->G()I

    move-result v7

    .line 151
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->B()I
    ...
    .line 152
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->D()I
...
.method public a(Landroid/support/constraint/solver/e;)V
    ...
    .prologue
    .line 280
    invoke-super {p0, p1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->a(Landroid/support/constraint/solver/e;)V
    ...
    .line 284
    .local v2, "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    invoke-virtual {v2, p1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->a(Landroid/support/constraint/solver/e;)V
...
.method public ao()V
    ...
    .prologue
    .line 265
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->Z()V
    ...
    .line 272
    .local v2, "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    instance-of v3, v2, Landroid/support/constraint/solver/widgets/k;

    if-eqz v3, :cond_2

    .line 273
    check-cast v2, Landroid/support/constraint/solver/widgets/k;

    .end local v2    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    invoke-virtual {v2}, Landroid/support/constraint/solver/widgets/k;->ao()V
...
.method public as()Ljava/util/ArrayList;
    ...
    .prologue
    .line 96
    iget-object v0, p0, Landroid/support/constraint/solver/widgets/k;->ae:Ljava/util/ArrayList;

    return-object v0
.end method

.method public at()Landroid/support/constraint/solver/widgets/e;
    .locals 4
    ...
    instance-of v3, v1, Landroid/support/constraint/solver/widgets/e;
...
.method public c(IIII)Ljava/util/ArrayList;
    ...
    .line 173
    .local v0, "area":Landroid/support/constraint/solver/widgets/h;
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/constraint/solver/widgets/h;->a(IIII)V

    .line 174
    const/4 v3, 0x0

    .local v3, "i":I
    iget-object v6, p0, Landroid/support/constraint/solver/widgets/k;->ae:Ljava/util/ArrayList;
    ...
    .line 177
    .local v1, "bounds":Landroid/support/constraint/solver/widgets/h;
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->F()I
    ...
    .line 178
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->B()I
    ...
    .line 177
    invoke-virtual {v1, v6, v7, v8, v9}, Landroid/support/constraint/solver/widgets/h;->a(IIII)V

    .line 179
    invoke-virtual {v0, v1}, Landroid/support/constraint/solver/widgets/h;->a(Landroid/support/constraint/solver/widgets/h;)Z
    ...
    .line 183
    .end local v1    # "bounds":Landroid/support/constraint/solver/widgets/h;
...
.method public c(II)V
    ...
    .line 237
    .local v2, "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->L()I

    move-result v3

    invoke-virtual {p0}, Landroid/support/constraint/solver/widgets/k;->M()I
...
.method public g(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .prologue
    .line 72
    iget-object v1, p0, Landroid/support/constraint/solver/widgets/k;->ae:Ljava/util/ArrayList;
    ...
    .line 75
    .local v0, "container":Landroid/support/constraint/solver/widgets/k;
    invoke-virtual {v0, p1}, Landroid/support/constraint/solver/widgets/k;->h(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V

    .line 77
    .end local v0    # "container":Landroid/support/constraint/solver/widgets/k;
    :cond_0
...
.method public m()V
    ...
    .line 294
    .local v2, "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    invoke-virtual {v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->m()V
