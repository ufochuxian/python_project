.class Landroid/support/constraint/solver/widgets/i$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/constraint/solver/widgets/i;
.end annotation
...
.method public constructor <init>(Landroid/support/constraint/solver/widgets/ConstraintAnchor;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/constraint/solver/widgets/i$a;->a:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/i$a;->b:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    iput v0, p0, Landroid/support/constraint/solver/widgets/i$a;->c:I
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/i$a;->d:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Strength;
    ...
    iput v0, p0, Landroid/support/constraint/solver/widgets/i$a;->e:I
...
.method public a(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 61
    iget-object v0, p0, Landroid/support/constraint/solver/widgets/i$a;->a:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/i$a;->a:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 69
    iput v1, p0, Landroid/support/constraint/solver/widgets/i$a;->c:I
    ...
    .line 71
    iput v1, p0, Landroid/support/constraint/solver/widgets/i$a;->e:I
...
.method public b(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .prologue
    .line 81
    iget-object v1, p0, Landroid/support/constraint/solver/widgets/i$a;->a:Landroid/support/constraint/solver/widgets/ConstraintAnchor;

    invoke-virtual {v1}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->d()Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;

    move-result-object v1

    invoke-virtual {p1, v1}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->a(Landroid/support/constraint/solver/widgets/ConstraintAnchor$Type;)Landroid/support/constraint/solver/widgets/ConstraintAnchor;

    move-result-object v0

    .line 82
    .local v0, "anchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    iget-object v1, p0, Landroid/support/constraint/solver/widgets/i$a;->b:Landroid/support/constraint/solver/widgets/ConstraintAnchor;

    iget v2, p0, Landroid/support/constraint/solver/widgets/i$a;->c:I

    iget-object v3, p0, Landroid/support/constraint/solver/widgets/i$a;->d:Landroid/support/constraint/solver/widgets/ConstraintAnchor$Strength;

    iget v4, p0, Landroid/support/constraint/solver/widgets/i$a;->e:I
