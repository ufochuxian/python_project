...
.method constructor <init>(Landroid/support/e/a/i$f;)V
    .locals 3
    .param p1, "state"    # Landroid/support/e/a/i$f;
...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/e/a/i;
    ...
    .line 579
    .local v1, "drawable":Landroid/support/e/a/i;
    ...
    iput-object v5, v1, Landroid/support/e/a/i;->c:Landroid/graphics/drawable/Drawable;

    .line 580
    new-instance v5, Landroid/support/e/a/i$g;

    iget-object v6, v1, Landroid/support/e/a/i;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v5, v6}, Landroid/support/e/a/i$g;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v5, v1, Landroid/support/e/a/i;->u:Landroid/graphics/drawable/Drawable$ConstantState;

    .line 602
    .end local v1    # "drawable":Landroid/support/e/a/i;
    :goto_0
    return-object v1
    ...
    :cond_3
    :try_start_1
    invoke-static {p0, v3, v0, p2}, Landroid/support/e/a/i;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/e/a/i;
    :try_end_1
...
.method public static a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/e/a/i;
    ...
    .line 615
    .local v0, "drawable":Landroid/support/e/a/i;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 692
    iget-object v4, p0, Landroid/support/e/a/i;->p:Landroid/support/e/a/i$f;

    .line 693
    .local v4, "state":Landroid/support/e/a/i$f;
    iget-object v3, v4, Landroid/support/e/a/i$f;->b:Landroid/support/e/a/i$e;

    .line 698
    .local v3, "pathRenderer":Landroid/support/e/a/i$e;
    ...
    invoke-static {p1, p2, v6, v7, v8}, Landroid/support/e/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {v1, v6}, Landroid/support/e/a/i;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v6

    iput-object v6, v4, Landroid/support/e/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 705
    iput-object v5, v4, Landroid/support/e/a/i$f;->c:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v8, v4, Landroid/support/e/a/i$f;->e:Z

    invoke-static {p1, p2, v6, v7, v8}, Landroid/support/e/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z

    move-result v6

    iput-boolean v6, v4, Landroid/support/e/a/i$f;->e:Z
    ...
    iget v8, v3, Landroid/support/e/a/i$e;->d:F

    invoke-static {p1, p2, v6, v7, v8}, Landroid/support/e/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v6

    iput v6, v3, Landroid/support/e/a/i$e;->d:F
    ...
    iget v8, v3, Landroid/support/e/a/i$e;->e:F

    invoke-static {p1, p2, v6, v7, v8}, Landroid/support/e/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v6

    iput v6, v3, Landroid/support/e/a/i$e;->e:F

    .line 719
    iget v6, v3, Landroid/support/e/a/i$e;->d:F
    ...
    .line 722
    :cond_1
    iget v6, v3, Landroid/support/e/a/i$e;->e:F
    ...
    iget v7, v3, Landroid/support/e/a/i$e;->b:F

    invoke-virtual {p1, v6, v7}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v6

    iput v6, v3, Landroid/support/e/a/i$e;->b:F

    .line 729
    const/4 v6, 0x2

    iget v7, v3, Landroid/support/e/a/i$e;->c:F

    invoke-virtual {p1, v6, v7}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v6

    iput v6, v3, Landroid/support/e/a/i$e;->c:F

    .line 731
    iget v6, v3, Landroid/support/e/a/i$e;->b:F
    ...
    .line 734
    :cond_3
    iget v6, v3, Landroid/support/e/a/i$e;->c:F
    ...
    .line 741
    invoke-virtual {v3}, Landroid/support/e/a/i$e;->getAlpha()F
    ...
    invoke-virtual {v3, v0}, Landroid/support/e/a/i$e;->setAlpha(F)V
    ...
    .line 746
    iput-object v2, v3, Landroid/support/e/a/i$e;->g:Ljava/lang/String;

    .line 747
    iget-object v6, v3, Landroid/support/e/a/i$e;->h:Landroid/support/v4/k/a;

    invoke-virtual {v6, v2, v3}, Landroid/support/v4/k/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a(Landroid/support/e/a/i$c;I)V
    .locals 6
    .param p1, "currentGroup"    # Landroid/support/e/a/i$c;
    .param p2, "level"    # I
    ...
    instance-of v3, v0, Landroid/support/e/a/i$c;
    ...
    invoke-direct {p0, v0, v3}, Landroid/support/e/a/i;->a(Landroid/support/e/a/i$c;I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/e/a/i$d;->a(I)V
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v12, v0, Landroid/support/e/a/i;->p:Landroid/support/e/a/i$f;

    .line 754
    .local v12, "state":Landroid/support/e/a/i$f;
    iget-object v11, v12, Landroid/support/e/a/i$f;->b:Landroid/support/e/a/i$e;

    .line 755
    .local v11, "pathRenderer":Landroid/support/e/a/i$e;
    const/4 v9, 0x1
    ...
    .line 760
    .local v6, "groupStack":Ljava/util/Stack;, "Ljava/util/Stack<Landroid/support/e/a/i$c;>;"
    iget-object v15, v11, Landroid/support/e/a/i$e;->a:Landroid/support/e/a/i$c;
    ...
    check-cast v4, Landroid/support/e/a/i$c;

    .line 771
    .local v4, "currentGroup":Landroid/support/e/a/i$c;
    ...
    .line 772
    new-instance v10, Landroid/support/e/a/i$b;

    invoke-direct {v10}, Landroid/support/e/a/i$b;-><init>()V

    .line 773
    .local v10, "path":Landroid/support/e/a/i$b;
    ...
    invoke-virtual {v10, v0, v1, v2, v3}, Landroid/support/e/a/i$b;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    .line 774
    iget-object v15, v4, Landroid/support/e/a/i$c;->a:Ljava/util/ArrayList;

    invoke-virtual {v15, v10}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 775
    invoke-virtual {v10}, Landroid/support/e/a/i$b;->getPathName()Ljava/lang/String;
    ...
    .line 776
    iget-object v15, v11, Landroid/support/e/a/i$e;->h:Landroid/support/v4/k/a;
    ...
    invoke-virtual {v15, v0, v10}, Landroid/support/v4/k/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 779
    iget v15, v12, Landroid/support/e/a/i$f;->a:I

    iget v0, v10, Landroid/support/e/a/i$b;->o:I

    move/from16 v16, v0

    or-int v15, v15, v16

    iput v15, v12, Landroid/support/e/a/i$f;->a:I

    .line 805
    .end local v4    # "currentGroup":Landroid/support/e/a/i$c;
    .end local v10    # "path":Landroid/support/e/a/i$b;
    ...
    .line 780
    .restart local v4    # "currentGroup":Landroid/support/e/a/i$c;
    ...
    .line 781
    new-instance v10, Landroid/support/e/a/i$a;

    invoke-direct {v10}, Landroid/support/e/a/i$a;-><init>()V

    .line 782
    .local v10, "path":Landroid/support/e/a/i$a;
    move-object/from16 v0, p1
    ...
    invoke-virtual {v10, v0, v1, v2, v3}, Landroid/support/e/a/i$a;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 784
    invoke-virtual {v10}, Landroid/support/e/a/i$a;->getPathName()Ljava/lang/String;
    ...
    iget v0, v10, Landroid/support/e/a/i$a;->o:I
    ...
    .line 788
    .end local v10    # "path":Landroid/support/e/a/i$a;
    :cond_5
    ...
    .line 789
    new-instance v8, Landroid/support/e/a/i$c;

    invoke-direct {v8}, Landroid/support/e/a/i$c;-><init>()V

    .line 790
    .local v8, "newChildGroup":Landroid/support/e/a/i$c;
    move-object/from16 v0, p1
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/support/e/a/i$c;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 793
    invoke-virtual {v8}, Landroid/support/e/a/i$c;->getGroupName()Ljava/lang/String;
    ...
    invoke-virtual {v15, v0, v8}, Landroid/support/v4/k/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 797
    :cond_6
    iget v15, v12, Landroid/support/e/a/i$f;->a:I

    iget v0, v8, Landroid/support/e/a/i$c;->c:I
    ...
    .line 799
    .end local v4    # "currentGroup":Landroid/support/e/a/i$c;
    .end local v8    # "newChildGroup":Landroid/support/e/a/i$c;
    .end local v14    # "tagName":Ljava/lang/String;
    :cond_7
    const/4 v15, 0x3
...
.method public a()F
    ...
    .line 549
    iget-object v6, p0, Landroid/support/e/a/i;->p:Landroid/support/e/a/i$f;

    if-nez v6, :cond_0

    iget-object v6, p0, Landroid/support/e/a/i;->p:Landroid/support/e/a/i$f;

    iget-object v6, v6, Landroid/support/e/a/i$f;->b:Landroid/support/e/a/i$e;
    ...
    iget v6, v6, Landroid/support/e/a/i$e;->b:F
    ...
    iget v6, v6, Landroid/support/e/a/i$e;->c:F
    ...
    iget v6, v6, Landroid/support/e/a/i$e;->e:F
    ...
    iget v6, v6, Landroid/support/e/a/i$e;->d:F
    ...
    iget v1, v6, Landroid/support/e/a/i$e;->b:F
    ...
    iget v0, v6, Landroid/support/e/a/i$e;->c:F
    ...
    iget v5, v6, Landroid/support/e/a/i$e;->d:F
    ...
    iget v4, v6, Landroid/support/e/a/i$e;->e:F
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 304
    iget-object v9, p0, Landroid/support/e/a/i;->c:Landroid/graphics/drawable/Drawable;
    ...
    .line 310
    :cond_1
    iget-object v9, p0, Landroid/support/e/a/i;->x:Landroid/graphics/Rect;

    invoke-virtual {p0, v9}, Landroid/support/e/a/i;->copyBounds(Landroid/graphics/Rect;)V
    ...
    .line 317
    iget-object v9, p0, Landroid/support/e/a/i;->r:Landroid/graphics/ColorFilter;

    if-nez v9, :cond_6

    iget-object v4, p0, Landroid/support/e/a/i;->q:Landroid/graphics/PorterDuffColorFilter;

    .line 323
    .local v4, "colorFilter":Landroid/graphics/ColorFilter;
    :goto_1
    iget-object v9, p0, Landroid/support/e/a/i;->w:Landroid/graphics/Matrix;
    ...
    iget-object v10, p0, Landroid/support/e/a/i;->v:[F

    invoke-virtual {v9, v10}, Landroid/graphics/Matrix;->getValues([F)V

    .line 325
    iget-object v9, p0, Landroid/support/e/a/i;->v:[F
    ...
    iget-object v10, p0, Landroid/support/e/a/i;->x:Landroid/graphics/Rect;
    ...
    .line 361
    iget-object v9, p0, Landroid/support/e/a/i;->p:Landroid/support/e/a/i$f;

    invoke-virtual {v9, v8, v7}, Landroid/support/e/a/i$f;->b(II)V

    .line 362
    iget-boolean v9, p0, Landroid/support/e/a/i;->t:Z
    ...
    invoke-virtual {v9, v8, v7}, Landroid/support/e/a/i$f;->a(II)V
    ...
    invoke-virtual {v9, p1, v4, v10}, Landroid/support/e/a/i$f;->a(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
    ...
    :cond_6
    iget-object v4, p0, Landroid/support/e/a/i;->r:Landroid/graphics/ColorFilter;
    ...
    invoke-virtual {v9}, Landroid/support/e/a/i$f;->b()Z
    ...
    invoke-virtual {v9}, Landroid/support/e/a/i$f;->c()V
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .prologue
    .line 641
    iget-object v3, p0, Landroid/support/e/a/i;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v3, p1, p2, p3, p4}, Landroid/support/v4/d/a/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 647
    .local v2, "state":Landroid/support/e/a/i$f;
    new-instance v1, Landroid/support/e/a/i$e;

    invoke-direct {v1}, Landroid/support/e/a/i$e;-><init>()V

    .line 648
    .local v1, "pathRenderer":Landroid/support/e/a/i$e;
    iput-object v1, v2, Landroid/support/e/a/i$f;->b:Landroid/support/e/a/i$e;

    .line 650
    sget-object v3, Landroid/support/e/a/a;->a:[I

    invoke-static {p1, p4, p3, v3}, Landroid/support/e/a/i;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    .line 653
    .local v0, "a":Landroid/content/res/TypedArray;
    invoke-direct {p0, v0, p2}, Landroid/support/e/a/i;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput v3, v2, Landroid/support/e/a/i$f;->a:I

    .line 656
    const/4 v3, 0x1

    iput-boolean v3, v2, Landroid/support/e/a/i$f;->l:Z
    ...
    .line 659
    iget-object v3, p0, Landroid/support/e/a/i;->q:Landroid/graphics/PorterDuffColorFilter;

    iget-object v4, v2, Landroid/support/e/a/i$f;->c:Landroid/content/res/ColorStateList;

    iget-object v5, v2, Landroid/support/e/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v3, v4, v5}, Landroid/support/e/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v3

    iput-object v3, p0, Landroid/support/e/a/i;->q:Landroid/graphics/PorterDuffColorFilter;
...
.method protected onStateChange([I)Z
    ...
    .line 480
    .local v0, "state":Landroid/support/e/a/i$f;
    ...
    iget-object v3, v0, Landroid/support/e/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v1, v2, v3}, Landroid/support/e/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v1

    iput-object v1, p0, Landroid/support/e/a/i;->q:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v1, p1}, Landroid/support/v4/d/a/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, v0, Landroid/support/e/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v1, p1, v2}, Landroid/support/e/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v1, p1}, Landroid/support/v4/d/a/a;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, v1, v2, p1}, Landroid/support/e/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
