...
.method private constructor <init>(Landroid/content/Context;Landroid/support/e/a/c$a;Landroid/content/res/Resources;)V
    ...
    .param p1, "context"    # Landroid/content/Context;
        ...
        .end annotation
    .end param
    .param p2, "state"    # Landroid/support/e/a/c$a;
        .annotation build Landroid/support/annotation/aa;
        .end annotation
    .end param
...
.method public static a(Landroid/content/Context;I)Landroid/support/e/a/c;
    ...
    invoke-direct {v1, p0}, Landroid/support/e/a/c;-><init>(Landroid/content/Context;)V

    .line 140
    .local v1, "drawable":Landroid/support/e/a/c;
    ...
    .line 140
    invoke-static {v6, p1, v7}, Landroid/support/v4/content/b/e;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    iput-object v6, v1, Landroid/support/e/a/c;->c:Landroid/graphics/drawable/Drawable;

    .line 142
    iget-object v6, v1, Landroid/support/e/a/c;->c:Landroid/graphics/drawable/Drawable;

    iget-object v7, v1, Landroid/support/e/a/c;->b:Landroid/graphics/drawable/Drawable$Callback;

    invoke-virtual {v6, v7}, Landroid/graphics/drawable/Drawable;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 143
    new-instance v6, Landroid/support/e/a/c$b;

    iget-object v7, v1, Landroid/support/e/a/c;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v6, v7}, Landroid/support/e/a/c$b;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v6, v1, Landroid/support/e/a/c;->a:Landroid/support/e/a/c$b;

    .line 166
    .end local v1    # "drawable":Landroid/support/e/a/c;
    :goto_0
    return-object v1
    ...
    .line 159
    invoke-static {p0, v6, v3, v0, v7}, Landroid/support/e/a/c;->a(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/e/a/c;
    :try_end_1
...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/e/a/c;
    ...
    .line 179
    .local v0, "drawable":Landroid/support/e/a/c;
...
.method static synthetic a(Landroid/support/e/a/c;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Landroid/support/e/a/c;
...
.method private a(Landroid/animation/Animator;)V
    ...
    invoke-direct {p0, v4}, Landroid/support/e/a/c;->a(Landroid/animation/Animator;)V
    ...
    .line 583
    :cond_1
    iget-object v4, p0, Landroid/support/e/a/c;->j:Landroid/animation/ArgbEvaluator;
    ...
    iput-object v4, p0, Landroid/support/e/a/c;->j:Landroid/animation/ArgbEvaluator;
...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/support/e/a/b$a;)V
    .locals 2
    .param p0, "dr"    # Landroid/graphics/drawable/Drawable;
    .param p1, "callback"    # Landroid/support/e/a/b$a;
...
.method private a(Ljava/lang/String;Landroid/animation/Animator;)V
    ...
    iget-object v1, v1, Landroid/support/e/a/c$a;->b:Landroid/support/e/a/i;

    invoke-virtual {v1, p1}, Landroid/support/e/a/i;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Landroid/support/e/a/c$a;->a(Landroid/support/e/a/c$a;)Ljava/util/ArrayList;
    ...
    invoke-static {v1, v2}, Landroid/support/e/a/c$a;->a(Landroid/support/e/a/c$a;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    iput-object v2, v1, Landroid/support/e/a/c$a;->d:Landroid/support/v4/k/a;
    ...
    iget-object v1, v1, Landroid/support/e/a/c$a;->d:Landroid/support/v4/k/a;

    invoke-virtual {v1, p2, p1}, Landroid/support/v4/k/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public b(Landroid/support/e/a/b$a;)Z
    ...
    invoke-static {v1, p1}, Landroid/support/e/a/c;->a(Landroid/graphics/drawable/AnimatedVectorDrawable;Landroid/support/e/a/b$a;)Z
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .prologue
    .line 361
    iget-object v9, p0, Landroid/support/e/a/c;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v9, p1, p2, p3, p4}, Landroid/support/v4/d/a/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 377
    sget-object v9, Landroid/support/e/a/a;->K:[I

    .line 378
    invoke-static {p1, p4, p3, v9}, Landroid/support/e/a/h;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 387
    invoke-static {p1, v1, p4}, Landroid/support/e/a/i;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/e/a/i;

    move-result-object v8

    .line 389
    .local v8, "vectorDrawable":Landroid/support/e/a/i;
    const/4 v9, 0x0

    invoke-virtual {v8, v9}, Landroid/support/e/a/i;->a(Z)V

    .line 390
    iget-object v9, p0, Landroid/support/e/a/c;->b:Landroid/graphics/drawable/Drawable$Callback;

    invoke-virtual {v8, v9}, Landroid/support/e/a/i;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 391
    iget-object v9, p0, Landroid/support/e/a/c;->h:Landroid/support/e/a/c$a;

    iget-object v9, v9, Landroid/support/e/a/c$a;->b:Landroid/support/e/a/i;
    ...
    invoke-virtual {v9, v10}, Landroid/support/e/a/i;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    .line 394
    :cond_2
    iget-object v9, p0, Landroid/support/e/a/c;->h:Landroid/support/e/a/c$a;

    iput-object v8, v9, Landroid/support/e/a/c$a;->b:Landroid/support/e/a/i;

    .line 396
    .end local v8    # "vectorDrawable":Landroid/support/e/a/i;
    :cond_3
    ...
    .line 398
    sget-object v9, Landroid/support/e/a/a;->M:[I
    ...
    .line 407
    iget-object v9, p0, Landroid/support/e/a/c;->i:Landroid/content/Context;
    ...
    invoke-direct {p0, v7, v5}, Landroid/support/e/a/c;->a(Ljava/lang/String;Landroid/animation/Animator;)V
    ...
    invoke-virtual {v9}, Landroid/support/e/a/c$a;->a()V
