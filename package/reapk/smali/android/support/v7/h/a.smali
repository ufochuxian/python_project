...
.method public constructor <init>(Ljava/lang/Class;ILandroid/support/v7/h/a$a;Landroid/support/v7/h/a$b;)V
    .locals 4
    .param p2, "tileSize"    # I
    .param p4, "viewCallback"    # Landroid/support/v7/h/a$b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/Class",
    ...
    .prologue
    .local p0, "this":Landroid/support/v7/h/a;, "Landroid/support/v7/h/a<TT;>;"
    .local p1, "klass":Ljava/lang/Class;, "Ljava/lang/Class<TT;>;"
    .local p3, "dataCallback":Landroid/support/v7/h/a$a;, "Landroid/support/v7/h/a$a<TT;>;"
    const/4 v3, 0x2
    ...
    iput-object v1, p0, Landroid/support/v7/h/a;->j:[I

    .line 62
    new-array v1, v3, [I

    iput-object v1, p0, Landroid/support/v7/h/a;->k:[I

    .line 63
    new-array v1, v3, [I

    iput-object v1, p0, Landroid/support/v7/h/a;->l:[I

    .line 66
    iput v2, p0, Landroid/support/v7/h/a;->r:I

    .line 68
    iput v2, p0, Landroid/support/v7/h/a;->n:I

    .line 70
    iput v2, p0, Landroid/support/v7/h/a;->o:I
    ...
    iput-object v1, p0, Landroid/support/v7/h/a;->q:Landroid/util/SparseIntArray;

    .line 207
    new-instance v1, Landroid/support/v7/h/a$1;

    invoke-direct {v1, p0}, Landroid/support/v7/h/a$1;-><init>(Landroid/support/v7/h/a;)V

    iput-object v1, p0, Landroid/support/v7/h/a;->s:Landroid/support/v7/h/g$b;

    .line 289
    new-instance v1, Landroid/support/v7/h/a$2;

    invoke-direct {v1, p0}, Landroid/support/v7/h/a$2;-><init>(Landroid/support/v7/h/a;)V

    iput-object v1, p0, Landroid/support/v7/h/a;->t:Landroid/support/v7/h/g$a;
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/h/h;-><init>(I)V

    iput-object v1, p0, Landroid/support/v7/h/a;->g:Landroid/support/v7/h/h;
    ...
    .line 97
    .local v0, "threadUtil":Landroid/support/v7/h/g;, "Landroid/support/v7/h/g<TT;>;"
    ...
    iput-object v1, p0, Landroid/support/v7/h/a;->i:Landroid/support/v7/h/g$a;
...
.method public a(I)Ljava/lang/Object;
    ...
    .line 154
    :cond_1
    iget-object v1, p0, Landroid/support/v7/h/a;->g:Landroid/support/v7/h/h;

    invoke-virtual {v1, p1}, Landroid/support/v7/h/h;->a(I)Ljava/lang/Object;
