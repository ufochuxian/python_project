...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v2, Landroid/support/v7/a/b$l;->MenuView:[I
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/at;->a(IZ)Z
...
.method private b()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->c:Landroid/widget/ImageView;
...
.method private d()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->d:Landroid/widget/RadioButton;
...
.method private e()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->f:Landroid/widget/CheckBox;
...
.method public a(ZC)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/k;->g()Z
...
.method public setCheckable(Z)V
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->d:Landroid/widget/RadioButton;

    if-nez v4, :cond_1

    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->f:Landroid/widget/CheckBox;
    ...
    .line 149
    :cond_1
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->b:Landroid/support/v7/view/menu/k;
    ...
    invoke-virtual {v4}, Landroid/support/v7/view/menu/k;->isChecked()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/k;->j()Z

    move-result v2

    if-nez v2, :cond_0

    iget-boolean v2, p0, Landroid/support/v7/view/menu/ListMenuItemView;->p:Z
