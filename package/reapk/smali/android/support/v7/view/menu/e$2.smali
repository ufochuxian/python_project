...
.method public b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    .prologue
    .line 129
    iget-object v8, p0, Landroid/support/v7/view/menu/e$2;->a:Landroid/support/v7/view/menu/e;

    iget-object v8, v8, Landroid/support/v7/view/menu/e;->d:Landroid/os/Handler;
    ...
    iget-object v8, v8, Landroid/support/v7/view/menu/e;->e:Ljava/util/List;
    ...
    check-cast v8, Landroid/support/v7/view/menu/e$a;

    iget-object v8, v8, Landroid/support/v7/view/menu/e$a;->b:Landroid/support/v7/view/menu/h;
    ...
    .line 152
    .local v4, "nextInfo":Landroid/support/v7/view/menu/e$a;
    :goto_2
    new-instance v5, Landroid/support/v7/view/menu/e$2$1;

    invoke-direct {v5, p0, v4, p2, p1}, Landroid/support/v7/view/menu/e$2$1;-><init>(Landroid/support/v7/view/menu/e$2;Landroid/support/v7/view/menu/e$a;Landroid/view/MenuItem;Landroid/support/v7/view/menu/h;)V
    ...
    .line 149
    .end local v4    # "nextInfo":Landroid/support/v7/view/menu/e$a;
    .end local v5    # "runnable":Ljava/lang/Runnable;
    .end local v6    # "uptimeMillis":J
    :cond_3
    const/4 v4, 0x0

    .restart local v4    # "nextInfo":Landroid/support/v7/view/menu/e$a;
    goto :goto_2
.end method
