...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a/a;)Landroid/view/Menu;
    ...
    .param p1, "supportMenu"    # Landroid/support/v4/f/a/a;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/view/menu/r;-><init>(Landroid/content/Context;Landroid/support/v4/f/a/a;)V
...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a/b;)Landroid/view/MenuItem;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "supportMenuItem"    # Landroid/support/v4/f/a/b;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/view/menu/MenuItemWrapperICS;-><init>(Landroid/content/Context;Landroid/support/v4/f/a/b;)V
...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a/c;)Landroid/view/SubMenu;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "supportSubMenu"    # Landroid/support/v4/f/a/c;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/view/menu/v;-><init>(Landroid/content/Context;Landroid/support/v4/f/a/c;)V
