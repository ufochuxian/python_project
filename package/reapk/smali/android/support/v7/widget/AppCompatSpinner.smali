...
.field private j:Landroid/support/v7/widget/e;

.field private k:Landroid/content/Context;

.field private l:Landroid/support/v7/widget/u;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/graphics/Rect;

    .line 197
    sget-object v9, Landroid/support/v7/a/b$l;->Spinner:[I

    const/4 v10, 0x0

    invoke-static {p1, p2, v9, p3, v10}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;

    move-result-object v1

    .line 200
    .local v1, "a":Landroid/support/v7/widget/at;
    new-instance v9, Landroid/support/v7/widget/e;

    invoke-direct {v9, p0}, Landroid/support/v7/widget/e;-><init>(Landroid/view/View;)V

    iput-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/e;

    .line 202
    if-eqz p5, :cond_5

    .line 203
    new-instance v9, Landroid/support/v7/view/d;

    move-object/from16 v0, p5

    invoke-direct {v9, p1, v0}, Landroid/support/v7/view/d;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V

    iput-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;

    .line 215
    :goto_0
    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v9, Landroid/support/v7/widget/AppCompatSpinner;->d:[I
    ...
    .line 240
    new-instance v7, Landroid/support/v7/widget/AppCompatSpinner$b;

    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;

    invoke-direct {v7, p0, v9, p2, p3}, Landroid/support/v7/widget/AppCompatSpinner$b;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 241
    .local v7, "popup":Landroid/support/v7/widget/AppCompatSpinner$b;
    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;

    sget-object v10, Landroid/support/v7/a/b$l;->Spinner:[I

    const/4 v11, 0x0

    invoke-static {v9, p2, v10, p3, v11}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;

    move-result-object v6

    .line 243
    .local v6, "pa":Landroid/support/v7/widget/at;
    sget v9, Landroid/support/v7/a/b$l;->Spinner_android_dropDownWidth:I

    const/4 v10, -0x2

    invoke-virtual {v6, v9, v10}, Landroid/support/v7/widget/at;->f(II)I

    move-result v9

    iput v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->b:I

    .line 245
    sget v9, Landroid/support/v7/a/b$l;->Spinner_android_popupBackground:I

    .line 246
    invoke-virtual {v6, v9}, Landroid/support/v7/widget/at;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v9

    .line 245
    invoke-virtual {v7, v9}, Landroid/support/v7/widget/AppCompatSpinner$b;->b(Landroid/graphics/drawable/Drawable;)V

    .line 247
    sget v9, Landroid/support/v7/a/b$l;->Spinner_android_prompt:I

    invoke-virtual {v1, v9}, Landroid/support/v7/widget/at;->e(I)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v7, v9}, Landroid/support/v7/widget/AppCompatSpinner$b;->a(Ljava/lang/CharSequence;)V

    .line 248
    invoke-virtual {v6}, Landroid/support/v7/widget/at;->e()V

    .line 250
    iput-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner;->a:Landroid/support/v7/widget/AppCompatSpinner$b;

    .line 251
    new-instance v9, Landroid/support/v7/widget/AppCompatSpinner$1;

    invoke-direct {v9, p0, p0, v7}, Landroid/support/v7/widget/AppCompatSpinner$1;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Landroid/support/v7/widget/AppCompatSpinner$b;)V

    iput-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->l:Landroid/support/v7/widget/u;

    .line 268
    .end local v6    # "pa":Landroid/support/v7/widget/at;
    .end local v7    # "popup":Landroid/support/v7/widget/AppCompatSpinner$b;
    :cond_2
    sget v9, Landroid/support/v7/a/b$l;->Spinner_android_entries:I

    invoke-virtual {v1, v9}, Landroid/support/v7/widget/at;->h(I)[Ljava/lang/CharSequence;
    ...
    sget v9, Landroid/support/v7/a/b$i;->support_simple_spinner_dropdown_item:I
    ...
    iput-boolean v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->n:Z

    .line 282
    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->m:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->m:Landroid/widget/SpinnerAdapter;

    .line 287
    :cond_4
    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/e;

    invoke-virtual {v9, p2, p3}, Landroid/support/v7/widget/e;->a(Landroid/util/AttributeSet;I)V
    ...
    :cond_5
    sget v9, Landroid/support/v7/a/b$l;->Spinner_popupTheme:I

    const/4 v10, 0x0

    invoke-virtual {v1, v9, v10}, Landroid/support/v7/widget/at;->g(II)I
    ...
    invoke-direct {v9, p1, v8}, Landroid/support/v7/view/d;-><init>(Landroid/content/Context;I)V
...
.method a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    .line 574
    iget-object v10, p0, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/graphics/Rect;
    ...
    iget-object v11, p0, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/graphics/Rect;
...
.method protected drawableStateChanged()V
    ...
    .line 532
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/e;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/AppCompatSpinner$b;->e()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 408
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->l:Landroid/support/v7/widget/u;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .prologue
    .line 384
    iget-boolean v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->n:Z
    ...
    .line 392
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;
    ...
    invoke-direct {v2, p1, v3}, Landroid/support/v7/widget/AppCompatSpinner$a;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V
