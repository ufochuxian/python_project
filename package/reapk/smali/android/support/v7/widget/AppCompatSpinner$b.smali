...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$b;)V
    .locals 0
    .param p0, "x0"    # Landroid/support/v7/widget/AppCompatSpinner$b;
...
.method public a()V
    ...
    .prologue
    .line 777
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->e()Z
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/AppCompatSpinner$b;->k(I)V
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/AppCompatSpinner$b;->l(I)V
    ...
    .line 798
    new-instance v0, Landroid/support/v7/widget/AppCompatSpinner$b$2;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/AppCompatSpinner$b$2;-><init>(Landroid/support/v7/widget/AppCompatSpinner$b;)V
    ...
    .line 814
    new-instance v4, Landroid/support/v7/widget/AppCompatSpinner$b$3;

    invoke-direct {v4, p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$b$3;-><init>(Landroid/support/v7/widget/AppCompatSpinner$b;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    invoke-virtual {p0, v4}, Landroid/support/v7/widget/AppCompatSpinner$b;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method c()V
    ...
    .line 743
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->b:Landroid/support/v7/widget/AppCompatSpinner;

    iget-object v7, v7, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v7}, Landroid/support/v7/widget/ay;->a(Landroid/view/View;)Z
    ...
    iget v7, v7, Landroid/support/v7/widget/AppCompatSpinner;->b:I
    ...
    .line 754
    iget-object v8, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->b:Landroid/support/v7/widget/AppCompatSpinner;

    iget-object v7, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->a:Landroid/widget/ListAdapter;
    ...
    .line 754
    invoke-virtual {v8, v7, v9}, Landroid/support/v7/widget/AppCompatSpinner;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v8, v8, Landroid/support/v7/widget/AppCompatSpinner;->c:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v7}, Landroid/support/v7/widget/AppCompatSpinner$b;->h(I)V
    ...
    .line 773
    :goto_2
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/AppCompatSpinner$b;->d(I)V
