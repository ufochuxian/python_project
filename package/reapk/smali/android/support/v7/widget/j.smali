...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5, v6}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v12, v0, Landroid/support/v4/d/a/h;
    ...
    .line 73
    check-cast v12, Landroid/support/v4/d/a/h;

    invoke-interface {v12}, Landroid/support/v4/d/a/h;->a()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v7, v0}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v12, v7}, Landroid/support/v4/d/a/h;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v13, v12}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v12, p0, Landroid/support/v7/widget/j;->c:Landroid/graphics/Bitmap;

    if-nez v12, :cond_7

    .line 100
    iput-object v11, p0, Landroid/support/v7/widget/j;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    sget-object v3, Landroid/support/v7/widget/j;->a:[I
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/at;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v4}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
