...
.method a(Landroid/graphics/Canvas;)V
    ...
    .line 165
    iget-object v8, p0, Landroid/support/v7/widget/k;->b:Landroid/graphics/drawable/Drawable;

    if-eqz v8, :cond_3

    .line 166
    iget-object v8, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/SeekBar;
    ...
    iget-object v9, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/SeekBar;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v3, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/SeekBar;

    invoke-virtual {v3}, Landroid/widget/SeekBar;->getContext()Landroid/content/Context;

    move-result-object v3

    sget-object v4, Landroid/support/v7/a/b$l;->AppCompatSeekBar:[I

    const/4 v5, 0x0

    invoke-static {v3, p1, v4, p2, v5}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;

    move-result-object v0

    .line 53
    .local v0, "a":Landroid/support/v7/widget/at;
    sget v3, Landroid/support/v7/a/b$l;->AppCompatSeekBar_android_thumb:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/at;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 58
    :cond_0
    sget v3, Landroid/support/v7/a/b$l;->AppCompatSeekBar_tickMark:I
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;)V

    .line 61
    sget v3, Landroid/support/v7/a/b$l;->AppCompatSeekBar_tickMarkTintMode:I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/k;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v3, v4}, Landroid/support/v7/widget/s;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v3

    iput-object v3, p0, Landroid/support/v7/widget/k;->d:Landroid/graphics/PorterDuff$Mode;

    .line 64
    iput-boolean v6, p0, Landroid/support/v7/widget/k;->f:Z

    .line 67
    :cond_1
    sget v3, Landroid/support/v7/a/b$l;->AppCompatSeekBar_tickMarkTint:I
    ...
    iput-object v3, p0, Landroid/support/v7/widget/k;->c:Landroid/content/res/ColorStateList;

    .line 69
    iput-boolean v6, p0, Landroid/support/v7/widget/k;->e:Z
