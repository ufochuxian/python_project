...
.field protected final f:Landroid/support/v7/widget/ScrollingTabContainerView$c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 75
    new-instance v1, Landroid/support/v7/widget/ScrollingTabContainerView$c;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/ScrollingTabContainerView$c;-><init>(Landroid/support/v7/widget/ScrollingTabContainerView;)V

    iput-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->f:Landroid/support/v7/widget/ScrollingTabContainerView$c;
    ...
    iput v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->d:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->b:Landroid/support/v7/widget/LinearLayoutCompat;
...
.method private e()Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    .line 208
    new-instance v1, Landroid/support/v7/widget/LinearLayoutCompat$b;

    const/4 v2, -0x2

    const/4 v3, -0x1

    invoke-direct {v1, v2, v3}, Landroid/support/v7/widget/LinearLayoutCompat$b;-><init>(II)V
...
# virtual methods
.method a(Landroid/support/v7/app/a$f;Z)Landroid/support/v7/widget/ScrollingTabContainerView$TabView;
    .locals 4
    ...
    invoke-direct {v0, p0, v1, p1, p2}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;-><init>(Landroid/support/v7/widget/ScrollingTabContainerView;Landroid/content/Context;Landroid/support/v7/app/a$f;Z)V
...
.method public a(I)V
    ...
    .line 235
    iget-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->e:Landroid/support/v4/view/bm;
    ...
    .line 240
    invoke-static {p0, v2}, Landroid/support/v4/view/ap;->c(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/support/v4/view/bm;->a(J)Landroid/support/v4/view/bm;
    ...
    .line 247
    iget-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->f:Landroid/support/v7/widget/ScrollingTabContainerView$c;

    invoke-virtual {v1, v0, p1}, Landroid/support/v7/widget/ScrollingTabContainerView$c;->a(Landroid/support/v4/view/bm;I)Landroid/support/v7/widget/ScrollingTabContainerView$c;
    ...
    .line 250
    .end local v0    # "anim":Landroid/support/v4/view/bm;
    :cond_2
    invoke-static {p0}, Landroid/support/v4/view/ap;->A(Landroid/view/View;)Landroid/support/v4/view/bm;
    ...
    .line 251
    .restart local v0    # "anim":Landroid/support/v4/view/bm;
    invoke-virtual {v0, v4, v5}, Landroid/support/v4/view/bm;->a(J)Landroid/support/v4/view/bm;
...
.method public a(Landroid/support/v7/app/a$f;IZ)V
    ...
    .line 325
    invoke-virtual {p0, p1, v5}, Landroid/support/v7/widget/ScrollingTabContainerView;->a(Landroid/support/v7/app/a$f;Z)Landroid/support/v7/widget/ScrollingTabContainerView$TabView;
    ...
    new-instance v2, Landroid/support/v7/widget/LinearLayoutCompat$b;

    const/4 v3, -0x1

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-direct {v2, v5, v3, v4}, Landroid/support/v7/widget/LinearLayoutCompat$b;-><init>(IIF)V
    ...
    .line 328
    iget-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->i:Landroid/widget/Spinner;
    ...
    check-cast v1, Landroid/support/v7/widget/ScrollingTabContainerView$a;

    invoke-virtual {v1}, Landroid/support/v7/widget/ScrollingTabContainerView$a;->notifyDataSetChanged()V
    ...
    .line 334
    :cond_1
    iget-boolean v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->j:Z
...
.method public c(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->a()V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 372
    .local v0, "tabView":Landroid/support/v7/widget/ScrollingTabContainerView$TabView;
    invoke-virtual {v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->b()Landroid/support/v7/app/a$f;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v7/app/a$f;->f()V
...
.method public onMeasure(II)V
    ...
    .line 101
    iget-object v8, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->b:Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    iput v8, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->c:I

    .line 109
    :goto_1
    iget v8, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->c:I

    iget v9, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->d:I
    ...
    .line 114
    :goto_2
    iget v8, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->k:I
    ...
    iget-boolean v8, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->j:Z
    ...
    .line 120
    iget-object v6, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->b:Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    .line 136
    iget v6, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->l:I
...
.method public setTabSelected(I)V
    ...
    :cond_2
    iget-object v4, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->i:Landroid/widget/Spinner;
