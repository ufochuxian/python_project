...
# direct methods
.method public constructor <init>(Landroid/support/v7/widget/ScrollingTabContainerView;Landroid/content/Context;Landroid/support/v7/app/a$f;Z)V
    .locals 5
    .param p2, "context"    # Landroid/content/Context;
    .param p3, "tab"    # Landroid/support/v7/app/a$f;
    .param p4, "forList"    # Z
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->b:[I

    .line 392
    iput-object p3, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->c:Landroid/support/v7/app/a$f;

    .line 394
    iget-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->b:[I

    sget v2, Landroid/support/v7/a/b$b;->actionBarTabStyle:I

    invoke-static {p2, v4, v1, v2, v3}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;
...
.method public a()V
    ...
    .line 451
    iget-object v6, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->c:Landroid/support/v7/app/a$f;

    .line 452
    .local v6, "tab":Landroid/support/v7/app/a$f;
    invoke-virtual {v6}, Landroid/support/v7/app/a$f;->d()Landroid/view/View;
    ...
    .line 459
    :cond_1
    iput-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->l:Landroid/view/View;

    .line 460
    iget-object v9, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->d:Landroid/widget/TextView;
    ...
    .line 461
    :cond_2
    iget-object v9, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    .line 466
    :cond_4
    iget-object v10, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->l:Landroid/view/View;
    ...
    .line 468
    iput-object v12, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->l:Landroid/view/View;

    .line 471
    :cond_5
    invoke-virtual {v6}, Landroid/support/v7/app/a$f;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v3

    .line 472
    .local v3, "icon":Landroid/graphics/drawable/Drawable;
    invoke-virtual {v6}, Landroid/support/v7/app/a$f;->c()Ljava/lang/CharSequence;
    ...
    .line 475
    iget-object v10, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    new-instance v5, Landroid/support/v7/widget/LinearLayoutCompat$b;

    invoke-direct {v5, v13, v13}, Landroid/support/v7/widget/LinearLayoutCompat$b;-><init>(II)V

    .line 479
    .local v5, "lp":Landroid/support/v7/widget/LinearLayoutCompat$b;
    iput v14, v5, Landroid/support/v7/widget/LinearLayoutCompat$b;->h:I
    ...
    .end local v5    # "lp":Landroid/support/v7/widget/LinearLayoutCompat$b;
    :cond_6
    iget-object v10, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    .line 493
    iget-object v10, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->d:Landroid/widget/TextView;
    ...
    sget v11, Landroid/support/v7/a/b$b;->actionBarTabTextStyle:I
    ...
    .line 499
    .restart local v5    # "lp":Landroid/support/v7/widget/LinearLayoutCompat$b;
    iput v14, v5, Landroid/support/v7/widget/LinearLayoutCompat$b;->h:I
    ...
    .line 502
    iput-object v8, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->d:Landroid/widget/TextView;
    ...
    invoke-virtual {v6}, Landroid/support/v7/app/a$f;->g()Ljava/lang/CharSequence;
...
.method public a(Landroid/support/v7/app/a$f;)V
    ...
    .prologue
    .line 409
    iput-object p1, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->c:Landroid/support/v7/app/a$f;
...
.method public b()Landroid/support/v7/app/a$f;
    ...
    .prologue
    .line 545
    iget-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->c:Landroid/support/v7/app/a$f;
