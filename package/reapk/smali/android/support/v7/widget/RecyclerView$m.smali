...
.method private c(I)Landroid/support/v7/widget/RecyclerView$m$a;
    ...
    .line 5141
    .local v0, "scrapData":Landroid/support/v7/widget/RecyclerView$m$a;
    if-nez v0, :cond_0

    .line 5142
    new-instance v0, Landroid/support/v7/widget/RecyclerView$m$a;

    .end local v0    # "scrapData":Landroid/support/v7/widget/RecyclerView$m$a;
    invoke-direct {v0}, Landroid/support/v7/widget/RecyclerView$m$a;-><init>()V

    .line 5143
    .restart local v0    # "scrapData":Landroid/support/v7/widget/RecyclerView$m$a;
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$m;->a:Landroid/util/SparseArray;
...
.method public a()V
    ...
    .line 5022
    .local v0, "data":Landroid/support/v7/widget/RecyclerView$m$a;
    ...
    .line 5024
    .end local v0    # "data":Landroid/support/v7/widget/RecyclerView$m$a;
    :cond_0
    return-void
.end method
...
.method public a(II)V
    ...
    .line 5030
    .local v1, "scrapHeap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$w;>;"
    if-eqz v1, :cond_0
...
.method public a(Landroid/support/v7/widget/RecyclerView$w;)V
    .locals 4
    .param p1, "scrap"    # Landroid/support/v7/widget/RecyclerView$w;
    ...
    .line 5066
    .local v1, "viewType":I
    invoke-direct {p0, v1}, Landroid/support/v7/widget/RecyclerView$m;->c(I)Landroid/support/v7/widget/RecyclerView$m$a;

    move-result-object v2

    iget-object v0, v2, Landroid/support/v7/widget/RecyclerView$m$a;->a:Ljava/util/ArrayList;
    ...
    check-cast v2, Landroid/support/v7/widget/RecyclerView$m$a;

    iget v2, v2, Landroid/support/v7/widget/RecyclerView$m$a;->b:I
...
.method a(IJJ)Z
    ...
    iget-wide v0, v2, Landroid/support/v7/widget/RecyclerView$m$a;->c:J
...
.method b()I
    ...
    .local v1, "i":I
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$m;->a:Landroid/util/SparseArray;
    ...
    check-cast v3, Landroid/support/v7/widget/RecyclerView$m$a;

    iget-object v2, v3, Landroid/support/v7/widget/RecyclerView$m$a;->a:Ljava/util/ArrayList;

    .line 5057
    .local v2, "viewHolders":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$w;>;"
    if-eqz v2, :cond_0
    ...
    .line 5061
    .end local v2    # "viewHolders":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$w;>;"
    :cond_1
    return v0
.end method
...
.method public b(I)Landroid/support/v7/widget/RecyclerView$w;
    ...
    .line 5050
    .end local v1    # "scrapHeap":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$w;>;"
    :goto_0
    return-object v2
...
.method b(IJJ)Z
    ...
    iget-wide v0, v2, Landroid/support/v7/widget/RecyclerView$m$a;->d:J
