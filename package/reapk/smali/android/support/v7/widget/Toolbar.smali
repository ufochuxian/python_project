...
.field private J:Landroid/support/v7/widget/au;
...
.field private v:Landroid/support/v7/widget/ai;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->y:I
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->F:Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->G:Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->H:[I
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ActionMenuView$e;
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->P:Ljava/lang/Runnable;
    ...
    sget-object v22, Landroid/support/v7/a/b$l;->Toolbar:[I
    ...
    invoke-static {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;

    move-result-object v5

    .line 241
    .local v5, "a":Landroid/support/v7/widget/at;
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleTextAppearance:I
    ...
    invoke-virtual {v5, v0, v1}, Landroid/support/v7/widget/at;->g(II)I
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->o:I

    .line 242
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_subtitleTextAppearance:I
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->p:I

    .line 243
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_android_gravity:I
    ...
    invoke-virtual {v5, v0, v1}, Landroid/support/v7/widget/at;->c(II)I
    ...
    .line 244
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_buttonGravity:I
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->c:I

    .line 247
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleMargin:I
    ...
    invoke-virtual {v5, v0, v1}, Landroid/support/v7/widget/at;->d(II)I

    move-result v20

    .line 248
    .local v20, "titleMargin":I
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleMargins:I

    move/from16 v0, v21

    invoke-virtual {v5, v0}, Landroid/support/v7/widget/at;->j(I)Z
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->u:I

    move/from16 v0, v20

    move-object/from16 v1, p0

    iput v0, v1, Landroid/support/v7/widget/Toolbar;->t:I

    move/from16 v0, v20

    move-object/from16 v1, p0

    iput v0, v1, Landroid/support/v7/widget/Toolbar;->s:I

    move/from16 v0, v20

    move-object/from16 v1, p0

    iput v0, v1, Landroid/support/v7/widget/Toolbar;->r:I

    .line 254
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleMarginStart:I
    ...
    iput v14, v0, Landroid/support/v7/widget/Toolbar;->r:I

    .line 259
    :cond_1
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleMarginEnd:I
    ...
    iput v13, v0, Landroid/support/v7/widget/Toolbar;->s:I

    .line 264
    :cond_2
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleMarginTop:I
    ...
    iput v15, v0, Landroid/support/v7/widget/Toolbar;->t:I

    .line 269
    :cond_3
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleMarginBottom:I
    ...
    iput v12, v0, Landroid/support/v7/widget/Toolbar;->u:I

    .line 275
    :cond_4
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_maxButtonHeight:I
    ...
    invoke-virtual {v5, v0, v1}, Landroid/support/v7/widget/at;->e(II)I
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->q:I

    .line 277
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_contentInsetStart:I
    ...
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_contentInsetEnd:I
    ...
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_contentInsetLeft:I
    ...
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_contentInsetRight:I
    ...
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->t()V

    .line 289
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/support/v7/widget/Toolbar;->v:Landroid/support/v7/widget/ai;

    move-object/from16 v21, v0

    move-object/from16 v0, v21

    invoke-virtual {v0, v7, v8}, Landroid/support/v7/widget/ai;->b(II)V
    ...
    invoke-virtual {v0, v9, v6}, Landroid/support/v7/widget/ai;->a(II)V

    .line 296
    :cond_6
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_contentInsetStartWithNavigation:I
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->w:I

    .line 298
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_contentInsetEndWithActions:I
    ...
    iput v0, v1, Landroid/support/v7/widget/Toolbar;->x:I

    .line 301
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_collapseIcon:I

    move/from16 v0, v21

    invoke-virtual {v5, v0}, Landroid/support/v7/widget/at;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->k:Landroid/graphics/drawable/Drawable;

    .line 302
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_collapseContentDescription:I

    move/from16 v0, v21

    invoke-virtual {v5, v0}, Landroid/support/v7/widget/at;->d(I)Ljava/lang/CharSequence;
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->l:Ljava/lang/CharSequence;

    .line 304
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_title:I
    ...
    .line 309
    :cond_7
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_subtitle:I
    ...
    iput-object v0, v1, Landroid/support/v7/widget/Toolbar;->m:Landroid/content/Context;

    .line 316
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_popupTheme:I
    ...
    .line 318
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_navigationIcon:I
    ...
    .line 322
    :cond_9
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_navigationContentDescription:I
    ...
    .line 327
    :cond_a
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_logo:I
    ...
    .line 332
    :cond_b
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_logoDescription:I
    ...
    .line 337
    :cond_c
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_titleTextColor:I
    ...
    invoke-virtual {v5, v0, v1}, Landroid/support/v7/widget/at;->b(II)I
    ...
    .line 341
    :cond_d
    sget v21, Landroid/support/v7/a/b$l;->Toolbar_subtitleTextColor:I
    ...
    .line 344
    :cond_e
    invoke-virtual {v5}, Landroid/support/v7/widget/at;->e()V
...
.method private a(Landroid/view/View;I)I
    ...
    :goto_0
    iget v10, v3, Landroid/support/v7/widget/Toolbar$b;->a:I

    invoke-direct {p0, v10}, Landroid/support/v7/widget/Toolbar;->b(I)I
    ...
    .line 1990
    iget v7, v3, Landroid/support/v7/widget/Toolbar$b;->topMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/Toolbar$b;->bottomMargin:I
...
.method private a(Landroid/view/View;I[II)I
    ...
    iget v4, v2, Landroid/support/v7/widget/Toolbar$b;->leftMargin:I
    ...
    .line 1953
    iget v4, v2, Landroid/support/v7/widget/Toolbar$b;->rightMargin:I
...
.method private a(Ljava/util/List;[I)I
    ...
    .line 1933
    .local v6, "lp":Landroid/support/v7/widget/Toolbar$b;
    iget v11, v6, Landroid/support/v7/widget/Toolbar$b;->leftMargin:I

    sub-int v4, v11, v0

    .line 1934
    .local v4, "l":I
    iget v11, v6, Landroid/support/v7/widget/Toolbar$b;->rightMargin:I
    ...
    .end local v6    # "lp":Landroid/support/v7/widget/Toolbar$b;
    .end local v7    # "r":I
...
.method private a(Landroid/view/View;Z)V
    ...
    iput v2, v0, Landroid/support/v7/widget/Toolbar$b;->e:I

    .line 1402
    if-eqz p2, :cond_2

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->b:Landroid/view/View;
    ...
    .line 1396
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Toolbar$b;

    move-result-object v0

    .restart local v0    # "lp":Landroid/support/v7/widget/Toolbar$b;
    goto :goto_0
...
.method private a(Ljava/util/List;I)V
    ...
    .line 2024
    invoke-static {p2, v6}, Landroid/support/v4/view/h;->a(II)I
    ...
    iget v6, v5, Landroid/support/v7/widget/Toolbar$b;->e:I
    ...
    iget v6, v5, Landroid/support/v7/widget/Toolbar$b;->a:I

    .line 2034
    invoke-direct {p0, v6}, Landroid/support/v7/widget/Toolbar;->c(I)I
...
.method private b(Landroid/view/View;I[II)I
    ...
    iget v4, v1, Landroid/support/v7/widget/Toolbar$b;->rightMargin:I
    ...
    .line 1966
    iget v4, v1, Landroid/support/v7/widget/Toolbar$b;->leftMargin:I
...
.method private c(I)I
    ...
    .line 2052
    .local v2, "ld":I
    invoke-static {p1, v2}, Landroid/support/v4/view/h;->a(II)I
...
.method private o()V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/ActionMenuView;->d()Landroid/support/v7/view/menu/h;
    ...
    .line 1038
    .local v0, "menu":Landroid/support/v7/view/menu/h;
    ...
    .line 1044
    .end local v0    # "menu":Landroid/support/v7/view/menu/h;
    :cond_1
    return-void
.end method
...
.method private p()V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ActionMenuView$e;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ActionMenuView;->setOnMenuItemClickListener(Landroid/support/v7/widget/ActionMenuView$e;)V

    .line 1051
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->M:Landroid/support/v7/view/menu/o$a;

    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/view/menu/h$a;

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
...
.method private q()V
    ...
    sget v4, Landroid/support/v7/a/b$b;->toolbarNavigationButtonStyle:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->i:Landroid/widget/ImageButton;
...
.method private s()Z
    ...
    .line 1557
    iget-boolean v4, p0, Landroid/support/v7/widget/Toolbar;->O:Z
...
.method private t()V
    ...
    .prologue
    .line 2171
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->v:Landroid/support/v7/widget/ai;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->v:Landroid/support/v7/widget/ai;
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/ai;->a(II)V
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/support/v7/widget/ActionMenuPresenter;)V
    ...
    .line 554
    .local v0, "oldMenu":Landroid/support/v7/view/menu/h;
    if-eq v0, p1, :cond_0
    ...
    .line 567
    :cond_3
    invoke-virtual {p2, v3}, Landroid/support/v7/widget/ActionMenuPresenter;->d(Z)V
    ...
    invoke-virtual {p1, p2, v1}, Landroid/support/v7/view/menu/h;->a(Landroid/support/v7/view/menu/o;Landroid/content/Context;)V
    ...
    invoke-virtual {p2, v1, v4}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/content/Context;Landroid/support/v7/view/menu/h;)V
    ...
    invoke-virtual {v1, v2, v4}, Landroid/support/v7/widget/Toolbar$a;->a(Landroid/content/Context;Landroid/support/v7/view/menu/h;)V

    .line 574
    invoke-virtual {p2, v3}, Landroid/support/v7/widget/ActionMenuPresenter;->b(Z)V

    .line 575
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$a;

    invoke-virtual {v1, v3}, Landroid/support/v7/widget/Toolbar$a;->b(Z)V
...
.method public a(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
    .locals 1
    .param p1, "pcb"    # Landroid/support/v7/view/menu/o$a;
    .param p2, "mcb"    # Landroid/support/v7/view/menu/h$a;
    .annotation build Landroid/support/annotation/RestrictTo;
        a = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
        }
    ...
    .prologue
    .line 2163
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->M:Landroid/support/v7/view/menu/o$a;
...
.method public getCurrentContentInsetEnd()I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/ActionMenuView;->d()Landroid/support/v7/view/menu/h;
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/h;->hasVisibleItems()Z
    ...
    iget v4, p0, Landroid/support/v7/widget/Toolbar;->x:I
...
.method public getWrapper()Landroid/support/v7/widget/p;
    .locals 2
    .annotation build Landroid/support/annotation/RestrictTo;
        a = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
    ...
    .prologue
    .line 2114
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->J:Landroid/support/v7/widget/au;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/au;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->J:Landroid/support/v7/widget/au;
...
.method public i()V
    ...
    .line 716
    .end local v0    # "item":Landroid/support/v7/view/menu/k;
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$a;

    iget-object v0, v1, Landroid/support/v7/widget/Toolbar$a;->b:Landroid/support/v7/view/menu/k;
...
.method j()V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->a:Landroid/widget/ImageButton;

    .line 1375
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->a:Landroid/widget/ImageButton;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->k:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->l:Ljava/lang/CharSequence;
...
.method l()V
    ...
    .line 2126
    .local v3, "lp":Landroid/support/v7/widget/Toolbar$b;
    iget v4, v3, Landroid/support/v7/widget/Toolbar$b;->e:I

    const/4 v5, 0x2

    if-eq v4, v5, :cond_0

    iget-object v4, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 2128
    iget-object v4, p0, Landroid/support/v7/widget/Toolbar;->G:Ljava/util/ArrayList;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v12, v0, Landroid/support/v7/widget/Toolbar;->H:[I
    ...
    invoke-direct {v0, v1, v2, v12, v5}, Landroid/support/v7/widget/Toolbar;->b(Landroid/view/View;I[II)I
    ...
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    invoke-direct {v0, v1, v2, v12, v5}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/View;I[II)I
    ...
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar;->g:Landroid/widget/TextView;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar;->h:Landroid/widget/TextView;
    ...
    check-cast v24, Landroid/support/v7/widget/Toolbar$b;

    .line 1787
    .local v24, "lp":Landroid/support/v7/widget/Toolbar$b;
    ...
    .line 1789
    .end local v24    # "lp":Landroid/support/v7/widget/Toolbar$b;
    :cond_5
    if-eqz v19, :cond_6
    ...
    .line 1791
    .restart local v24    # "lp":Landroid/support/v7/widget/Toolbar$b;
    move-object/from16 v0, v24
    ...
    check-cast v47, Landroid/support/v7/widget/Toolbar$b;

    .line 1799
    .local v47, "toplp":Landroid/support/v7/widget/Toolbar$b;
    ...
    .end local v47    # "toplp":Landroid/support/v7/widget/Toolbar$b;
    :cond_d
    :goto_d
    move-object/from16 v0, p0
    ...
    .restart local v47    # "toplp":Landroid/support/v7/widget/Toolbar$b;
    :cond_17
    const/16 v41, 0x0
    ...
    iget v0, v7, Landroid/support/v7/widget/Toolbar$b;->bottomMargin:I
    ...
    invoke-direct {v0, v1, v12}, Landroid/support/v7/widget/Toolbar;->a(Ljava/util/List;[I)I
    ...
    invoke-direct {v0, v1, v8, v12, v5}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/View;I[II)I
...
.method protected onMeasure(II)V
    ...
    iget-object v13, v0, Landroid/support/v7/widget/Toolbar;->H:[I
    ...
    invoke-direct/range {v3 .. v9}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/View;IIIII)V
    ...
    iget-object v5, v0, Landroid/support/v7/widget/Toolbar;->i:Landroid/widget/ImageButton;

    move-object/from16 v0, p0

    invoke-direct {v0, v5}, Landroid/support/v7/widget/Toolbar;->b(Landroid/view/View;)I
    ...
    invoke-direct {v0, v5}, Landroid/support/v7/widget/Toolbar;->c(Landroid/view/View;)I
    ...
    invoke-static {v0, v3}, Landroid/support/v7/widget/ay;->a(II)I
    ...
    iget-object v5, v0, Landroid/support/v7/widget/Toolbar;->a:Landroid/widget/ImageButton;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    iget-object v5, v0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/Toolbar;->b:Landroid/view/View;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/Toolbar;->b:Landroid/view/View;
    ...
    invoke-direct/range {v3 .. v9}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/View;IIII[I)I
    ...
    iget-object v5, v0, Landroid/support/v7/widget/Toolbar;->b:Landroid/view/View;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    iget-object v5, v0, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    check-cast v27, Landroid/support/v7/widget/Toolbar$b;

    .line 1652
    .local v27, "lp":Landroid/support/v7/widget/Toolbar$b;
    move-object/from16 v0, v27

    iget v3, v0, Landroid/support/v7/widget/Toolbar$b;->e:I
    ...
    .end local v26    # "i":I
    .end local v27    # "lp":Landroid/support/v7/widget/Toolbar$b;
    ...
    .restart local v27    # "lp":Landroid/support/v7/widget/Toolbar$b;
    ...
    invoke-direct {v0, v4}, Landroid/support/v7/widget/Toolbar;->c(Landroid/view/View;)I
    ...
    iget-object v8, v0, Landroid/support/v7/widget/Toolbar;->g:Landroid/widget/TextView;
    ...
    invoke-direct/range {v7 .. v13}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/View;IIII[I)I
    ...
    invoke-direct/range {v14 .. v20}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/View;IIII[I)I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .prologue
    .line 1424
    instance-of v3, p1, Landroid/support/v7/widget/Toolbar$d;
    ...
    .line 1430
    .local v2, "ss":Landroid/support/v7/widget/Toolbar$d;
    invoke-virtual {v2}, Landroid/support/v7/widget/Toolbar$d;->a()Landroid/os/Parcelable;
    ...
    :goto_1
    iget v3, v2, Landroid/support/v7/widget/Toolbar$d;->b:I

    if-eqz v3, :cond_2

    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$a;
    ...
    .line 1436
    invoke-static {v0}, Landroid/support/v4/view/u;->c(Landroid/view/MenuItem;)Z

    .line 1440
    .end local v0    # "item":Landroid/view/MenuItem;
    :cond_2
    iget-boolean v3, v2, Landroid/support/v7/widget/Toolbar$d;->c:Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    .line 489
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->v:Landroid/support/v7/widget/ai;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ai;->a(Z)V
