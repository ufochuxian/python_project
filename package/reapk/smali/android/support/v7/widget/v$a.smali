...
.method a()V
    ...
    .prologue
    .line 149
    iget-object v0, p0, Landroid/support/v7/widget/v$a;->c:[I
    ...
    iput v0, p0, Landroid/support/v7/widget/v$a;->d:I
...
.method a(II)V
    ...
    .prologue
    .line 71
    iput p1, p0, Landroid/support/v7/widget/v$a;->a:I

    .line 72
    iput p2, p0, Landroid/support/v7/widget/v$a;->b:I
...
.method a(Landroid/support/v7/widget/RecyclerView;Z)V
    ...
    iput v1, p0, Landroid/support/v7/widget/v$a;->d:I

    .line 77
    iget-object v1, p0, Landroid/support/v7/widget/v$a;->c:[I
    ...
    .line 81
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->D:Landroid/support/v7/widget/RecyclerView$LayoutManager;
    ...
    .line 84
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->A()Z
    ...
    .line 88
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->v:Landroid/support/v7/widget/d;
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->C:I
    ...
    iput v1, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->C:I

    .line 101
    iput-boolean p2, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->D:Z

    .line 102
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->u:Landroid/support/v7/widget/RecyclerView$n;

    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$n;->b()V
    ...
    .line 94
    iget v1, p0, Landroid/support/v7/widget/v$a;->a:I

    iget v2, p0, Landroid/support/v7/widget/v$a;->b:I
...
.method a(I)Z
    ...
    .prologue
    .line 136
    iget-object v2, p0, Landroid/support/v7/widget/v$a;->c:[I

    if-eqz v2, :cond_1

    .line 137
    iget v2, p0, Landroid/support/v7/widget/v$a;->d:I
...
.method public b(II)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/v$a;->c:[I
    ...
    iput v2, p0, Landroid/support/v7/widget/v$a;->d:I
