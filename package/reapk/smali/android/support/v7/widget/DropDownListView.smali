...
.method private a(Landroid/view/View;IFF)V
    ...
    .line 191
    iput-boolean v5, p0, Landroid/support/v7/widget/DropDownListView;->k:Z
    ...
    .line 206
    iget v3, p0, Landroid/support/v7/widget/DropDownListView;->h:I
...
.method private d()V
    ...
    .line 179
    iget v1, p0, Landroid/support/v7/widget/DropDownListView;->h:I
    ...
    .line 184
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/DropDownListView;->l:Landroid/support/v4/view/bm;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/DropDownListView;->l:Landroid/support/v4/view/bm;
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    .line 141
    iget-object v8, p0, Landroid/support/v7/widget/DropDownListView;->m:Landroid/support/v4/widget/q;

    if-nez v8, :cond_3

    .line 142
    new-instance v8, Landroid/support/v4/widget/q;

    invoke-direct {v8, p0}, Landroid/support/v4/widget/q;-><init>(Landroid/widget/ListView;)V

    iput-object v8, p0, Landroid/support/v7/widget/DropDownListView;->m:Landroid/support/v4/widget/q;

    .line 144
    :cond_3
    iget-object v8, p0, Landroid/support/v7/widget/DropDownListView;->m:Landroid/support/v4/widget/q;

    invoke-virtual {v8, v10}, Landroid/support/v4/widget/q;->a(Z)Landroid/support/v4/widget/a;

    .line 145
    iget-object v8, p0, Landroid/support/v7/widget/DropDownListView;->m:Landroid/support/v4/widget/q;

    invoke-virtual {v8, p0, p1}, Landroid/support/v4/widget/q;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v2, v5, v8, v9}, Landroid/support/v7/widget/DropDownListView;->a(Landroid/view/View;IFF)V
    ...
    .line 129
    invoke-direct {p0, v2, v5}, Landroid/support/v7/widget/DropDownListView;->a(Landroid/view/View;I)V
    ...
    invoke-virtual {v8, v9}, Landroid/support/v4/widget/q;->a(Z)Landroid/support/v4/widget/a;
