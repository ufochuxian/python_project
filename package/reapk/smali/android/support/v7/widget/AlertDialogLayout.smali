...
.method private c(II)Z
    ...
    .line 82
    .local v15, "id":I
    sget v24, Landroid/support/v7/a/b$g;->topPanel:I
    ...
    .line 84
    :cond_1
    sget v24, Landroid/support/v7/a/b$g;->buttonPanel:I
    ...
    .line 86
    :cond_2
    sget v24, Landroid/support/v7/a/b$g;->contentPanel:I

    move/from16 v0, v24

    if-eq v15, v0, :cond_3

    sget v24, Landroid/support/v7/a/b$g;->customPanel:I
    ...
    .line 110
    invoke-static/range {v20 .. v20}, Landroid/support/v4/view/ap;->p(Landroid/view/View;)I
    ...
    invoke-static {v8, v0}, Landroid/support/v4/view/ap;->a(II)I
    ...
    .line 117
    invoke-static {v4}, Landroid/support/v7/widget/AlertDialogLayout;->c(Landroid/view/View;)I
    ...
    .line 140
    invoke-static/range {v18 .. v18}, Landroid/support/v4/view/ap;->p(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, v8}, Landroid/support/v4/view/ap;->a(III)I
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/view/ap;->a(III)I
    ...
    invoke-direct {v0, v9, v1}, Landroid/support/v7/widget/AlertDialogLayout;->d(II)V
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v17, Landroid/support/v7/widget/LinearLayoutCompat$b;

    .line 315
    .local v17, "lp":Landroid/support/v7/widget/LinearLayoutCompat$b;
    ...
    invoke-static {v0, v15}, Landroid/support/v4/view/h;->a(II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/LinearLayoutCompat$b;->leftMargin:I
    ...
    invoke-virtual {v0, v14}, Landroid/support/v7/widget/AlertDialogLayout;->c(I)Z
    ...
    iget v1, v0, Landroid/support/v7/widget/LinearLayoutCompat$b;->topMargin:I
    ...
    .line 345
    invoke-direct/range {v1 .. v6}, Landroid/support/v7/widget/AlertDialogLayout;->a(Landroid/view/View;IIII)V

    .line 346
    move-object/from16 v0, v17

    iget v1, v0, Landroid/support/v7/widget/LinearLayoutCompat$b;->bottomMargin:I
    ...
    .end local v17    # "lp":Landroid/support/v7/widget/LinearLayoutCompat$b;
    :cond_2
    add-int/lit8 v14, v14, 0x1
    ...
    .restart local v17    # "lp":Landroid/support/v7/widget/LinearLayoutCompat$b;
    :sswitch_2
    sub-int v1, v9, v5
    ...
    iget v0, v0, Landroid/support/v7/widget/LinearLayoutCompat$b;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/LinearLayoutCompat$b;->rightMargin:I
