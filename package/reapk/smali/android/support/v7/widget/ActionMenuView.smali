...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroid/support/v7/widget/ActionMenuView;->u:I
...
.method static a(Landroid/view/View;IIII)I
    ...
    .line 405
    .local v8, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    :cond_2
    iget-boolean v11, v8, Landroid/support/v7/widget/ActionMenuView$c;->a:Z
    ...
    :goto_2
    iput-boolean v5, v8, Landroid/support/v7/widget/ActionMenuView$c;->d:Z

    .line 429
    iput v0, v8, Landroid/support/v7/widget/ActionMenuView$c;->b:I
...
.method private c(II)V
    ...
    check-cast v23, Landroid/support/v7/widget/ActionMenuView$c;

    .line 226
    .local v23, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    const/16 v38, 0x0
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    iput v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->c:I
    ...
    iput v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->b:I
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->d:Z
    ...
    iput v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->leftMargin:I
    ...
    iput v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->rightMargin:I
    ...
    invoke-virtual/range {v38 .. v38}, Landroid/support/v7/view/menu/ActionMenuItemView;->b()Z
    ...
    iput-boolean v0, v1, Landroid/support/v7/widget/ActionMenuView$c;->e:Z

    .line 235
    move-object/from16 v0, v23

    iget-boolean v0, v0, Landroid/support/v7/widget/ActionMenuView$c;->a:Z
    ...
    invoke-static {v11, v5, v7, v0, v1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/View;IIII)I
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/ActionMenuView$c;->d:Z
    ...
    .end local v23    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    :cond_8
    if-eqz v16, :cond_a
    ...
    .line 266
    .restart local v23    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    move-object/from16 v0, v23
    ...
    iget v0, v0, Landroid/support/v7/widget/ActionMenuView$c;->b:I
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/ActionMenuView$c;->e:Z
    ...
    iput v15, v0, Landroid/support/v7/widget/ActionMenuView$c;->c:I
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/ActionMenuView$c;->f:Z
    ...
    iget v0, v0, Landroid/support/v7/widget/ActionMenuView$c;->c:I
...
.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 596
    instance-of v1, p1, Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 599
    .local v0, "result":Landroid/support/v7/widget/ActionMenuView$c;
    :goto_0
    ...
    .line 604
    .end local v0    # "result":Landroid/support/v7/widget/ActionMenuView$c;
    :cond_0
    :goto_1
    return-object v0
...
.method public a(Landroid/support/v7/view/menu/o$a;Landroid/support/v7/view/menu/h$a;)V
    ...
    .prologue
    .line 668
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->q:Landroid/support/v7/view/menu/o$a;
...
.method protected b()Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 584
    .local v0, "params":Landroid/support/v7/widget/ActionMenuView$c;
    const/16 v1, 0x10
...
.method public synthetic b(Landroid/util/AttributeSet;)Landroid/support/v7/widget/LinearLayoutCompat$b;
    .locals 1
...
.method protected synthetic b(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/LinearLayoutCompat$b;
    .locals 1
...
.method public getMenu()Landroid/view/Menu;
    ...
    .line 653
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/widget/ActionMenuPresenter;

    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->q:Landroid/support/v7/view/menu/o$a;
    ...
    :goto_0
    invoke-virtual {v2, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/o$a;)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuView;->m:Landroid/content/Context;

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/view/menu/h;->a(Landroid/support/v7/view/menu/o;Landroid/content/Context;)V

    .line 656
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:Landroid/support/v7/widget/ActionMenuPresenter;

    invoke-virtual {v1, p0}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/widget/ActionMenuView;)V
...
.method protected synthetic j()Landroid/support/v7/widget/LinearLayoutCompat$b;
    .locals 1
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/ActionMenuView;->r:Z
    ...
    check-cast v19, Landroid/support/v7/widget/ActionMenuView$c;

    .line 459
    .local v19, "p":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    invoke-virtual {v0, v10}, Landroid/support/v7/widget/ActionMenuView;->a(I)Z
    ...
    .line 491
    .end local v19    # "p":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 511
    .local v13, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    invoke-virtual/range {v27 .. v27}, Landroid/view/View;->getVisibility()I
    ...
    iget-boolean v0, v13, Landroid/support/v7/widget/ActionMenuView$c;->a:Z
    ...
    .line 503
    .end local v13    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    ...
    .line 515
    .restart local v13    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    .restart local v23    # "spacerSize":I
    .restart local v25    # "startRight":I
    .restart local v27    # "v":Landroid/view/View;
    :cond_c
    iget v0, v13, Landroid/support/v7/widget/ActionMenuView$c;->rightMargin:I
    ...
    .line 520
    iget v0, v13, Landroid/support/v7/widget/ActionMenuView$c;->leftMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 146
    iget-boolean v4, p0, Landroid/support/v7/widget/ActionMenuView;->r:Z
    ...
    :goto_0
    iput-boolean v6, p0, Landroid/support/v7/widget/ActionMenuView;->r:Z

    .line 149
    iget-boolean v6, p0, Landroid/support/v7/widget/ActionMenuView;->r:Z

    if-eq v4, v6, :cond_0

    .line 150
    iput v8, p0, Landroid/support/v7/widget/ActionMenuView;->s:I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ActionMenuView;->l:Landroid/support/v7/view/menu/h;

    if-eqz v6, :cond_1

    iget v6, p0, Landroid/support/v7/widget/ActionMenuView;->s:I

    if-eq v5, v6, :cond_1

    .line 157
    iput v5, p0, Landroid/support/v7/widget/ActionMenuView;->s:I

    .line 158
    iget-object v6, p0, Landroid/support/v7/widget/ActionMenuView;->l:Landroid/support/v7/view/menu/h;

    invoke-virtual {v6, v7}, Landroid/support/v7/view/menu/h;->c(Z)V
    ...
    .line 169
    .local v3, "lp":Landroid/support/v7/widget/ActionMenuView$c;
    iput v8, v3, Landroid/support/v7/widget/ActionMenuView$c;->rightMargin:I

    iput v8, v3, Landroid/support/v7/widget/ActionMenuView$c;->leftMargin:I
    ...
    .line 171
    .end local v0    # "child":Landroid/view/View;
    .end local v3    # "lp":Landroid/support/v7/widget/ActionMenuView$c;
    :cond_4
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/ActionMenuView$e;)V
    .locals 0
    .param p1, "listener"    # Landroid/support/v7/widget/ActionMenuView$e;
