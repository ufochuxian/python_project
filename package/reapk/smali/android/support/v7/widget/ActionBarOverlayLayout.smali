...
.field private final C:Landroid/support/v4/view/ad;
...
.field private z:Landroid/support/v4/widget/ac;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/view/ad;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->C:Landroid/support/v4/view/ad;

    .line 142
    return-void
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/p;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    sget-object v4, Landroid/support/v7/widget/ActionBarOverlayLayout;->e:[I
    ...
    iput v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->k:Landroid/graphics/drawable/Drawable;

    .line 148
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->k:Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    iput-boolean v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->l:Z

    .line 154
    invoke-static {p1}, Landroid/support/v4/widget/ac;->a(Landroid/content/Context;)Landroid/support/v4/widget/ac;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->z:Landroid/support/v4/widget/ac;
...
.method private a(FF)Z
    ...
    .line 601
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->z:Landroid/support/v4/widget/ac;
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    check-cast v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    .line 261
    .local v1, "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    if-eqz p3, :cond_0

    iget v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->leftMargin:I
    ...
    iput v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->leftMargin:I

    .line 265
    :cond_0
    if-eqz p4, :cond_1

    iget v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->topMargin:I
    ...
    iput v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->topMargin:I

    .line 269
    :cond_1
    if-eqz p6, :cond_2

    iget v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->rightMargin:I
    ...
    iput v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->rightMargin:I

    .line 273
    :cond_2
    if-eqz p5, :cond_3

    iget v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->bottomMargin:I
    ...
    iput v2, v1, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->bottomMargin:I
...
.method public a(I)V
    ...
    .line 629
    :sswitch_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->j:Landroid/support/v7/widget/p;

    invoke-interface {v0}, Landroid/support/v7/widget/p;->g()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/p;->h()V
...
.method public a(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/p;->a(Landroid/util/SparseArray;)V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/p;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method public b(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/p;->b(Landroid/util/SparseArray;)V
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/p;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->j:Landroid/support/v7/widget/p;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v3}, Landroid/support/v4/view/ap;->w(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, v0, v1}, Landroid/support/v7/widget/ay;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getNestedScrollAxes()I
    ...
    .prologue
    .line 525
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->C:Landroid/support/v4/view/ad;
...
.method public h()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/p;->k()Z
...
.method public i()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/p;->l()Z
...
.method public j()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/p;->m()Z
...
.method public m()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/p;->p()V
...
.method public n()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/p;->q()V
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v6, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    .line 431
    .local v6, "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    ...
    .line 434
    .local v4, "height":I
    iget v12, v6, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->leftMargin:I

    add-int v1, v8, v12

    .line 435
    .local v1, "childLeft":I
    iget v12, v6, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->topMargin:I
    ...
    .end local v6    # "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
...
.method protected onMeasure(II)V
    ...
    .prologue
    .line 331
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->c()V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->a:Landroid/support/v7/widget/ActionBarContainer;
    ...
    check-cast v10, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    .line 342
    .local v10, "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    move-object/from16 v0, p0
    ...
    iget v2, v10, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v10, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->rightMargin:I
    ...
    iget v2, v10, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->topMargin:I

    add-int/2addr v1, v2

    iget v2, v10, Landroid/support/v7/widget/ActionBarOverlayLayout$b;->bottomMargin:I
    ...
    .line 349
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ap;->N(Landroid/view/View;)I
    ...
    iget v15, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:I

    .line 356
    move-object/from16 v0, p0

    iget-boolean v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->n:Z
    ...
    iget-object v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->t:Landroid/graphics/Rect;

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->r:Landroid/graphics/Rect;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Landroid/graphics/Rect;

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Landroid/graphics/Rect;
    ...
    iget-boolean v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/ContentFrameLayout;

    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->t:Landroid/graphics/Rect;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/graphics/Rect;

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Landroid/graphics/Rect;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/support/v7/widget/ContentFrameLayout;

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ContentFrameLayout;->a(Landroid/graphics/Rect;)V
    ...
    .end local v10    # "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    check-cast v10, Landroid/support/v7/widget/ActionBarOverlayLayout$b;

    .line 395
    .restart local v10    # "lp":Landroid/support/v7/widget/ActionBarOverlayLayout$b;
    move-object/from16 v0, p0
    ...
    invoke-static {v12, v0, v9}, Landroid/support/v4/view/ap;->a(III)I
    ...
    invoke-static {v11, v0, v2}, Landroid/support/v4/view/ap;->a(III)I
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    .line 229
    iget v5, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->q:I
    ...
    :goto_2
    invoke-interface {v5, v3}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->k(Z)V
    ...
    :cond_1
    iget-object v3, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v7/widget/ActionBarOverlayLayout$a;

    invoke-interface {v3}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->A()V
    ...
    invoke-interface {v3}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->B()V
...
.method public setActionBarHideOffset(I)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/ap;->b(Landroid/view/View;F)V
...
.method public setActionBarVisibilityCallback(Landroid/support/v7/widget/ActionBarOverlayLayout$a;)V
    .locals 3
    .param p1, "cb"    # Landroid/support/v7/widget/ActionBarOverlayLayout$a;
    ...
    .line 168
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v7/widget/ActionBarOverlayLayout$a;

    iget v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->h:I

    invoke-interface {v1, v2}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->n(I)V

    .line 169
    iget v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->q:I
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/p;->a(Landroid/view/Window$Callback;)V
