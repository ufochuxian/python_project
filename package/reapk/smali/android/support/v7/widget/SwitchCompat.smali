...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->k:Landroid/content/res/ColorStateList;

    .line 101
    const/4 v8, 0x0

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->l:Landroid/graphics/PorterDuff$Mode;

    .line 102
    const/4 v8, 0x0

    iput-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->m:Z

    .line 103
    const/4 v8, 0x0

    iput-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->n:Z

    .line 106
    const/4 v8, 0x0

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->p:Landroid/content/res/ColorStateList;

    .line 107
    const/4 v8, 0x0

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->q:Landroid/graphics/PorterDuff$Mode;

    .line 108
    const/4 v8, 0x0

    iput-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->r:Z

    .line 109
    const/4 v8, 0x0

    iput-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->s:Z
    ...
    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->E:Landroid/view/VelocityTracker;
    ...
    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->T:Landroid/graphics/Rect;
    ...
    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->O:Landroid/text/TextPaint;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->O:Landroid/text/TextPaint;
    ...
    .line 210
    sget-object v8, Landroid/support/v7/a/b$l;->SwitchCompat:[I

    const/4 v9, 0x0

    invoke-static {p1, p2, v8, p3, v9}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;

    move-result-object v0

    .line 212
    .local v0, "a":Landroid/support/v7/widget/at;
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_android_thumb:I

    invoke-virtual {v0, v8}, Landroid/support/v7/widget/at;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->j:Landroid/graphics/drawable/Drawable;
    ...
    .line 216
    :cond_0
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_track:I

    invoke-virtual {v0, v8}, Landroid/support/v7/widget/at;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/drawable/Drawable;
    ...
    .line 220
    :cond_1
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_android_textOn:I

    invoke-virtual {v0, v8}, Landroid/support/v7/widget/at;->d(I)Ljava/lang/CharSequence;

    move-result-object v8

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->x:Ljava/lang/CharSequence;

    .line 221
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_android_textOff:I

    invoke-virtual {v0, v8}, Landroid/support/v7/widget/at;->d(I)Ljava/lang/CharSequence;

    move-result-object v8

    iput-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->y:Ljava/lang/CharSequence;

    .line 222
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_showText:I

    const/4 v9, 0x1

    invoke-virtual {v0, v8, v9}, Landroid/support/v7/widget/at;->a(IZ)Z

    move-result v8

    iput-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->z:Z

    .line 223
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_thumbTextPadding:I

    const/4 v9, 0x0

    invoke-virtual {v0, v8, v9}, Landroid/support/v7/widget/at;->e(II)I

    move-result v8

    iput v8, p0, Landroid/support/v7/widget/SwitchCompat;->t:I

    .line 225
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_switchMinWidth:I
    ...
    iput v8, p0, Landroid/support/v7/widget/SwitchCompat;->u:I

    .line 227
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_switchPadding:I
    ...
    iput v8, p0, Landroid/support/v7/widget/SwitchCompat;->v:I

    .line 229
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_splitTrack:I
    ...
    iput-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->w:Z

    .line 231
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_thumbTint:I

    invoke-virtual {v0, v8}, Landroid/support/v7/widget/at;->g(I)Landroid/content/res/ColorStateList;
    ...
    .line 233
    iput-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->k:Landroid/content/res/ColorStateList;
    ...
    .line 236
    :cond_2
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_thumbTintMode:I

    const/4 v9, -0x1

    .line 237
    invoke-virtual {v0, v8, v9}, Landroid/support/v7/widget/at;->a(II)I
    ...
    .line 236
    invoke-static {v8, v9}, Landroid/support/v7/widget/s;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v5

    .line 238
    .local v5, "thumbTintMode":Landroid/graphics/PorterDuff$Mode;
    iget-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->l:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 242
    :cond_3
    iget-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->m:Z
    ...
    .line 246
    :cond_5
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_trackTint:I
    ...
    .line 248
    iput-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->p:Landroid/content/res/ColorStateList;
    ...
    .line 251
    :cond_6
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_trackTintMode:I
    ...
    iget-object v8, p0, Landroid/support/v7/widget/SwitchCompat;->q:Landroid/graphics/PorterDuff$Mode;

    if-eq v8, v7, :cond_7

    .line 254
    iput-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->q:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 257
    :cond_7
    iget-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->r:Z

    if-nez v8, :cond_8

    iget-boolean v8, p0, Landroid/support/v7/widget/SwitchCompat;->s:Z
    ...
    .line 261
    :cond_9
    sget v8, Landroid/support/v7/a/b$l;->SwitchCompat_switchTextAppearance:I

    const/4 v9, 0x0

    invoke-virtual {v0, v8, v9}, Landroid/support/v7/widget/at;->g(II)I
    ...
    iput v8, p0, Landroid/support/v7/widget/SwitchCompat;->B:I
    ...
    iput v8, p0, Landroid/support/v7/widget/SwitchCompat;->F:I
...
.method private a(FF)Z
    ...
    .line 872
    iget-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->j:Landroid/graphics/drawable/Drawable;
    ...
    iget v7, p0, Landroid/support/v7/widget/SwitchCompat;->B:I
    ...
    iget v6, p0, Landroid/support/v7/widget/SwitchCompat;->N:I
...
.method private b(Landroid/view/MotionEvent;)V
    ...
    .line 980
    iput v5, p0, Landroid/support/v7/widget/SwitchCompat;->A:I
    ...
    .line 988
    iget-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->E:Landroid/view/VelocityTracker;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v2}, Landroid/support/v7/widget/s;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Landroid/support/v7/widget/s;->a:Landroid/graphics/Rect;
...
.method public a(Landroid/content/Context;I)V
    ...
    .line 285
    sget-object v6, Landroid/support/v7/a/b$l;->TextAppearance:[I

    invoke-static {p1, p2, v6}, Landroid/support/v7/widget/at;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/at;

    move-result-object v1

    .line 291
    .local v1, "appearance":Landroid/support/v7/widget/at;
    sget v6, Landroid/support/v7/a/b$l;->TextAppearance_android_textColor:I

    invoke-virtual {v1, v6}, Landroid/support/v7/widget/at;->g(I)Landroid/content/res/ColorStateList;
    ...
    .line 293
    iput-object v2, p0, Landroid/support/v7/widget/SwitchCompat;->P:Landroid/content/res/ColorStateList;

    .line 299
    :goto_0
    sget v6, Landroid/support/v7/a/b$l;->TextAppearance_android_textSize:I

    invoke-virtual {v1, v6, v9}, Landroid/support/v7/widget/at;->e(II)I
    ...
    iget-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->O:Landroid/text/TextPaint;
    ...
    .line 308
    :cond_0
    sget v6, Landroid/support/v7/a/b$l;->TextAppearance_android_typeface:I

    invoke-virtual {v1, v6, v8}, Landroid/support/v7/widget/at;->a(II)I

    move-result v5

    .line 309
    .local v5, "typefaceIndex":I
    sget v6, Landroid/support/v7/a/b$l;->TextAppearance_android_textStyle:I
    ...
    invoke-direct {p0, v5, v3}, Landroid/support/v7/widget/SwitchCompat;->a(II)V

    .line 313
    sget v6, Landroid/support/v7/a/b$l;->TextAppearance_textAllCaps:I

    invoke-virtual {v1, v6, v9}, Landroid/support/v7/widget/at;->a(IZ)Z
    ...
    .line 315
    new-instance v6, Landroid/support/v7/f/a;

    invoke-virtual {p0}, Landroid/support/v7/widget/SwitchCompat;->getContext()Landroid/content/Context;

    move-result-object v7

    invoke-direct {v6, v7}, Landroid/support/v7/f/a;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Landroid/support/v7/widget/SwitchCompat;->S:Landroid/text/method/TransformationMethod;

    .line 320
    :goto_1
    invoke-virtual {v1}, Landroid/support/v7/widget/at;->e()V
...
.method public a(Landroid/graphics/Typeface;I)V
    ...
    .line 360
    .local v0, "need":I
    iget-object v4, p0, Landroid/support/v7/widget/SwitchCompat;->O:Landroid/text/TextPaint;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/SwitchCompat;->T:Landroid/graphics/Rect;

    .line 1136
    .local v2, "padding":Landroid/graphics/Rect;
    move-object/from16 v0, p0

    iget v4, v0, Landroid/support/v7/widget/SwitchCompat;->K:I

    .line 1137
    .local v4, "switchLeft":I
    move-object/from16 v0, p0

    iget v6, v0, Landroid/support/v7/widget/SwitchCompat;->L:I

    .line 1138
    .local v6, "switchTop":I
    move-object/from16 v0, p0

    iget v5, v0, Landroid/support/v7/widget/SwitchCompat;->M:I

    .line 1139
    .local v5, "switchRight":I
    move-object/from16 v0, p0

    iget v3, v0, Landroid/support/v7/widget/SwitchCompat;->N:I
    ...
    iget-object v15, v0, Landroid/support/v7/widget/SwitchCompat;->j:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v15}, Landroid/support/v7/widget/s;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget-object v15, v0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/drawable/Drawable;
    ...
    iget v15, v0, Landroid/support/v7/widget/SwitchCompat;->J:I
    ...
    .line 1189
    invoke-static {v1, v9, v6, v10, v3}, Landroid/support/v4/d/a/a;->a(Landroid/graphics/drawable/Drawable;IIII)V
    ...
    :cond_6
    sget-object v8, Landroid/support/v7/widget/s;->a:Landroid/graphics/Rect;
...
.method protected drawableStateChanged()V
    ...
    .line 1343
    :cond_0
    iget-object v3, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/drawable/Drawable;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, Landroid/support/v7/widget/SwitchCompat;->T:Landroid/graphics/Rect;

    .line 1203
    .local v8, "padding":Landroid/graphics/Rect;
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/drawable/Drawable;
    ...
    iget v14, v0, Landroid/support/v7/widget/SwitchCompat;->L:I

    .line 1211
    .local v14, "switchTop":I
    move-object/from16 v0, p0

    iget v10, v0, Landroid/support/v7/widget/SwitchCompat;->N:I
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/SwitchCompat;->w:Z
    ...
    iget-object v13, v0, Landroid/support/v7/widget/SwitchCompat;->Q:Landroid/text/Layout;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/SwitchCompat;->P:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/SwitchCompat;->O:Landroid/text/TextPaint;
    ...
    iget-object v13, v0, Landroid/support/v7/widget/SwitchCompat;->R:Landroid/text/Layout;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/SwitchCompat;->x:Ljava/lang/CharSequence;
    ...
    .line 1402
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/SwitchCompat;->y:Ljava/lang/CharSequence;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {v8}, Landroid/support/v7/widget/s;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1100
    .local v4, "switchLeft":I
    iget v8, p0, Landroid/support/v7/widget/SwitchCompat;->H:I
    ...
    .line 1112
    .local v6, "switchTop":I
    iget v8, p0, Landroid/support/v7/widget/SwitchCompat;->I:I
    ...
    .line 1128
    iput v6, p0, Landroid/support/v7/widget/SwitchCompat;->L:I

    .line 1129
    iput v3, p0, Landroid/support/v7/widget/SwitchCompat;->N:I

    .line 1130
    iput v5, p0, Landroid/support/v7/widget/SwitchCompat;->M:I
    ...
    iget v9, p0, Landroid/support/v7/widget/SwitchCompat;->I:I
...
.method public onMeasure(II)V
    ...
    .prologue
    .line 781
    iget-boolean v11, p0, Landroid/support/v7/widget/SwitchCompat;->z:Z

    if-eqz v11, :cond_1

    .line 782
    iget-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->Q:Landroid/text/Layout;

    if-nez v11, :cond_0

    .line 783
    iget-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->x:Ljava/lang/CharSequence;

    invoke-direct {p0, v11}, Landroid/support/v7/widget/SwitchCompat;->a(Ljava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v11

    iput-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->Q:Landroid/text/Layout;

    .line 786
    :cond_0
    iget-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->R:Landroid/text/Layout;

    if-nez v11, :cond_1

    .line 787
    iget-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->y:Ljava/lang/CharSequence;

    invoke-direct {p0, v11}, Landroid/support/v7/widget/SwitchCompat;->a(Ljava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v11

    iput-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->R:Landroid/text/Layout;
    ...
    iget-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->j:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v12, p0, Landroid/support/v7/widget/SwitchCompat;->R:Landroid/text/Layout;
    ...
    iget v12, p0, Landroid/support/v7/widget/SwitchCompat;->t:I
    ...
    iput v11, p0, Landroid/support/v7/widget/SwitchCompat;->J:I

    .line 815
    iget-object v11, p0, Landroid/support/v7/widget/SwitchCompat;->o:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v11}, Landroid/support/v7/widget/s;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_2
    iget v11, p0, Landroid/support/v7/widget/SwitchCompat;->u:I

    iget v12, p0, Landroid/support/v7/widget/SwitchCompat;->J:I
    ...
    iput v7, p0, Landroid/support/v7/widget/SwitchCompat;->H:I

    .line 837
    iput v6, p0, Landroid/support/v7/widget/SwitchCompat;->I:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 890
    iget-object v9, p0, Landroid/support/v7/widget/SwitchCompat;->E:Landroid/view/VelocityTracker;
    ...
    invoke-direct {p0, v5, v6}, Landroid/support/v7/widget/SwitchCompat;->a(FF)Z
    ...
    .line 897
    iput v8, p0, Landroid/support/v7/widget/SwitchCompat;->A:I

    .line 898
    iput v5, p0, Landroid/support/v7/widget/SwitchCompat;->C:F

    .line 899
    iput v6, p0, Landroid/support/v7/widget/SwitchCompat;->D:F
    ...
    .end local v6    # "y":F
    :pswitch_2
    iget v9, p0, Landroid/support/v7/widget/SwitchCompat;->A:I
    ...
    iget v7, p0, Landroid/support/v7/widget/SwitchCompat;->C:F
    ...
    iget v9, p0, Landroid/support/v7/widget/SwitchCompat;->B:I
    ...
    iget v7, p0, Landroid/support/v7/widget/SwitchCompat;->D:F
    ...
    .line 915
    :cond_1
    iput v11, p0, Landroid/support/v7/widget/SwitchCompat;->A:I
    ...
    iget v9, p0, Landroid/support/v7/widget/SwitchCompat;->C:F
    ...
    .line 939
    :cond_2
    iget v9, p0, Landroid/support/v7/widget/SwitchCompat;->G:F

    add-float/2addr v9, v1

    invoke-static {v9, v10, v7}, Landroid/support/v7/widget/SwitchCompat;->a(FFF)F

    move-result v2

    .line 940
    .local v2, "newPos":F
    iget v7, p0, Landroid/support/v7/widget/SwitchCompat;->G:F
    ...
    iput v7, p0, Landroid/support/v7/widget/SwitchCompat;->A:I

    .line 959
    iget-object v7, p0, Landroid/support/v7/widget/SwitchCompat;->E:Landroid/view/VelocityTracker;
