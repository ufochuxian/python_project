...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 144
    iput v5, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->j:I
    ...
    .line 146
    :cond_0
    iput v5, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->i:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 183
    iget-object v9, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->k:Landroid/support/v7/widget/aa;
    ...
    .local v5, "menuAdapter":Landroid/support/v7/view/menu/g;
    :goto_0
    const/4 v6, 0x0
    ...
    invoke-virtual {v5}, Landroid/support/v7/view/menu/g;->getCount()I
    ...
    .line 204
    invoke-virtual {v5, v3}, Landroid/support/v7/view/menu/g;->a(I)Landroid/support/v7/view/menu/k;
    ...
    :cond_0
    iget-object v7, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->l:Landroid/view/MenuItem;
    ...
    .line 211
    invoke-virtual {v5}, Landroid/support/v7/view/menu/g;->b()Landroid/support/v7/view/menu/h;

    move-result-object v4

    .line 212
    .local v4, "menu":Landroid/support/v7/view/menu/h;
    if-eqz v7, :cond_1

    .line 213
    iget-object v9, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->k:Landroid/support/v7/widget/aa;

    invoke-interface {v9, v4, v7}, Landroid/support/v7/widget/aa;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    .line 216
    :cond_1
    iput-object v6, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->l:Landroid/view/MenuItem;
    ...
    invoke-interface {v9, v4, v6}, Landroid/support/v7/widget/aa;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    .line 224
    .end local v0    # "adapter":Landroid/widget/ListAdapter;
    .end local v2    # "headersCount":I
    .end local v4    # "menu":Landroid/support/v7/view/menu/h;
    .end local v5    # "menuAdapter":Landroid/support/v7/view/menu/g;
    ...
    .restart local v5    # "menuAdapter":Landroid/support/v7/view/menu/g;
    goto :goto_0
.end method
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->i:I
    ...
    iget v1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->j:I
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/g;->b()Landroid/support/v7/view/menu/h;
...
.method public setHoverListener(Landroid/support/v7/widget/aa;)V
    ...
    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->k:Landroid/support/v7/widget/aa;
