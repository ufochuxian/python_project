...
.method constructor <init>(Landroid/support/v4/h/e;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 0
    .param p1, "this$0"    # Landroid/support/v4/h/e;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 344
    :try_start_0
    iget-object v8, p0, Landroid/support/v4/h/e$2;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v8, p0, Landroid/support/v4/h/e$2;->h:Landroid/support/v4/h/e;

    iget-object v8, v8, Landroid/support/v4/h/e;->a:Landroid/content/Context;

    iget-object v9, p0, Landroid/support/v4/h/e$2;->b:Landroid/print/PrintAttributes;
    ...
    iget-object v9, p0, Landroid/support/v4/h/e$2;->c:Landroid/graphics/Bitmap;

    iget-object v10, p0, Landroid/support/v4/h/e$2;->b:Landroid/print/PrintAttributes;
    ...
    .line 351
    invoke-static {v8, v9, v10}, Landroid/support/v4/h/e;->a(Landroid/support/v4/h/e;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-boolean v8, v8, Landroid/support/v4/h/e;->j:Z
    ...
    iget v11, p0, Landroid/support/v4/h/e$2;->e:I

    .line 376
    invoke-static {v8, v9, v10, v0, v11}, Landroid/support/v4/h/e;->a(Landroid/support/v4/h/e;IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    .line 407
    iget-object v8, p0, Landroid/support/v4/h/e$2;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :goto_3
    :try_start_4
    iget-object v8, p0, Landroid/support/v4/h/e$2;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v9, p0, Landroid/support/v4/h/e$2;->d:Landroid/print/PrintAttributes;
    ...
    .line 407
    iget-object v9, p0, Landroid/support/v4/h/e$2;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_6
