...
.method constructor <init>(Landroid/support/v4/d/a/i$a;Landroid/content/res/Resources;)V
    .locals 0
    .param p1, "state"    # Landroid/support/v4/d/a/i$a;
...
.method private a(Landroid/content/res/Resources;)V
    ...
    iget-object v1, v1, Landroid/support/v4/d/a/i$a;->b:Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    invoke-virtual {p0, v1, p1}, Landroid/support/v4/d/a/i;->a(Landroid/graphics/drawable/Drawable$ConstantState;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
...
.method private a([I)Z
    ...
    .line 287
    :cond_1
    iget-object v5, p0, Landroid/support/v4/d/a/i;->b:Landroid/support/v4/d/a/i$a;

    iget-object v1, v5, Landroid/support/v4/d/a/i$a;->c:Landroid/content/res/ColorStateList;

    .line 288
    .local v1, "tintList":Landroid/content/res/ColorStateList;
    iget-object v5, p0, Landroid/support/v4/d/a/i;->b:Landroid/support/v4/d/a/i$a;

    iget-object v2, v5, Landroid/support/v4/d/a/i$a;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 292
    .local v0, "color":I
    iget-boolean v5, p0, Landroid/support/v4/d/a/i;->f:Z

    if-eqz v5, :cond_2

    iget v5, p0, Landroid/support/v4/d/a/i;->d:I

    if-ne v0, v5, :cond_2

    iget-object v5, p0, Landroid/support/v4/d/a/i;->e:Landroid/graphics/PorterDuff$Mode;

    if-eq v2, v5, :cond_0

    .line 293
    :cond_2
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/d/a/i;->setColorFilter(ILandroid/graphics/PorterDuff$Mode;)V

    .line 294
    iput v0, p0, Landroid/support/v4/d/a/i;->d:I

    .line 295
    iput-object v2, p0, Landroid/support/v4/d/a/i;->e:Landroid/graphics/PorterDuff$Mode;

    .line 296
    iput-boolean v4, p0, Landroid/support/v4/d/a/i;->f:Z
    ...
    :cond_3
    iput-boolean v3, p0, Landroid/support/v4/d/a/i;->f:Z
...
.method public isStateful()Z
    ...
    iget-object v0, v1, Landroid/support/v4/d/a/i$a;->c:Landroid/content/res/ColorStateList;
