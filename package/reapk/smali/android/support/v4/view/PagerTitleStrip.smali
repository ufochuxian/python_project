...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->h:I

    .line 58
    const/high16 v7, -0x40800000    # -1.0f

    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->e:F

    .line 65
    new-instance v7, Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-direct {v7, p0}, Landroid/support/v4/view/PagerTitleStrip$a;-><init>(Landroid/support/v4/view/PagerTitleStrip;)V

    iput-object v7, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Landroid/support/v4/view/PagerTitleStrip$a;
    ...
    iput-object v7, p0, Landroid/support/v4/view/PagerTitleStrip;->b:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/widget/TextView;
    ...
    iput-object v7, p0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;

    invoke-virtual {p0, v7}, Landroid/support/v4/view/PagerTitleStrip;->addView(Landroid/view/View;)V

    .line 128
    sget-object v7, Landroid/support/v4/view/PagerTitleStrip;->o:[I
    ...
    invoke-static {v7, v4}, Landroid/support/v4/widget/ai;->a(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v9, v7}, Landroid/support/v4/view/PagerTitleStrip;->a(IF)V
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->j:I
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->f:I
    ...
    .line 157
    sget-object v7, Landroid/support/v4/view/PagerTitleStrip;->p:[I
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->i:I
...
.method a(IFZ)V
    ...
    invoke-virtual/range {v42 .. v42}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/af;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILandroid/support/v4/view/af;)V
    ...
    iput-boolean v0, v1, Landroid/support/v4/view/PagerTitleStrip;->l:Z
...
.method a(ILandroid/support/v4/view/af;)V
    .locals 12
    .param p1, "currentItem"    # I
    .param p2, "adapter"    # Landroid/support/v4/view/af;
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/af;->getCount()I
    ...
    :goto_0
    iput-boolean v9, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Z
    ...
    invoke-virtual {p2, v9}, Landroid/support/v4/view/af;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    .line 286
    iget-object v10, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/widget/TextView;
    ...
    .line 287
    invoke-virtual {p2, p1}, Landroid/support/v4/view/af;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    .line 293
    :cond_1
    iget-object v9, p0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
    ...
    .line 308
    iget-boolean v9, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Z

    if-nez v9, :cond_2

    .line 309
    iget v9, p0, Landroid/support/v4/view/PagerTitleStrip;->e:F

    invoke-virtual {p0, p1, v9, v8}, Landroid/support/v4/view/PagerTitleStrip;->a(IFZ)V

    .line 312
    :cond_2
    iput-boolean v8, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Z
...
.method a(Landroid/support/v4/view/af;Landroid/support/v4/view/af;)V
    .locals 1
    .param p1, "oldAdapter"    # Landroid/support/v4/view/af;
    .param p2, "newAdapter"    # Landroid/support/v4/view/af;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/view/af;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/af;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILandroid/support/v4/view/af;)V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {v1, v3}, Landroid/support/v4/view/ViewPager;->setInternalPageChangeListener(Landroid/support/v4/view/ViewPager$f;)Landroid/support/v4/view/ViewPager$f;

    .line 260
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {v1, v3}, Landroid/support/v4/view/ViewPager;->addOnAdapterChangeListener(Landroid/support/v4/view/ViewPager$e;)V

    .line 261
    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    .line 262
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->n:Ljava/lang/ref/WeakReference;
    ...
    check-cast v3, Landroid/support/v4/view/af;

    :goto_0
    invoke-virtual {p0, v3, v0}, Landroid/support/v4/view/PagerTitleStrip;->a(Landroid/support/v4/view/af;Landroid/support/v4/view/af;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(Landroid/support/v4/view/af;Landroid/support/v4/view/af;)V
...
.method protected onMeasure(II)V
    ...
    iget-object v13, p0, Landroid/support/v4/view/PagerTitleStrip;->b:Landroid/widget/TextView;

    invoke-virtual {v13, v3, v1}, Landroid/widget/TextView;->measure(II)V

    .line 444
    iget-object v13, p0, Landroid/support/v4/view/PagerTitleStrip;->c:Landroid/widget/TextView;

    invoke-virtual {v13, v3, v1}, Landroid/widget/TextView;->measure(II)V

    .line 445
    iget-object v13, p0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
    ...
    invoke-static {v13}, Landroid/support/v4/view/ap;->p(Landroid/view/View;)I
    ...
    invoke-static {v4, v0, v13}, Landroid/support/v4/view/ap;->a(III)I
...
.method public setNonPrimaryAlpha(F)V
    ...
    iput v1, p0, Landroid/support/v4/view/PagerTitleStrip;->s:I

    .line 200
    iget v1, p0, Landroid/support/v4/view/PagerTitleStrip;->s:I

    shl-int/lit8 v1, v1, 0x18

    iget v2, p0, Landroid/support/v4/view/PagerTitleStrip;->f:I
