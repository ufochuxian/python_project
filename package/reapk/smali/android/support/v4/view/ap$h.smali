...
.method public G(Landroid/view/View;)Landroid/support/v4/view/bm;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ap$h;->a:Ljava/util/WeakHashMap;
    ...
    .line 1402
    .local v0, "vpa":Landroid/support/v4/view/bm;
    if-nez v0, :cond_1

    .line 1403
    new-instance v0, Landroid/support/v4/view/bm;

    .end local v0    # "vpa":Landroid/support/v4/view/bm;
    invoke-direct {v0, p1}, Landroid/support/v4/view/bm;-><init>(Landroid/view/View;)V

    .line 1404
    .restart local v0    # "vpa":Landroid/support/v4/view/bm;
    iget-object v1, p0, Landroid/support/v4/view/ap$h;->a:Ljava/util/WeakHashMap;
...
.method public a(Landroid/view/View;)Z
    ...
    .line 1375
    sget-boolean v3, Landroid/support/v4/view/ap$h;->c:Z
    ...
    .line 1378
    :cond_0
    sget-object v3, Landroid/support/v4/view/ap$h;->b:Ljava/lang/reflect/Field;
    ...
    sput-object v3, Landroid/support/v4/view/ap$h;->b:Ljava/lang/reflect/Field;
    ...
    sput-boolean v1, Landroid/support/v4/view/ap$h;->c:Z
