...
.method public a(Landroid/view/ViewParent;Landroid/view/View;)V
    ...
    invoke-interface {p1, p2}, Landroid/support/v4/view/ac;->onStopNestedScroll(Landroid/view/View;)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;IIII)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/view/ac;->onNestedScroll(Landroid/view/View;IIII)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;II[I)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/v4/view/ac;->onNestedPreScroll(Landroid/view/View;II[I)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;FF)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/ac;->onNestedPreFling(Landroid/view/View;FF)Z
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/v4/view/ac;->onNestedFling(Landroid/view/View;FFZ)Z
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/ac;->onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
...
.method public b(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/ac;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
