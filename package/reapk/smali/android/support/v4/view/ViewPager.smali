...
.field private static final sPositionComparator:Landroid/support/v4/view/ViewPager$k;


# instance fields
.field private mActivePointerId:I

.field mAdapter:Landroid/support/v4/view/af;
...
.field private mLeftEdge:Landroid/support/v4/widget/j;
...
.field private mRightEdge:Landroid/support/v4/widget/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->sPositionComparator:Landroid/support/v4/view/ViewPager$k;
...
.method private calculatePageOffsets(Landroid/support/v4/view/ViewPager$b;ILandroid/support/v4/view/ViewPager$b;)V
    ...
    .prologue
    .line 1322
    iget-object v12, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    iget v12, p1, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    iget v12, v0, Landroid/support/v4/view/ViewPager$b;->e:F

    move-object/from16 v0, p3

    iget v13, v0, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    :goto_2
    iget v12, v3, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    invoke-virtual {v12, v9}, Landroid/support/v4/view/af;->getPageWidth(I)F
    ...
    .line 1346
    :cond_2
    iput v7, v3, Landroid/support/v4/view/ViewPager$b;->e:F

    .line 1347
    iget v12, v3, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    iget v7, v0, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    iget v7, p1, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    iget v12, p1, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    iget v13, p1, Landroid/support/v4/view/ViewPager$b;->d:F
...
.method private completeScroll(Z)V
    ...
    iget-boolean v9, v1, Landroid/support/v4/view/ViewPager$b;->c:Z
    ...
    invoke-static {p0, v8}, Landroid/support/v4/view/ap;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private determineTargetPage(IFII)I
    ...
    .line 2432
    .local v0, "firstItem":Landroid/support/v4/view/ViewPager$b;
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mItems:Ljava/util/ArrayList;
    ...
    .line 2435
    .local v1, "lastItem":Landroid/support/v4/view/ViewPager$b;
    ...
    .line 2438
    .end local v0    # "firstItem":Landroid/support/v4/view/ViewPager$b;
    .end local v1    # "lastItem":Landroid/support/v4/view/ViewPager$b;
    :cond_0
    return v2
...
.method private dispatchOnPageScrolled(IFI)V
    ...
    .prologue
    .line 1943
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mOnPageChangeListener:Landroid/support/v4/view/ViewPager$f;
    ...
    invoke-interface {v3, p1, p2, p3}, Landroid/support/v4/view/ViewPager$f;->onPageScrolled(IFI)V
    ...
    .line 1949
    .local v1, "listener":Landroid/support/v4/view/ViewPager$f;
    if-eqz v1, :cond_1

    .line 1950
    invoke-interface {v1, p1, p2, p3}, Landroid/support/v4/view/ViewPager$f;->onPageScrolled(IFI)V
    ...
    .line 1954
    .end local v0    # "i":I
    .end local v1    # "listener":Landroid/support/v4/view/ViewPager$f;
    .end local v2    # "z":I
    :cond_2
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mInternalPageChangeListener:Landroid/support/v4/view/ViewPager$f;
...
.method private dispatchOnPageSelected(I)V
    ...
    invoke-interface {v3, p1}, Landroid/support/v4/view/ViewPager$f;->onPageSelected(I)V
...
.method private dispatchOnScrollStateChanged(I)V
    ...
    invoke-interface {v3, p1}, Landroid/support/v4/view/ViewPager$f;->onPageScrollStateChanged(I)V
    ...
    .line 1984
    invoke-interface {v1, p1}, Landroid/support/v4/view/ViewPager$f;->onPageScrollStateChanged(I)V
...
.method private enableLayers(Z)V
    ...
    invoke-static {v3, v2, v4}, Landroid/support/v4/view/ap;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method private infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$b;
    ...
    .line 2389
    .local v3, "lastItem":Landroid/support/v4/view/ViewPager$b;
    const/4 v1, 0x0
    ...
    .line 2392
    .local v2, "ii":Landroid/support/v4/view/ViewPager$b;
    if-nez v0, :cond_1
    ...
    .line 2394
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mTempItem:Landroid/support/v4/view/ViewPager$b;
    ...
    iput v13, v2, Landroid/support/v4/view/ViewPager$b;->e:F

    .line 2396
    add-int/lit8 v13, v5, 0x1

    iput v13, v2, Landroid/support/v4/view/ViewPager$b;->b:I

    .line 2397
    iget-object v13, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;

    iget v14, v2, Landroid/support/v4/view/ViewPager$b;->b:I

    invoke-virtual {v13, v14}, Landroid/support/v4/view/af;->getPageWidth(I)F

    move-result v13

    iput v13, v2, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    .line 2400
    :cond_1
    iget v9, v2, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    iget v13, v2, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    .line 2418
    .end local v2    # "ii":Landroid/support/v4/view/ViewPager$b;
    .end local v3    # "lastItem":Landroid/support/v4/view/ViewPager$b;
    ...
    .restart local v2    # "ii":Landroid/support/v4/view/ViewPager$b;
    .restart local v3    # "lastItem":Landroid/support/v4/view/ViewPager$b;
    ...
    .line 2414
    iget v6, v2, Landroid/support/v4/view/ViewPager$b;->d:F
...
.method private pageScrolled(I)Z
    ...
    iget v0, v1, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    iget v9, v1, Landroid/support/v4/view/ViewPager$b;->e:F

    sub-float/2addr v8, v9

    iget v9, v1, Landroid/support/v4/view/ViewPager$b;->d:F
...
.method private performDrag(F)Z
    ...
    .line 2344
    .local v3, "firstItem":Landroid/support/v4/view/ViewPager$b;
    move-object/from16 v0, p0
    ...
    .line 2345
    .local v4, "lastItem":Landroid/support/v4/view/ViewPager$b;
    iget v14, v3, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    .line 2347
    iget v14, v3, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    .line 2349
    :cond_0
    iget v14, v4, Landroid/support/v4/view/ViewPager$b;->b:I

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;

    invoke-virtual {v15}, Landroid/support/v4/view/af;->getCount()I
    ...
    .line 2351
    iget v14, v4, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/j;
    ...
    invoke-virtual {v14, v15}, Landroid/support/v4/widget/j;->a(F)Z
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/j;
...
.method private recomputeScrollPosition(IIII)V
    ...
    invoke-virtual {p0, v8}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$b;
...
.method private removeNonDecorViews()V
    ...
    .line 558
    .local v2, "lp":Landroid/support/v4/view/ViewPager$c;
    ...
    .end local v2    # "lp":Landroid/support/v4/view/ViewPager$c;
    :cond_1
    return-void
.end method
...
.method private resetTouch()Z
    ...
    .line 2317
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/j;

    invoke-virtual {v1}, Landroid/support/v4/widget/j;->c()Z

    move-result v1

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/j;
...
.method private scrollToItem(IZIZ)V
    ...
    .line 676
    .local v0, "curInfo":Landroid/support/v4/view/ViewPager$b;
    const/4 v1, 0x0
    ...
    iget v5, v0, Landroid/support/v4/view/ViewPager$b;->e:F
...
.method private sortChildDrawingOrder()V
    ...
    sget-object v4, Landroid/support/v4/view/ViewPager;->sPositionComparator:Landroid/support/v4/view/ViewPager$k;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2926
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$b;

    move-result-object v4

    .line 2927
    .local v4, "ii":Landroid/support/v4/view/ViewPager$b;
    if-eqz v4, :cond_0
    ...
    .line 2923
    .end local v4    # "ii":Landroid/support/v4/view/ViewPager$b;
    :cond_0
...
.method addNewItem(II)Landroid/support/v4/view/ViewPager$b;
    ...
    .line 1034
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/view/af;->getPageWidth(I)F
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    iget v3, v2, Landroid/support/v4/view/ViewPager$b;->b:I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1497
    .local v0, "lp":Landroid/support/v4/view/ViewPager$c;
...
.method public canScrollHorizontally(I)Z
    ...
    .line 2709
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
...
.method dataSetChanged()V
    ...
    iget-object v13, v4, Landroid/support/v4/view/ViewPager$b;->a:Ljava/lang/Object;

    invoke-virtual {v12, v13}, Landroid/support/v4/view/af;->getItemPosition(Ljava/lang/Object;)I
    ...
    .restart local v4    # "ii":Landroid/support/v4/view/ViewPager$b;
    ...
    invoke-virtual {v12, p0}, Landroid/support/v4/view/af;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget v13, v4, Landroid/support/v4/view/ViewPager$b;->b:I

    iget-object v14, v4, Landroid/support/v4/view/ViewPager$b;->a:Ljava/lang/Object;

    invoke-virtual {v12, p0, v13, v14}, Landroid/support/v4/view/af;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 1082
    :cond_4
    iget v12, v4, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    .line 1088
    :cond_5
    iput v9, v4, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    invoke-virtual {v12, p0}, Landroid/support/v4/view/af;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    .line 1105
    .local v6, "lp":Landroid/support/v4/view/ViewPager$c;
    iget-boolean v12, v6, Landroid/support/v4/view/ViewPager$c;->a:Z
    ...
    iput v12, v6, Landroid/support/v4/view/ViewPager$c;->c:F
    ...
    .line 1110
    .end local v1    # "child":Landroid/view/View;
    .end local v6    # "lp":Landroid/support/v4/view/ViewPager$c;
    :cond_9
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    .line 2449
    invoke-virtual {v5}, Landroid/support/v4/view/af;->getCount()I
    ...
    .line 2450
    :cond_0
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/j;

    invoke-virtual {v5}, Landroid/support/v4/widget/j;->a()Z
    ...
    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/j;->a(II)V

    .line 2458
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/j;

    invoke-virtual {v5, p1}, Landroid/support/v4/widget/j;->a(Landroid/graphics/Canvas;)Z
    ...
    :cond_1
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/j;
    ...
    invoke-virtual {v5}, Landroid/support/v4/widget/j;->b()V
...
.method public endFakeDrag()V
    ...
    .line 2575
    :cond_0
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    invoke-static {v7, v9}, Landroid/support/v4/view/an;->a(Landroid/view/VelocityTracker;I)F
    ...
    iget v10, v1, Landroid/support/v4/view/ViewPager$b;->e:F

    sub-float/2addr v9, v10

    iget v10, v1, Landroid/support/v4/view/ViewPager$b;->d:F
...
.method public fakeDragBy(F)V
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    .line 2622
    .local v11, "firstItem":Landroid/support/v4/view/ViewPager$b;
    move-object/from16 v0, p0
    ...
    check-cast v12, Landroid/support/v4/view/ViewPager$b;

    .line 2623
    .local v12, "lastItem":Landroid/support/v4/view/ViewPager$b;
    iget v2, v11, Landroid/support/v4/view/ViewPager$b;->b:I

    if-eqz v2, :cond_2

    .line 2624
    iget v2, v11, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    .line 2626
    :cond_2
    iget v2, v12, Landroid/support/v4/view/ViewPager$b;->b:I

    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    .line 2627
    iget v2, v12, Landroid/support/v4/view/ViewPager$b;->e:F
...
.method public getAdapter()Landroid/support/v4/view/af;
    ...
    .prologue
    .line 571
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v1, v2, Landroid/support/v4/view/ViewPager$c;->f:I
...
.method infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$b;
    ...
    .line 1534
    .local v1, "ii":Landroid/support/v4/view/ViewPager$b;
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
...
.method initViewPager()V
    ...
    iput-object v3, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/j;
    ...
    iput-object v3, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/j;
    ...
    .line 419
    new-instance v3, Landroid/support/v4/view/ViewPager$d;

    invoke-direct {v3, p0}, Landroid/support/v4/view/ViewPager$d;-><init>(Landroid/support/v4/view/ViewPager;)V

    invoke-static {p0, v3}, Landroid/support/v4/view/ap;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
    ...
    invoke-static {p0, v3}, Landroid/support/v4/view/ap;->a(Landroid/view/View;Landroid/support/v4/view/ae;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v13, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    .line 2495
    .local v3, "ii":Landroid/support/v4/view/ViewPager$b;
    iget v8, v3, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    .line 2497
    .local v4, "itemCount":I
    iget v2, v3, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    check-cast v13, Landroid/support/v4/view/ViewPager$b;

    iget v6, v13, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    .line 2500
    :goto_1
    iget v13, v3, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    .line 2506
    iget v13, v3, Landroid/support/v4/view/ViewPager$b;->e:F

    iget v14, v3, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    invoke-virtual {v13, v9}, Landroid/support/v4/view/af;->getPageWidth(I)F
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v17, Landroid/support/v4/view/ViewPager$c;

    .line 1719
    .local v17, "lp":Landroid/support/v4/view/ViewPager$c;
    const/4 v6, 0x0
    ...
    .end local v17    # "lp":Landroid/support/v4/view/ViewPager$c;
    ...
    .restart local v17    # "lp":Landroid/support/v4/view/ViewPager$c;
    ...
    .local v15, "ii":Landroid/support/v4/view/ViewPager$b;
    if-eqz v15, :cond_3
    ...
    iget v0, v15, Landroid/support/v4/view/ViewPager$b;->e:F
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/ViewPager$c;->d:Z
    ...
    iput-boolean v0, v1, Landroid/support/v4/view/ViewPager$c;->d:Z
    ...
    .end local v6    # "childLeft":I
    .end local v7    # "childTop":I
    .end local v15    # "ii":Landroid/support/v4/view/ViewPager$b;
...
.method protected onMeasure(II)V
    ...
    check-cast v13, Landroid/support/v4/view/ViewPager$c;

    .line 1596
    .local v13, "lp":Landroid/support/v4/view/ViewPager$c;
    if-eqz v13, :cond_5

    iget-boolean v0, v13, Landroid/support/v4/view/ViewPager$c;->a:Z
    ...
    .line 1597
    iget v0, v13, Landroid/support/v4/view/ViewPager$c;->b:I
    ...
    iget v0, v13, Landroid/support/v4/view/ViewPager$c;->width:I
    ...
    .line 1618
    :cond_3
    iget v0, v13, Landroid/support/v4/view/ViewPager$c;->height:I
    ...
    .line 1621
    iget v9, v13, Landroid/support/v4/view/ViewPager$c;->height:I
    ...
    .end local v13    # "lp":Landroid/support/v4/view/ViewPager$c;
    ...
    .restart local v13    # "lp":Landroid/support/v4/view/ViewPager$c;
    ...
    iget v0, v13, Landroid/support/v4/view/ViewPager$c;->c:F
...
.method protected onPageScrolled(IFI)V
    ...
    .line 1896
    :cond_1
    iget v12, v6, Landroid/support/v4/view/ViewPager$c;->b:I
    ...
    .line 1926
    iget-object v12, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$g;
    ...
    .line 1933
    .restart local v6    # "lp":Landroid/support/v4/view/ViewPager$c;
    iget-boolean v12, v6, Landroid/support/v4/view/ViewPager$c;->a:Z
    ...
    invoke-interface {v12, v0, v10}, Landroid/support/v4/view/ViewPager$g;->a(Landroid/view/View;F)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .prologue
    .line 1472
    instance-of v1, p1, Landroid/support/v4/view/ViewPager$i;
    ...
    .line 1477
    check-cast v0, Landroid/support/v4/view/ViewPager$i;

    .line 1478
    .local v0, "ss":Landroid/support/v4/view/ViewPager$i;
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager$i;->a()Landroid/os/Parcelable;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager$i;->c:Landroid/os/Parcelable;

    iget-object v3, v0, Landroid/support/v4/view/ViewPager$i;->d:Ljava/lang/ClassLoader;

    invoke-virtual {v1, v2, v3}, Landroid/support/v4/view/af;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V

    .line 1482
    iget v1, v0, Landroid/support/v4/view/ViewPager$i;->b:I
    ...
    .line 1485
    iget-object v1, v0, Landroid/support/v4/view/ViewPager$i;->c:Landroid/os/Parcelable;

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->mRestoredAdapterState:Landroid/os/Parcelable;

    .line 1486
    iget-object v1, v0, Landroid/support/v4/view/ViewPager$i;->d:Ljava/lang/ClassLoader;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/view/ViewPager$i;-><init>(Landroid/os/Parcelable;)V

    .line 1463
    .local v0, "ss":Landroid/support/v4/view/ViewPager$i;
    iget v2, p0, Landroid/support/v4/view/ViewPager;->mCurItem:I

    iput v2, v0, Landroid/support/v4/view/ViewPager$i;->b:I
    ...
    iput-object v2, v0, Landroid/support/v4/view/ViewPager$i;->c:Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/support/v4/view/af;->getCount()I
    ...
    .line 2274
    .local v17, "scrollX":I
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$b;

    move-result-object v8

    .line 2275
    .local v8, "ii":Landroid/support/v4/view/ViewPager$b;
    move-object/from16 v0, p0
    ...
    iget v7, v8, Landroid/support/v4/view/ViewPager$b;->b:I
    ...
    iget v0, v8, Landroid/support/v4/view/ViewPager$b;->e:F

    move/from16 v26, v0

    sub-float v25, v25, v26

    iget v0, v8, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    .end local v8    # "ii":Landroid/support/v4/view/ViewPager$b;
...
.method populate(I)V
    ...
    .line 1121
    .local v20, "oldCurInfo":Landroid/support/v4/view/ViewPager$b;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$b;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/af;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/support/v4/view/af;->getCount()I
    ...
    .line 1173
    .local v9, "curItem":Landroid/support/v4/view/ViewPager$b;
    const/4 v8, 0x0
    ...
    check-cast v16, Landroid/support/v4/view/ViewPager$b;

    .line 1175
    .local v16, "ii":Landroid/support/v4/view/ViewPager$b;
    ...
    .line 1181
    .end local v16    # "ii":Landroid/support/v4/view/ViewPager$b;
    :cond_5
    if-nez v9, :cond_6
    ...
    invoke-virtual {v0, v1, v8}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$b;
    ...
    check-cast v26, Landroid/support/v4/view/ViewPager$b;

    move-object/from16 v16, v26

    .line 1192
    .restart local v16    # "ii":Landroid/support/v4/view/ViewPager$b;
    :goto_3
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getClientWidth()I
    ...
    .line 1223
    :cond_7
    iget v14, v9, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    invoke-direct {v0, v9, v8, v1}, Landroid/support/v4/view/ViewPager;->calculatePageOffsets(Landroid/support/v4/view/ViewPager$b;ILandroid/support/v4/view/ViewPager$b;)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/support/v4/view/af;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/af;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    check-cast v19, Landroid/support/v4/view/ViewPager$c;

    .line 1276
    .local v19, "lp":Landroid/support/v4/view/ViewPager$c;
    move-object/from16 v0, v19

    iput v15, v0, Landroid/support/v4/view/ViewPager$c;->f:I
    ...
    iput v0, v1, Landroid/support/v4/view/ViewPager$c;->c:F
    ...
    iput v0, v1, Landroid/support/v4/view/ViewPager$c;->e:I
    ...
    .end local v15    # "i":I
    .end local v19    # "lp":Landroid/support/v4/view/ViewPager$c;
    .restart local v16    # "ii":Landroid/support/v4/view/ViewPager$b;
    :cond_b
    add-int/lit8 v8, v8, 0x1
    ...
    iget v0, v9, Landroid/support/v4/view/ViewPager$b;->d:F
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/ViewPager$b;->c:Z
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/support/v4/view/af;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$b;
    ...
    invoke-virtual {v0, v10}, Landroid/support/v4/view/ViewPager;->infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$b;
...
.method public setAdapter(Landroid/support/v4/view/af;)V
    ...
    invoke-virtual {v5, v9}, Landroid/support/v4/view/af;->setViewPagerObserver(Landroid/database/DataSetObserver;)V

    .line 508
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;

    invoke-virtual {v5, p0}, Landroid/support/v4/view/af;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v7, v2, Landroid/support/v4/view/ViewPager$b;->a:Ljava/lang/Object;

    invoke-virtual {v5, p0, v6, v7}, Landroid/support/v4/view/af;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v5, p0}, Landroid/support/v4/view/af;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    .end local v1    # "i":I
    :cond_1
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;

    .line 521
    .local v3, "oldAdapter":Landroid/support/v4/view/af;
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;
    ...
    .line 525
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/ViewPager$h;

    if-nez v5, :cond_2

    .line 526
    new-instance v5, Landroid/support/v4/view/ViewPager$h;

    invoke-direct {v5, p0}, Landroid/support/v4/view/ViewPager$h;-><init>(Landroid/support/v4/view/ViewPager;)V

    iput-object v5, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/ViewPager$h;

    .line 528
    :cond_2
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->mObserver:Landroid/support/v4/view/ViewPager$h;

    invoke-virtual {v5, v6}, Landroid/support/v4/view/af;->setViewPagerObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v5, v6, v7}, Landroid/support/v4/view/af;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    check-cast v5, Landroid/support/v4/view/ViewPager$e;

    invoke-interface {v5, p0, v3, p1}, Landroid/support/v4/view/ViewPager$e;->a(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/af;Landroid/support/v4/view/af;)V
...
.method setCurrentItemInternal(IZZI)V
    ...
    iput-boolean v0, v3, Landroid/support/v4/view/ViewPager$b;->c:Z
...
.method setInternalPageChangeListener(Landroid/support/v4/view/ViewPager$f;)Landroid/support/v4/view/ViewPager$f;
    ...
    .line 840
    .local v0, "oldListener":Landroid/support/v4/view/ViewPager$f;
...
.method public setPageTransformer(ZLandroid/support/v4/view/ViewPager$g;I)V
    ...
    :goto_0
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$g;
...
.method smoothScrollTo(III)V
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/af;

    move-object/from16 v0, p0

    iget v15, v0, Landroid/support/v4/view/ViewPager;->mCurItem:I

    invoke-virtual {v14, v15}, Landroid/support/v4/view/af;->getPageWidth(I)F
