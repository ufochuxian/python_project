...
.method static a([Landroid/support/v4/app/bq$a;Landroid/content/Intent;Landroid/os/Bundle;)V
    .locals 1
    .param p0, "remoteInputs"    # [Landroid/support/v4/app/bq$a;
    .param p1, "intent"    # Landroid/content/Intent;
    .param p2, "results"    # Landroid/os/Bundle;

    .prologue
    .line 65
    invoke-static {p0}, Landroid/support/v4/app/bp;->a([Landroid/support/v4/app/bq$a;)[Landroid/app/RemoteInput;
...
.method static a([Landroid/support/v4/app/bq$a;)[Landroid/app/RemoteInput;
    .locals 5
    .param p0, "srcArray"    # [Landroid/support/v4/app/bq$a;
    ...
    .line 49
    .local v2, "src":Landroid/support/v4/app/bq$a;
    new-instance v3, Landroid/app/RemoteInput$Builder;

    invoke-virtual {v2}, Landroid/support/v4/app/bq$a;->a()Ljava/lang/String;
    ...
    .line 50
    invoke-virtual {v2}, Landroid/support/v4/app/bq$a;->b()Ljava/lang/CharSequence;
    ...
    .line 51
    invoke-virtual {v2}, Landroid/support/v4/app/bq$a;->c()[Ljava/lang/CharSequence;
    ...
    .line 52
    invoke-virtual {v2}, Landroid/support/v4/app/bq$a;->d()Z
    ...
    .line 53
    invoke-virtual {v2}, Landroid/support/v4/app/bq$a;->e()Landroid/os/Bundle;
...
.method static a([Landroid/app/RemoteInput;Landroid/support/v4/app/bq$a$a;)[Landroid/support/v4/app/bq$a;
    .locals 9
    ...
    invoke-interface {p1, v0}, Landroid/support/v4/app/bq$a$a;->b(I)[Landroid/support/v4/app/bq$a;

    move-result-object v7

    .line 34
    .local v7, "result":[Landroid/support/v4/app/bq$a;
    const/4 v6, 0x0
