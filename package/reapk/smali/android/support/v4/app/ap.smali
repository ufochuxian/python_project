...
.method static synthetic a(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 34
    invoke-static {p0, p1}, Landroid/support/v4/app/ap;->b(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method public static a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    :cond_3
    new-instance v0, Landroid/support/v4/app/ap$3;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v4/app/ap$3;-><init>(ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public static a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    new-instance v0, Landroid/support/v4/app/ap$4;

    invoke-direct {v0, p1, p2}, Landroid/support/v4/app/ap$4;-><init>(Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method public static a(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    .local p1, "sharedElementsIn":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/View;>;"
    .local p2, "nameOverrides":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    new-instance v0, Landroid/support/v4/app/ap$7;

    invoke-direct {v0, p1, p2}, Landroid/support/v4/app/ap$7;-><init>(Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method public static a(Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    new-instance v1, Landroid/support/v4/app/ap$6;

    invoke-direct {v1, p1}, Landroid/support/v4/app/ap$6;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/app/ap;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 128
    new-instance v2, Landroid/support/v4/app/ap$1;

    invoke-direct {v2, v0}, Landroid/support/v4/app/ap$1;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    .line 74
    .local v3, "view":Landroid/view/View;
    invoke-static {v4, v3}, Landroid/support/v4/app/ap;->a(Ljava/util/List;Landroid/view/View;)V
    ...
    .line 78
    invoke-static {v2, p2}, Landroid/support/v4/app/ap;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    new-instance v0, Landroid/support/v4/app/ap$5;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/app/ap$5;-><init>(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/app/ap;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    :cond_2
    invoke-static {v6}, Landroid/support/v4/app/ap;->a(Landroid/transition/Transition;)Z
    ...
    invoke-static {v5}, Landroid/support/v4/app/ap;->a(Ljava/util/List;)Z
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 484
    invoke-static {v0, p1, p2}, Landroid/support/v4/app/ap;->b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/app/ap;->a(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method private static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v4}, Landroid/support/v4/app/ap;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    .line 98
    .local v0, "child":Landroid/view/View;
    invoke-static {p0, v0, v4}, Landroid/support/v4/app/ap;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    .line 397
    .local v0, "child":Landroid/view/View;
    invoke-static {p0, v0}, Landroid/support/v4/app/ap;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method private static a(Landroid/transition/Transition;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/app/ap;->a(Ljava/util/List;)Z
...
.method public static b(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    new-instance v1, Landroid/support/v4/app/ap$2;

    invoke-direct {v1, p1, p2}, Landroid/support/v4/app/ap$2;-><init>(Landroid/view/View;Ljava/util/ArrayList;)V
