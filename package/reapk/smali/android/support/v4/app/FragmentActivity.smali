...
.field final mFragments:Landroid/support/v4/app/ae;
...
.field mPendingFragmentActivityResults:Landroid/support/v4/k/p;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;
...
.method private allocateRequestIndex(Landroid/support/v4/app/Fragment;)I
    ...
    .line 970
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/k/p;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/k/p;->g(I)I
...
.method final dispatchFragmentsOnCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .prologue
    .line 378
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;
...
.method doReallyStop(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/ae;->c(Z)V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 697
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/ae;->a()Landroid/support/v4/app/ag;

    move-result-object v1

    invoke-virtual {v1, p1, p2, p3, p4}, Landroid/support/v4/app/ag;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getSupportLoaderManager()Landroid/support/v4/app/as;
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ae;->b()Landroid/support/v4/app/as;
...
.method public final getSupportMediaController()Landroid/support/v4/media/session/c;
    .locals 1
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .prologue
    .line 149
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;

    invoke-virtual {v3}, Landroid/support/v4/app/ae;->d()V
    ...
    .line 154
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/k/p;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/k/p;->c(I)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/ae;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 317
    iget-object v6, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;

    invoke-virtual {v6, v5}, Landroid/support/v4/app/ae;->a(Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v7, v2, Landroid/support/v4/app/FragmentActivity$b;->c:Landroid/support/v4/k/o;

    invoke-virtual {v6, v7}, Landroid/support/v4/app/ae;->a(Landroid/support/v4/k/o;)V
    ...
    iget-object v5, v2, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/support/v4/app/ai;

    :cond_1
    invoke-virtual {v6, v3, v5}, Landroid/support/v4/app/ae;->a(Landroid/os/Parcelable;Landroid/support/v4/app/ai;)V
    ...
    :cond_3
    iget-object v5, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/k/p;

    if-nez v5, :cond_4

    .line 349
    new-instance v5, Landroid/support/v4/k/p;

    invoke-direct {v5}, Landroid/support/v4/k/p;-><init>()V

    iput-object v5, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/k/p;
    ...
    .line 353
    :cond_4
    iget-object v5, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;

    invoke-virtual {v5}, Landroid/support/v4/app/ae;->h()V
    ...
    invoke-direct {v5, v6}, Landroid/support/v4/k/p;-><init>(I)V
    ...
    invoke-virtual {v5, v6, v7}, Landroid/support/v4/k/p;->b(ILjava/lang/Object;)V
...
.method protected onPostResume()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/ae;->r()Z
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/k/p;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/k/p;->c(I)V
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;

    invoke-virtual {v4}, Landroid/support/v4/app/ae;->g()Landroid/support/v4/app/ai;

    move-result-object v1

    .line 552
    .local v1, "fragments":Landroid/support/v4/app/ai;
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/ae;

    invoke-virtual {v4}, Landroid/support/v4/app/ae;->w()Landroid/support/v4/k/o;

    move-result-object v2

    .line 554
    .local v2, "loaders":Landroid/support/v4/k/o;, "Landroid/support/v4/k/o<Ljava/lang/String;Landroid/support/v4/app/as;>;"
    if-nez v1, :cond_1
    ...
    .line 560
    iput-object v1, v3, Landroid/support/v4/app/FragmentActivity$b;->b:Landroid/support/v4/app/ai;

    .line 561
    iput-object v2, v3, Landroid/support/v4/app/FragmentActivity$b;->c:Landroid/support/v4/k/o;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4}, Landroid/support/v4/app/ae;->e()Landroid/os/Parcelable;
    ...
    .line 575
    :cond_0
    iget-object v4, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/k/p;
...
.method requestPermissionsFromFragment(Landroid/support/v4/app/Fragment;[Ljava/lang/String;I)V
    ...
    invoke-static {p0, p2, v1}, Landroid/support/v4/app/d;->a(Landroid/app/Activity;[Ljava/lang/String;I)V
    :try_end_0
...
.method public setEnterSharedElementCallback(Landroid/support/v4/app/bx;)V
    ...
    .prologue
    .line 242
    invoke-static {p0, p1}, Landroid/support/v4/app/d;->a(Landroid/app/Activity;Landroid/support/v4/app/bx;)V
...
.method public setExitSharedElementCallback(Landroid/support/v4/app/bx;)V
    .locals 0
    .param p1, "listener"    # Landroid/support/v4/app/bx;

    .prologue
    .line 255
    invoke-static {p0, p1}, Landroid/support/v4/app/d;->b(Landroid/app/Activity;Landroid/support/v4/app/bx;)V

    .line 256
    return-void
.end method

.method public final setSupportMediaController(Landroid/support/v4/media/session/c;)V
    .locals 0
...
.method public startActivityFromFragment(Landroid/support/v4/app/Fragment;Landroid/content/Intent;ILandroid/os/Bundle;)V
    ...
    :try_start_0
    invoke-static {p0, p2, v1, p4}, Landroid/support/v4/app/d;->a(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
