...
.field private static final c:Landroid/support/v4/app/au$a;
...
.method static constructor <clinit>()V
    ...
    .line 138
    new-instance v1, Landroid/support/v4/app/au$c;

    invoke-direct {v1}, Landroid/support/v4/app/au$c;-><init>()V

    sput-object v1, Landroid/support/v4/app/au;->c:Landroid/support/v4/app/au$a;
    ...
    .line 140
    :cond_0
    new-instance v1, Landroid/support/v4/app/au$b;

    invoke-direct {v1}, Landroid/support/v4/app/au$b;-><init>()V
...
.method public static a(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    ...
    .prologue
    .line 256
    invoke-static {p0, p1}, Landroid/support/v4/app/au;->b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    invoke-static {p0, v3}, Landroid/support/v4/app/au;->b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    .line 264
    invoke-static {v3}, Landroid/support/v4/content/m;->a(Landroid/content/ComponentName;)Landroid/content/Intent;
...
.method public static a(Landroid/content/Context;Ljava/lang/Class;)Landroid/content/Intent;
    ...
    invoke-static {p0, v4}, Landroid/support/v4/app/au;->b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
...
.method public static a(Landroid/app/Activity;)V
    ...
    .line 185
    :cond_0
    invoke-static {p0, v0}, Landroid/support/v4/app/au;->b(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public static a(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    .prologue
    .line 159
    sget-object v0, Landroid/support/v4/app/au;->c:Landroid/support/v4/app/au$a;

    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/au$a;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public static b(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    invoke-interface {v0, p0}, Landroid/support/v4/app/au$a;->a(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public static b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    ...
    sget-object v3, Landroid/support/v4/app/au;->c:Landroid/support/v4/app/au$a;

    invoke-interface {v3, p0, v0}, Landroid/support/v4/app/au$a;->a(Landroid/content/Context;Landroid/content/pm/ActivityInfo;)Ljava/lang/String;
...
.method public static b(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v4/app/au$a;->b(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public static c(Landroid/app/Activity;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Landroid/support/v4/app/au;->b(Landroid/content/Context;Landroid/content/ComponentName;)Ljava/lang/String;
    :try_end_0
