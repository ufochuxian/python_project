...
.method private a(Ljava/lang/String;)Landroid/support/v4/app/FragmentTabHost$c;
    ...
    .line 366
    .local v2, "tab":Landroid/support/v4/app/FragmentTabHost$c;
    ...
    .line 370
    .end local v2    # "tab":Landroid/support/v4/app/FragmentTabHost$c;
    :goto_1
    return-object v2

    .line 364
    .restart local v2    # "tab":Landroid/support/v4/app/FragmentTabHost$c;
    :cond_0
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/an;)Landroid/support/v4/app/an;
    ...
    .line 335
    .local v0, "newTab":Landroid/support/v4/app/FragmentTabHost$c;
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/FragmentTabHost$c;
    ...
    .line 337
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ag;
    ...
    iget-object v1, v1, Landroid/support/v4/app/FragmentTabHost$c;->d:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/an;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/an;
    ...
    .line 347
    iget-object v1, v0, Landroid/support/v4/app/FragmentTabHost$c;->d:Landroid/support/v4/app/Fragment;
    ...
    iget-object v2, v0, Landroid/support/v4/app/FragmentTabHost$c;->b:Ljava/lang/Class;
    ...
    iget-object v3, v0, Landroid/support/v4/app/FragmentTabHost$c;->c:Landroid/os/Bundle;
    ...
    iput-object v1, v0, Landroid/support/v4/app/FragmentTabHost$c;->d:Landroid/support/v4/app/Fragment;

    .line 350
    iget v1, p0, Landroid/support/v4/app/FragmentTabHost;->e:I

    iget-object v2, v0, Landroid/support/v4/app/FragmentTabHost$c;->d:Landroid/support/v4/app/Fragment;

    iget-object v3, v0, Landroid/support/v4/app/FragmentTabHost$c;->a:Ljava/lang/String;

    invoke-virtual {p2, v1, v2, v3}, Landroid/support/v4/app/an;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/an;

    .line 356
    :cond_2
    :goto_0
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/FragmentTabHost$c;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/an;->e(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/an;
...
.method private a(Landroid/content/Context;)V
    ...
    .line 175
    iget-object v3, p0, Landroid/support/v4/app/FragmentTabHost;->b:Landroid/widget/FrameLayout;
...
.method public a(Landroid/content/Context;Landroid/support/v4/app/ag;)V
    ...
    .line 196
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ag;
...
.method public a(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    new-instance v3, Landroid/support/v4/app/FragmentTabHost$a;

    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/content/Context;

    invoke-direct {v3, v4}, Landroid/support/v4/app/FragmentTabHost$a;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, v2, p2, p3}, Landroid/support/v4/app/FragmentTabHost$c;-><init>(Ljava/lang/String;Ljava/lang/Class;Landroid/os/Bundle;)V

    .line 238
    .local v1, "info":Landroid/support/v4/app/FragmentTabHost$c;
    iget-boolean v3, p0, Landroid/support/v4/app/FragmentTabHost;->h:Z

    if-eqz v3, :cond_0

    .line 242
    iget-object v3, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ag;

    invoke-virtual {v3, v2}, Landroid/support/v4/app/ag;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v3

    iput-object v3, v1, Landroid/support/v4/app/FragmentTabHost$c;->d:Landroid/support/v4/app/Fragment;

    .line 243
    iget-object v3, v1, Landroid/support/v4/app/FragmentTabHost$c;->d:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/app/an;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/an;
...
.method protected onAttachedToWindow()V
    ...
    .line 265
    .local v4, "tab":Landroid/support/v4/app/FragmentTabHost$c;
    iget-object v5, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/ag;
    ...
    invoke-virtual {v2, v5}, Landroid/support/v4/app/an;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/an;

    goto :goto_1

    .line 285
    .end local v4    # "tab":Landroid/support/v4/app/FragmentTabHost$c;
    :cond_3
    const/4 v5, 0x1

    iput-boolean v5, p0, Landroid/support/v4/app/FragmentTabHost;->h:Z

    .line 286
    invoke-direct {p0, v1, v2}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/an;)Landroid/support/v4/app/an;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .prologue
    .line 309
    instance-of v1, p1, Landroid/support/v4/app/FragmentTabHost$b;
    ...
    .line 314
    .local v0, "ss":Landroid/support/v4/app/FragmentTabHost$b;
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentTabHost$b;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 315
    iget-object v1, v0, Landroid/support/v4/app/FragmentTabHost$b;->a:Ljava/lang/String;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/app/FragmentTabHost$b;-><init>(Landroid/os/Parcelable;)V
    ...
    iput-object v2, v0, Landroid/support/v4/app/FragmentTabHost$b;->a:Ljava/lang/String;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    .prologue
    .line 320
    iget-boolean v1, p0, Landroid/support/v4/app/FragmentTabHost;->h:Z
    ...
    invoke-direct {p0, p1, v1}, Landroid/support/v4/app/FragmentTabHost;->a(Ljava/lang/String;Landroid/support/v4/app/an;)Landroid/support/v4/app/an;
    ...
    .end local v0    # "ft":Landroid/support/v4/app/an;
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->f:Landroid/widget/TabHost$OnTabChangeListener;
