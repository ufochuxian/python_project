...
# instance fields
.field private final A:Landroid/support/v4/widget/ap;

.field private final B:Landroid/support/v4/widget/ap;

.field private final C:Landroid/support/v4/widget/DrawerLayout$j;

.field private final D:Landroid/support/v4/widget/DrawerLayout$j;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/support/v4/widget/DrawerLayout;->h:[I
    ...
    :goto_1
    sput-boolean v2, Landroid/support/v4/widget/DrawerLayout;->t:Z
    ...
    invoke-direct {v1}, Landroid/support/v4/widget/DrawerLayout$d;-><init>()V

    sput-object v1, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$c;
    ...
    invoke-direct {v1}, Landroid/support/v4/widget/DrawerLayout$e;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 185
    new-instance v2, Landroid/support/v4/widget/DrawerLayout$b;

    invoke-direct {v2, p0}, Landroid/support/v4/widget/DrawerLayout$b;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/support/v4/widget/DrawerLayout$b;

    .line 191
    const/high16 v2, -0x67000000

    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->x:I
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->z:Landroid/graphics/Paint;

    .line 201
    iput-boolean v5, p0, Landroid/support/v4/widget/DrawerLayout;->G:Z

    .line 203
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->H:I

    .line 204
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->I:I

    .line 205
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->J:I

    .line 206
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->K:I

    .line 228
    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->ab:Landroid/graphics/drawable/Drawable;

    .line 229
    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->ac:Landroid/graphics/drawable/Drawable;

    .line 230
    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->ad:Landroid/graphics/drawable/Drawable;

    .line 231
    iput-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->ae:Landroid/graphics/drawable/Drawable;
    ...
    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->w:I
    ...
    .line 380
    .local v1, "minVel":F
    new-instance v2, Landroid/support/v4/widget/DrawerLayout$j;

    invoke-direct {v2, p0, v4}, Landroid/support/v4/widget/DrawerLayout$j;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$j;
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v4/widget/DrawerLayout$j;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$j;

    .line 383
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$j;

    invoke-static {p0, v6, v2}, Landroid/support/v4/widget/ap;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ap$a;)Landroid/support/v4/widget/ap;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v2, v5}, Landroid/support/v4/widget/ap;->a(I)V

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/ap;->a(F)V

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$j;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/DrawerLayout$j;->a(Landroid/support/v4/widget/ap;)V

    .line 388
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$j;

    invoke-static {p0, v6, v2}, Landroid/support/v4/widget/ap;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ap$a;)Landroid/support/v4/widget/ap;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/ap;->a(I)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;
    ...
    .line 399
    new-instance v2, Landroid/support/v4/widget/DrawerLayout$a;

    invoke-direct {v2, p0}, Landroid/support/v4/widget/DrawerLayout$a;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v2}, Landroid/support/v4/view/ap;->a(Landroid/view/View;Landroid/support/v4/view/b;)V

    .line 400
    const/4 v2, 0x0

    invoke-static {p0, v2}, Landroid/support/v4/view/bd;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 402
    sget-object v2, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$c;

    invoke-interface {v2, p0}, Landroid/support/v4/widget/DrawerLayout$c;->a(Landroid/view/View;)V

    .line 403
    sget-object v2, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$c;

    invoke-interface {v2, p1}, Landroid/support/v4/widget/DrawerLayout$c;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->R:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->af:Ljava/util/ArrayList;
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v0, v3}, Landroid/support/v4/view/ap;->d(Landroid/view/View;I)V
...
.method private f()Landroid/graphics/drawable/Drawable;
    ...
    .line 1143
    :cond_1
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->ad:Landroid/graphics/drawable/Drawable;
...
.method private g()Landroid/graphics/drawable/Drawable;
    ...
    .line 1161
    :cond_1
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->ae:Landroid/graphics/drawable/Drawable;
...
.method private h()Z
    ...
    check-cast v2, Landroid/support/v4/widget/DrawerLayout$g;

    .line 1793
    .local v2, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    iget-boolean v3, v2, Landroid/support/v4/widget/DrawerLayout$g;->c:Z
    ...
    .line 1797
    .end local v2    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :goto_1
    return v3

    .line 1791
    .restart local v2    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_0
...
.method public a(I)I
    ...
    .line 698
    :sswitch_0
    iget v5, p0, Landroid/support/v4/widget/DrawerLayout;->H:I
    ...
    .line 708
    :sswitch_1
    iget v5, p0, Landroid/support/v4/widget/DrawerLayout;->I:I
    ...
    .line 718
    :sswitch_2
    iget v5, p0, Landroid/support/v4/widget/DrawerLayout;->J:I
    ...
    iget v4, p0, Landroid/support/v4/widget/DrawerLayout;->H:I
    ...
    :cond_6
    iget v4, p0, Landroid/support/v4/widget/DrawerLayout;->I:I

    goto :goto_3

    .line 728
    :sswitch_3
    iget v5, p0, Landroid/support/v4/widget/DrawerLayout;->K:I
...
.method public a(Landroid/view/View;)I
    ...
    check-cast v1, Landroid/support/v4/widget/DrawerLayout$g;

    iget v0, v1, Landroid/support/v4/widget/DrawerLayout$g;->a:I
...
.method a()Landroid/view/View;
    ...
    .line 949
    .local v2, "childLp":Landroid/support/v4/widget/DrawerLayout$g;
    iget v4, v2, Landroid/support/v4/widget/DrawerLayout$g;->d:I
    ...
    .line 953
    .end local v0    # "child":Landroid/view/View;
    .end local v2    # "childLp":Landroid/support/v4/widget/DrawerLayout$g;
    :goto_1
    return-object v0

    .line 946
    .restart local v0    # "child":Landroid/view/View;
    .restart local v2    # "childLp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_0
...
.method a(IILandroid/view/View;)V
    ...
    .line 803
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v6}, Landroid/support/v4/widget/ap;->b()I

    move-result v1

    .line 804
    .local v1, "leftState":I
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;
    ...
    check-cast v3, Landroid/support/v4/widget/DrawerLayout$g;

    .line 817
    .local v3, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    iget v6, v3, Landroid/support/v4/widget/DrawerLayout$g;->b:F
    ...
    .line 824
    .end local v3    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_1
    :goto_1
    iget v6, p0, Landroid/support/v4/widget/DrawerLayout;->E:I

    if-eq v5, v6, :cond_6

    .line 825
    iput v5, p0, Landroid/support/v4/widget/DrawerLayout;->E:I

    .line 827
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
    ...
    check-cast v6, Landroid/support/v4/widget/DrawerLayout$f;

    invoke-interface {v6, v5}, Landroid/support/v4/widget/DrawerLayout$f;->b(I)V
    ...
    .line 819
    .restart local v3    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_5
    iget v6, v3, Landroid/support/v4/widget/DrawerLayout$g;->b:F
...
.method public a(ILjava/lang/CharSequence;)V
    ...
    .line 769
    invoke-static {p1, v1}, Landroid/support/v4/view/h;->a(II)I
...
.method public a(Landroid/support/v4/widget/DrawerLayout$f;)V
    .locals 1
    .param p1, "listener"    # Landroid/support/v4/widget/DrawerLayout$f;
...
.method a(Landroid/view/View;F)V
    ...
    .prologue
    .line 906
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
    ...
    check-cast v2, Landroid/support/v4/widget/DrawerLayout$f;

    invoke-interface {v2, p1, p2}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/view/View;F)V
...
.method public a(Landroid/view/View;Z)V
    ...
    .line 1608
    .local v0, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    ...
    .line 1617
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v2

    invoke-virtual {v1, p1, v3, v2}, Landroid/support/v4/widget/ap;->a(Landroid/view/View;II)Z

    goto :goto_0

    .line 1619
    :cond_2
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;
    ...
    .line 1624
    iget v1, v0, Landroid/support/v4/widget/DrawerLayout$g;->a:I

    invoke-virtual {p0, v1, v3, p1}, Landroid/support/v4/widget/DrawerLayout;->a(IILandroid/view/View;)V
...
.method a(Z)V
    ...
    check-cast v4, Landroid/support/v4/widget/DrawerLayout$g;

    .line 1562
    .local v4, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
    ...
    iget-boolean v6, v4, Landroid/support/v4/widget/DrawerLayout$g;->c:Z
    ...
    .line 1569
    invoke-virtual {v6, v0, v7, v8}, Landroid/support/v4/widget/ap;->a(Landroid/view/View;II)Z
    ...
    iput-boolean v6, v4, Landroid/support/v4/widget/DrawerLayout$g;->c:Z
    ...
    .end local v4    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_3
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$j;

    invoke-virtual {v6}, Landroid/support/v4/widget/DrawerLayout$j;->a()V

    .line 1580
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$j;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/view/ap;->d(Landroid/view/View;I)V

    .line 1989
    :goto_0
    sget-boolean v1, Landroid/support/v4/widget/DrawerLayout;->i:Z

    if-nez v1, :cond_1

    .line 1990
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/support/v4/widget/DrawerLayout$b;

    invoke-static {p1, v1}, Landroid/support/v4/view/ap;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
...
.method public b(I)Ljava/lang/CharSequence;
    ...
    .line 791
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->U:Ljava/lang/CharSequence;
    ...
    .line 793
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->V:Ljava/lang/CharSequence;
...
.method public b(II)V
    ...
    .line 618
    invoke-static {p2, v4}, Landroid/support/v4/view/h;->a(II)I
    ...
    .line 639
    .local v1, "helper":Landroid/support/v4/widget/ap;
    :goto_1
    invoke-virtual {v1}, Landroid/support/v4/widget/ap;->g()V

    .line 641
    .end local v1    # "helper":Landroid/support/v4/widget/ap;
    :cond_0
    ...
    .line 645
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->h(Landroid/view/View;)V
    ...
    .line 651
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)V
...
.method b(Landroid/view/View;)V
    ...
    .line 841
    iput v6, v2, Landroid/support/v4/widget/DrawerLayout$g;->d:I

    .line 843
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
    ...
    check-cast v4, Landroid/support/v4/widget/DrawerLayout$f;

    invoke-interface {v4, p1}, Landroid/support/v4/widget/DrawerLayout$f;->b(Landroid/view/View;)V
    ...
    .end local v1    # "listenerCount":I
    :cond_0
    invoke-direct {p0, p1, v6}, Landroid/support/v4/widget/DrawerLayout;->c(Landroid/view/View;Z)V
...
.method c(I)Landroid/view/View;
    ...
    .line 975
    invoke-static {p1, v5}, Landroid/support/v4/view/h;->a(II)I
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/widget/DrawerLayout;->e(Landroid/view/View;)I
...
.method c(Landroid/view/View;)V
    ...
    .line 868
    .local v2, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    iget v3, v2, Landroid/support/v4/widget/DrawerLayout$g;->d:I
    ...
    .line 869
    iput v4, v2, Landroid/support/v4/widget/DrawerLayout$g;->d:I

    .line 870
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->O:Ljava/util/List;
    ...
    check-cast v3, Landroid/support/v4/widget/DrawerLayout$f;

    invoke-interface {v3, p1}, Landroid/support/v4/widget/DrawerLayout$f;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    iget v2, v4, Landroid/support/v4/widget/DrawerLayout$g;->b:F
    ...
    .line 1280
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v4, v6}, Landroid/support/v4/widget/ap;->a(Z)Z

    move-result v4

    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;

    invoke-virtual {v5, v6}, Landroid/support/v4/widget/ap;->a(Z)Z
...
.method d()V
    ...
    .line 1876
    iget-boolean v2, p0, Landroid/support/v4/widget/DrawerLayout;->M:Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/DrawerLayout;->f(Landroid/view/View;)Z
    ...
    .line 1364
    invoke-static/range {v25 .. v25}, Landroid/support/v4/widget/DrawerLayout;->m(Landroid/view/View;)Z
    ...
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout;->y:F
    ...
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout;->x:I
    ...
    iget v3, v0, Landroid/support/v4/widget/DrawerLayout;->y:F
    ...
    iget v3, v0, Landroid/support/v4/widget/DrawerLayout;->x:I
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->z:Landroid/graphics/Paint;
    ...
    iget-object v7, v0, Landroid/support/v4/widget/DrawerLayout;->z:Landroid/graphics/Paint;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->S:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v2}, Landroid/support/v4/widget/ap;->c()I
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->T:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;
...
.method e(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/h;->a(II)I
...
.method g(Landroid/view/View;)Z
    ...
    iget v1, v2, Landroid/support/v4/widget/DrawerLayout$g;->a:I
    ...
    .line 1422
    invoke-static {v1, v2}, Landroid/support/v4/view/h;->a(II)I
...
.method public j(Landroid/view/View;)Z
    ...
    .line 1738
    .local v0, "drawerLp":Landroid/support/v4/widget/DrawerLayout$g;
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$g;->d:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1343
    iget-boolean v1, p0, Landroid/support/v4/widget/DrawerLayout;->aa:Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->W:Ljava/lang/Object;

    invoke-interface {v1, v2}, Landroid/support/v4/widget/DrawerLayout$c;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1440
    .local v0, "action":I
    iget-object v8, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v8, p1}, Landroid/support/v4/widget/ap;->a(Landroid/view/MotionEvent;)Z

    move-result v8

    iget-object v9, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;

    .line 1441
    invoke-virtual {v9, p1}, Landroid/support/v4/widget/ap;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v8, p0, Landroid/support/v4/widget/DrawerLayout;->M:Z
    ...
    .line 1449
    .local v5, "y":F
    iput v4, p0, Landroid/support/v4/widget/DrawerLayout;->P:F

    .line 1450
    iput v5, p0, Landroid/support/v4/widget/DrawerLayout;->Q:F

    .line 1451
    iget v8, p0, Landroid/support/v4/widget/DrawerLayout;->y:F
    ...
    invoke-virtual {v8, v9, v10}, Landroid/support/v4/widget/ap;->e(II)Landroid/view/View;
    ...
    .end local v1    # "child":Landroid/view/View;
    :cond_3
    iput-boolean v6, p0, Landroid/support/v4/widget/DrawerLayout;->L:Z

    .line 1458
    iput-boolean v6, p0, Landroid/support/v4/widget/DrawerLayout;->M:Z
    ...
    invoke-virtual {v8, v9}, Landroid/support/v4/widget/ap;->d(I)Z
    ...
    .line 1465
    iget-object v8, p0, Landroid/support/v4/widget/DrawerLayout;->C:Landroid/support/v4/widget/DrawerLayout$j;

    invoke-virtual {v8}, Landroid/support/v4/widget/DrawerLayout$j;->a()V

    .line 1466
    iget-object v8, p0, Landroid/support/v4/widget/DrawerLayout;->D:Landroid/support/v4/widget/DrawerLayout$j;
    ...
    .line 1473
    :pswitch_2
    invoke-virtual {p0, v7}, Landroid/support/v4/widget/DrawerLayout;->a(Z)V
...
.method protected onLayout(ZIIII)V
    ...
    iput-boolean v0, v1, Landroid/support/v4/widget/DrawerLayout;->F:Z
    ...
    check-cast v13, Landroid/support/v4/widget/DrawerLayout$g;

    .line 1192
    .local v13, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    move-object/from16 v0, p0

    invoke-virtual {v0, v5}, Landroid/support/v4/widget/DrawerLayout;->f(Landroid/view/View;)Z
    ...
    .line 1193
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$g;->leftMargin:I

    move/from16 v18, v0

    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$g;->topMargin:I
    ...
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$g;->b:F
    ...
    :goto_3
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$g;->a:I
    ...
    invoke-virtual {v0, v5, v14}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/view/View;F)V
    ...
    .line 1224
    .local v11, "height":I
    iget v0, v13, Landroid/support/v4/widget/DrawerLayout$g;->bottomMargin:I
    ...
    .line 1238
    iget v9, v13, Landroid/support/v4/widget/DrawerLayout$g;->topMargin:I
    ...
    .end local v13    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    .end local v14    # "newOffset":F
    .end local v16    # "vgrav":I
    :cond_9
    const/16 v18, 0x0
    ...
    iput-boolean v0, v1, Landroid/support/v4/widget/DrawerLayout;->G:Z
...
.method protected onMeasure(II)V
    ...
    iget-object v0, v0, Landroid/support/v4/widget/DrawerLayout;->W:Ljava/lang/Object;
    ...
    check-cast v19, Landroid/support/v4/widget/DrawerLayout$g;

    .line 1066
    .local v19, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    if-eqz v3, :cond_8
    ...
    .line 1069
    sget-object v22, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/DrawerLayout$c;
    ...
    invoke-interface {v0, v5, v1, v4}, Landroid/support/v4/widget/DrawerLayout$c;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$g;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$g;->rightMargin:I
    ...
    invoke-interface {v0, v1, v2, v4}, Landroid/support/v4/widget/DrawerLayout$c;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/widget/DrawerLayout;->g(Landroid/view/View;)Z
    ...
    .line 1083
    sget-boolean v22, Landroid/support/v4/widget/DrawerLayout;->t:Z

    if-eqz v22, :cond_b

    .line 1084
    invoke-static {v5}, Landroid/support/v4/view/ap;->K(Landroid/view/View;)F

    move-result v22

    move-object/from16 v0, p0

    iget v0, v0, Landroid/support/v4/widget/DrawerLayout;->v:F
    ...
    invoke-static {v5, v0}, Landroid/support/v4/view/ap;->m(Landroid/view/View;F)V

    .line 1089
    :cond_b
    move-object/from16 v0, p0

    invoke-virtual {v0, v5}, Landroid/support/v4/widget/DrawerLayout;->e(Landroid/view/View;)I
    ...
    .line 1096
    invoke-static {v7}, Landroid/support/v4/widget/DrawerLayout;->d(I)Ljava/lang/String;
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout;->w:I
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$g;->width:I
    ...
    .line 1117
    .end local v5    # "child":Landroid/view/View;
    .end local v19    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_12
    return-void
.end method
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1912
    instance-of v2, p1, Landroid/support/v4/widget/DrawerLayout$h;
    ...
    .line 1917
    check-cast v0, Landroid/support/v4/widget/DrawerLayout$h;

    .line 1918
    .local v0, "ss":Landroid/support/v4/widget/DrawerLayout$h;
    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout$h;->a()Landroid/os/Parcelable;
    ...
    .line 1920
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$h;->b:I
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/DrawerLayout;->c(I)Landroid/view/View;
    ...
    :cond_2
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$h;->c:I
    ...
    invoke-virtual {p0, v2, v4}, Landroid/support/v4/widget/DrawerLayout;->b(II)V

    .line 1930
    :cond_3
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$h;->d:I
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/widget/DrawerLayout;->b(II)V

    .line 1933
    :cond_4
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$h;->e:I
    ...
    .line 1936
    :cond_5
    iget v2, v0, Landroid/support/v4/widget/DrawerLayout$h;->f:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v6, v7}, Landroid/support/v4/widget/DrawerLayout$h;-><init>(Landroid/os/Parcelable;)V

    .line 1946
    .local v6, "ss":Landroid/support/v4/widget/DrawerLayout$h;
    invoke-virtual {p0}, Landroid/support/v4/widget/DrawerLayout;->getChildCount()I
    ...
    check-cast v5, Landroid/support/v4/widget/DrawerLayout$g;

    .line 1951
    .local v5, "lp":Landroid/support/v4/widget/DrawerLayout$g;
    iget v10, v5, Landroid/support/v4/widget/DrawerLayout$g;->d:I
    ...
    .line 1957
    :cond_0
    iget v8, v5, Landroid/support/v4/widget/DrawerLayout$g;->a:I

    iput v8, v6, Landroid/support/v4/widget/DrawerLayout$h;->b:I

    .line 1962
    .end local v0    # "child":Landroid/view/View;
    .end local v3    # "isClosedAndOpening":Z
    .end local v4    # "isOpenedAndNotClosing":Z
    .end local v5    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_1
    iget v8, p0, Landroid/support/v4/widget/DrawerLayout;->H:I

    iput v8, v6, Landroid/support/v4/widget/DrawerLayout$h;->c:I

    .line 1963
    iget v8, p0, Landroid/support/v4/widget/DrawerLayout;->I:I

    iput v8, v6, Landroid/support/v4/widget/DrawerLayout$h;->d:I

    .line 1964
    iget v8, p0, Landroid/support/v4/widget/DrawerLayout;->J:I

    iput v8, v6, Landroid/support/v4/widget/DrawerLayout$h;->e:I

    .line 1965
    iget v8, p0, Landroid/support/v4/widget/DrawerLayout;->K:I

    iput v8, v6, Landroid/support/v4/widget/DrawerLayout$h;->f:I

    .line 1967
    return-object v6

    .restart local v0    # "child":Landroid/view/View;
    .restart local v5    # "lp":Landroid/support/v4/widget/DrawerLayout$g;
    :cond_2
    move v4, v9
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 1484
    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->A:Landroid/support/v4/widget/ap;

    invoke-virtual {v10, p1}, Landroid/support/v4/widget/ap;->b(Landroid/view/MotionEvent;)V

    .line 1485
    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->B:Landroid/support/v4/widget/ap;
    ...
    .line 1494
    .local v9, "y":F
    iput v8, p0, Landroid/support/v4/widget/DrawerLayout;->P:F

    .line 1495
    iput v9, p0, Landroid/support/v4/widget/DrawerLayout;->Q:F

    .line 1496
    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/support/v4/widget/DrawerLayout;->L:Z

    .line 1497
    const/4 v10, 0x0

    iput-boolean v10, p0, Landroid/support/v4/widget/DrawerLayout;->M:Z
    ...
    invoke-virtual {v10, v11, v12}, Landroid/support/v4/widget/ap;->e(II)Landroid/view/View;
    ...
    .line 1507
    iget v10, p0, Landroid/support/v4/widget/DrawerLayout;->P:F

    sub-float v1, v8, v10

    .line 1508
    .local v1, "dx":F
    iget v10, p0, Landroid/support/v4/widget/DrawerLayout;->Q:F
    ...
    invoke-virtual {v10}, Landroid/support/v4/widget/ap;->f()I
    ...
    :cond_0
    :goto_1
    invoke-virtual {p0, v4}, Landroid/support/v4/widget/DrawerLayout;->a(Z)V
    ...
    invoke-virtual {p0, v10}, Landroid/support/v4/widget/DrawerLayout;->a(Z)V
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/ap;->m(Landroid/view/View;F)V
