...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 137
    new-instance v3, Landroid/support/v4/widget/a$a;

    invoke-direct {v3}, Landroid/support/v4/widget/a$a;-><init>()V

    iput-object v3, p0, Landroid/support/v4/widget/a;->g:Landroid/support/v4/widget/a$a;
    ...
    iput-object v3, p0, Landroid/support/v4/widget/a;->n:Landroid/view/animation/Interpolator;
    ...
    iput-object v3, p0, Landroid/support/v4/widget/a;->p:[F
    ...
    iput-object v3, p0, Landroid/support/v4/widget/a;->q:[F
    ...
    iput-object v3, p0, Landroid/support/v4/widget/a;->t:[F
    ...
    iput-object v3, p0, Landroid/support/v4/widget/a;->u:[F
    ...
    iput-object v3, p0, Landroid/support/v4/widget/a;->v:[F
    ...
    invoke-virtual {p0, v3, v4}, Landroid/support/v4/widget/a;->a(FF)Landroid/support/v4/widget/a;
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/a;->a(I)Landroid/support/v4/widget/a;

    .line 219
    invoke-virtual {p0, v8, v8}, Landroid/support/v4/widget/a;->e(FF)Landroid/support/v4/widget/a;

    .line 220
    invoke-virtual {p0, v5, v5}, Landroid/support/v4/widget/a;->d(FF)Landroid/support/v4/widget/a;

    .line 221
    invoke-virtual {p0, v7, v7}, Landroid/support/v4/widget/a;->c(FF)Landroid/support/v4/widget/a;

    .line 222
    sget v3, Landroid/support/v4/widget/a;->F:I

    invoke-virtual {p0, v3}, Landroid/support/v4/widget/a;->b(I)Landroid/support/v4/widget/a;
...
.method private a(FFFF)F
    ...
    invoke-static {v6, v5, p3}, Landroid/support/v4/widget/a;->a(FFF)F
    ...
    invoke-direct {p0, v6, v0}, Landroid/support/v4/widget/a;->f(FF)F
    ...
    .line 613
    iget-object v5, p0, Landroid/support/v4/widget/a;->n:Landroid/view/animation/Interpolator;
...
.method private a(IFFF)F
    ...
    .line 539
    iget-object v8, p0, Landroid/support/v4/widget/a;->p:[F

    aget v3, v8, p1

    .line 540
    .local v3, "relativeEdge":F
    iget-object v8, p0, Landroid/support/v4/widget/a;->q:[F

    aget v0, v8, p1

    .line 541
    .local v0, "maximumEdge":F
    invoke-direct {p0, v3, p3, v0, p2}, Landroid/support/v4/widget/a;->a(FFFF)F
    ...
    .line 547
    :cond_0
    iget-object v8, p0, Landroid/support/v4/widget/a;->t:[F

    aget v4, v8, p1

    .line 548
    .local v4, "relativeVelocity":F
    iget-object v8, p0, Landroid/support/v4/widget/a;->u:[F

    aget v2, v8, p1

    .line 549
    .local v2, "minimumVelocity":F
    iget-object v8, p0, Landroid/support/v4/widget/a;->v:[F
    ...
    invoke-static {v7, v2, v1}, Landroid/support/v4/widget/a;->a(FFF)F
...
.method c()Z
    ...
    .prologue
    .line 492
    iget-object v1, p0, Landroid/support/v4/widget/a;->g:Landroid/support/v4/widget/a$a;

    .line 493
    .local v1, "scroller":Landroid/support/v4/widget/a$a;
    invoke-virtual {v1}, Landroid/support/v4/widget/a$a;->f()I

    move-result v2

    .line 494
    .local v2, "verticalDirection":I
    invoke-virtual {v1}, Landroid/support/v4/widget/a$a;->e()I
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/a;->f(I)Z
...
.method d()V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/a;->h:Landroid/view/View;
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 456
    iget-boolean v5, p0, Landroid/support/v4/widget/a;->x:Z
    ...
    :cond_1
    :goto_1
    iget-boolean v5, p0, Landroid/support/v4/widget/a;->y:Z

    if-eqz v5, :cond_2

    iget-boolean v5, p0, Landroid/support/v4/widget/a;->k:Z
    ...
    .line 463
    :pswitch_0
    iput-boolean v3, p0, Landroid/support/v4/widget/a;->j:Z
    ...
    iget-object v7, p0, Landroid/support/v4/widget/a;->h:Landroid/view/View;
    ...
    .line 467
    invoke-direct {p0, v4, v5, v6, v7}, Landroid/support/v4/widget/a;->a(IFFF)F
    ...
    .line 469
    invoke-direct {p0, v3, v5, v6, v7}, Landroid/support/v4/widget/a;->a(IFFF)F

    move-result v2

    .line 471
    .local v2, "yTargetVelocity":F
    iget-object v5, p0, Landroid/support/v4/widget/a;->g:Landroid/support/v4/widget/a$a;

    invoke-virtual {v5, v1, v2}, Landroid/support/v4/widget/a$a;->a(FF)V
