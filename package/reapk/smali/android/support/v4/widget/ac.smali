...
.method constructor <init>(ZLandroid/content/Context;Landroid/view/animation/Interpolator;)V
    ...
    .line 50
    iput-boolean p1, p0, Landroid/support/v4/widget/ac;->b:Z
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v4/widget/ac;->a:Landroid/widget/OverScroller;
...
.method public static a(Landroid/content/Context;)Landroid/support/v4/widget/ac;
    .locals 1
    ...
    invoke-static {p0, v0}, Landroid/support/v4/widget/ac;->a(Landroid/content/Context;Landroid/view/animation/Interpolator;)Landroid/support/v4/widget/ac;
...
.method public static a(Landroid/content/Context;Landroid/view/animation/Interpolator;)Landroid/support/v4/widget/ac;
    ...
    :goto_0
    invoke-direct {v1, v0, p0, p1}, Landroid/support/v4/widget/ac;-><init>(ZLandroid/content/Context;Landroid/view/animation/Interpolator;)V
...
.method public a(III)V
    ...
    .prologue
    .line 246
    iget-object v0, p0, Landroid/support/v4/widget/ac;->a:Landroid/widget/OverScroller;
...
.method public f()F
    ...
    .prologue
    .line 107
    iget-boolean v0, p0, Landroid/support/v4/widget/ac;->b:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/widget/ac;->a:Landroid/widget/OverScroller;

    invoke-static {v0}, Landroid/support/v4/widget/ad;->a(Ljava/lang/Object;)F
