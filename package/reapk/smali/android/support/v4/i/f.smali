...
.method public a(Ljava/lang/String;)Landroid/support/v4/i/a;
    ...
    .prologue
    .line 40
    iget-object v1, p0, Landroid/support/v4/i/f;->b:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v4/i/f;->c:Landroid/net/Uri;

    invoke-static {v1, v2, p1}, Landroid/support/v4/i/c;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {v1, p0, v2, v0}, Landroid/support/v4/i/f;-><init>(Landroid/support/v4/i/a;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public a(Ljava/lang/String;Ljava/lang/String;)Landroid/support/v4/i/a;
    ...
    invoke-static {v1, v2, p1, p2}, Landroid/support/v4/i/c;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public c(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v2, p1}, Landroid/support/v4/i/c;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
...
.method public n()[Landroid/support/v4/i/a;
    ...
    .prologue
    .line 106
    iget-object v3, p0, Landroid/support/v4/i/f;->b:Landroid/content/Context;

    iget-object v4, p0, Landroid/support/v4/i/f;->c:Landroid/net/Uri;

    invoke-static {v3, v4}, Landroid/support/v4/i/c;->a(Landroid/content/Context;Landroid/net/Uri;)[Landroid/net/Uri;
    ...
    new-array v2, v3, [Landroid/support/v4/i/a;

    .line 108
    .local v2, "resultFiles":[Landroid/support/v4/i/a;
    const/4 v0, 0x0
