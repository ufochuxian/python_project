...
.method public a(Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
    .locals 2
    .param p1, "callbacks"    # Landroid/support/v4/media/MediaBrowserServiceCompat$j;
...
.method public a(Ljava/lang/String;ILandroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
    ...
    .param p4, "callbacks"    # Landroid/support/v4/media/MediaBrowserServiceCompat$j;
...
.method public a(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/m;Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v4/media/MediaBrowserServiceCompat$i$8;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$i;Landroid/support/v4/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/m;)V
...
.method public a(Ljava/lang/String;Landroid/os/IBinder;Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
    ...
    .param p1, "id"    # Ljava/lang/String;
    .param p2, "token"    # Landroid/os/IBinder;
    .param p3, "callbacks"    # Landroid/support/v4/media/MediaBrowserServiceCompat$j;
...
.method public a(Ljava/lang/String;Landroid/support/v4/os/m;Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserServiceCompat$i$5;-><init>(Landroid/support/v4/media/MediaBrowserServiceCompat$i;Landroid/support/v4/media/MediaBrowserServiceCompat$j;Ljava/lang/String;Landroid/support/v4/os/m;)V
