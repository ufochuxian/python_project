...
.method public a(Ljava/lang/String;Landroid/support/v4/media/session/g$i;Landroid/os/Bundle;)V
    .locals 3
    .param p1, "root"    # Ljava/lang/String;
    .param p2, "session"    # Landroid/support/v4/media/session/g$i;
...
.method public a(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 810
    .local p2, "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/a$k;>;"
    new-instance v0, Landroid/os/Bundle;
    ...
    .end local p2    # "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/a$k;>;"
    :goto_0
    ...
    invoke-direct {p0, v1, v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$k;->a(ILandroid/os/Bundle;)V

    .line 818
    return-void

    .line 814
    .restart local p2    # "list":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/a$k;>;"
    :cond_1
