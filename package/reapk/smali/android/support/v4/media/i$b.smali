...
.method constructor <init>(Landroid/service/media/MediaBrowserService$Result;)V
    ...
    .line 67
    iput-object p1, p0, Landroid/support/v4/media/i$b;->a:Landroid/service/media/MediaBrowserService$Result;
...
.method public a()V
    ...
    .prologue
    .line 80
    iget-object v0, p0, Landroid/support/v4/media/i$b;->a:Landroid/service/media/MediaBrowserService$Result;
...
.method public a(Ljava/util/List;I)V
    ...
    :try_start_0
    invoke-static {}, Landroid/support/v4/media/i;->a()Ljava/lang/reflect/Field;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v4/media/i$b;->a:Landroid/service/media/MediaBrowserService$Result;
    ...
    .line 76
    :goto_0
    iget-object v1, p0, Landroid/support/v4/media/i$b;->a:Landroid/service/media/MediaBrowserService$Result;

    invoke-virtual {p0, p1}, Landroid/support/v4/media/i$b;->a(Ljava/util/List;)Ljava/util/List;
