...
.method private createMediaCrypto()Z
    ...
    .line 272
    .end local v0    # "e":Landroid/media/MediaCryptoException;
    :catch_2
    move-exception v0
    ...
    const-string v5, "closeSession failed: "
...
.method private createSession([BLjava/lang/String;Ljava/util/HashMap;J)V
    ...
    const-string v6, "createSession() called when MediaDrm is null."
    ...
    .line 630
    const-string v5, "MediaDrm released previously."

    invoke-direct {p0, p4, p5, v5}, Lorg/chromium/media/MediaDrmBridge;->onPromiseRejected(JLjava/lang/String;)V
    ...
    .line 646
    const-string v5, "Open session failed."
    ...
    invoke-virtual {v5, v4}, Landroid/media/MediaDrm;->closeSession([B)V
    :try_end_1
    ...
    invoke-direct {p0, v4}, Lorg/chromium/media/MediaDrmBridge;->sessionExists([B)Z
    ...
    invoke-direct {p0, v4, p1, p2, p3}, Lorg/chromium/media/MediaDrmBridge;->getKeyRequest([B[BLjava/lang/String;Ljava/util/HashMap;)Landroid/media/MediaDrm$KeyRequest;
    :try_end_2
    ...
    :goto_2
    :try_start_4
    const-string v5, "Generate request failed."
    ...
    const-string v6, "closeSession failed"
    ...
    const-string v6, "createSession(): Session (%s) created."

    invoke-static {v4}, Lorg/chromium/media/MediaDrmBridge;->bytesToHexString([B)Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v6, v7}, Lorg/chromium/base/Log;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    .line 667
    invoke-direct {p0, p4, p5, v4}, Lorg/chromium/media/MediaDrmBridge;->onPromiseResolvedWithSession(J[B)V

    .line 668
    invoke-direct {p0, v4, v3}, Lorg/chromium/media/MediaDrmBridge;->onSessionMessage([BLandroid/media/MediaDrm$KeyRequest;)V

    .line 669
    iget-object v5, p0, Lorg/chromium/media/MediaDrmBridge;->mSessionIds:Ljava/util/HashMap;
    ...
    .line 676
    .end local v3    # "request":Landroid/media/MediaDrm$KeyRequest;
    .local v0, "e":Landroid/media/NotProvisionedException;
    :catch_2
    move-exception v1
...
.method private release()V
    ...
    .line 495
    invoke-direct {p0, v8}, Lorg/chromium/media/MediaDrmBridge;->onMediaCryptoReady(Landroid/media/MediaCrypto;)V
