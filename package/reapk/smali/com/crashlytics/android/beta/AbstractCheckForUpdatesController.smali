...
.field private betaSettings:Lio/fabric/sdk/android/services/settings/g;

.field private buildProps:Lcom/crashlytics/android/beta/BuildProperties;

.field private context:Landroid/content/Context;

.field private currentTimeProvider:Lio/fabric/sdk/android/services/common/k;
...
.field private preferenceStore:Lio/fabric/sdk/android/services/c/d;
...
.method private performUpdateCheck()V
    ...
    invoke-virtual {v1, v2}, Lio/fabric/sdk/android/services/common/g;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lio/fabric/sdk/android/services/common/IdManager;->i()Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->betaSettings:Lio/fabric/sdk/android/services/settings/g;

    iget-object v3, v3, Lio/fabric/sdk/android/services/settings/g;->a:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/crashlytics/android/beta/CheckForUpdatesRequest;-><init>(Lio/fabric/sdk/android/i;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;Lcom/crashlytics/android/beta/CheckForUpdatesResponseTransform;)V
...
.method protected checkForUpdates()V
    ...
    .prologue
    .line 118
    iget-object v7, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Lio/fabric/sdk/android/services/c/d;

    monitor-enter v7

    .line 119
    :try_start_0
    iget-object v6, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Lio/fabric/sdk/android/services/c/d;

    invoke-interface {v6}, Lio/fabric/sdk/android/services/c/d;->a()Landroid/content/SharedPreferences;
    ...
    iget-object v8, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Lio/fabric/sdk/android/services/c/d;

    invoke-interface {v8}, Lio/fabric/sdk/android/services/c/d;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v6, v8}, Lio/fabric/sdk/android/services/c/d;->a(Landroid/content/SharedPreferences$Editor;)Z
    ...
    .line 124
    iget-object v6, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->currentTimeProvider:Lio/fabric/sdk/android/services/common/k;
    ...
    iget-object v6, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->betaSettings:Lio/fabric/sdk/android/services/settings/g;

    iget v6, v6, Lio/fabric/sdk/android/services/settings/g;->b:I
...
.method public initialize(Landroid/content/Context;Lcom/crashlytics/android/beta/Beta;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/settings/g;Lcom/crashlytics/android/beta/BuildProperties;Lio/fabric/sdk/android/services/c/d;Lio/fabric/sdk/android/services/common/k;Lio/fabric/sdk/android/services/network/c;)V
    .locals 1
    ...
    .param p4, "betaSettings"    # Lio/fabric/sdk/android/services/settings/g;
    .param p5, "buildProps"    # Lcom/crashlytics/android/beta/BuildProperties;
    .param p6, "preferenceStore"    # Lio/fabric/sdk/android/services/c/d;
    .param p7, "currentTimeProvider"    # Lio/fabric/sdk/android/services/common/k;
    .param p8, "httpRequestFactory"    # Lio/fabric/sdk/android/services/network/c;
    ...
    .line 84
    iput-object p4, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->betaSettings:Lio/fabric/sdk/android/services/settings/g;
    ...
    .line 86
    iput-object p6, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->preferenceStore:Lio/fabric/sdk/android/services/c/d;

    .line 87
    iput-object p7, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->currentTimeProvider:Lio/fabric/sdk/android/services/common/k;
