...
.method private getBetaDeviceToken(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v3, p0, Lcom/crashlytics/android/beta/Beta;->deviceTokenCache:Lio/fabric/sdk/android/services/a/b;
    ...
    invoke-interface {v4, v5, v3}, Lio/fabric/sdk/android/l;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private getBetaSettingsData()Lio/fabric/sdk/android/services/settings/g;
    ...
    .line 161
    iget-object v1, v0, Lio/fabric/sdk/android/services/settings/t;->f:Lio/fabric/sdk/android/services/settings/g;
...
.method canCheckForUpdates(Lio/fabric/sdk/android/services/settings/g;Lcom/crashlytics/android/beta/BuildProperties;)Z
    .locals 1
    .param p1, "betaSettings"    # Lio/fabric/sdk/android/services/settings/g;
    ...
    iget-object v0, p1, Lio/fabric/sdk/android/services/settings/g;->a:Ljava/lang/String;
...
.method createUpdatesController(ILandroid/app/Application;)Lcom/crashlytics/android/beta/UpdatesController;
    ...
    invoke-virtual {v2}, Lio/fabric/sdk/android/d;->e()Lio/fabric/sdk/android/a;

    move-result-object v1

    .line 103
    .local v1, "lifecycleManager":Lio/fabric/sdk/android/a;
    invoke-virtual {p0}, Lcom/crashlytics/android/beta/Beta;->getFabric()Lio/fabric/sdk/android/d;

    move-result-object v2

    invoke-virtual {v2}, Lio/fabric/sdk/android/d;->f()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v2, v1, v0}, Lcom/crashlytics/android/beta/ActivityLifecycleCheckForUpdatesController;-><init>(Lio/fabric/sdk/android/a;Ljava/util/concurrent/ExecutorService;)V

    .line 107
    .end local v0    # "executorService":Ljava/util/concurrent/ExecutorService;
    .end local v1    # "lifecycleManager":Lio/fabric/sdk/android/a;
    :goto_0
    return-object v2
...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    invoke-interface {v0, v2, v6}, Lio/fabric/sdk/android/l;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 75
    .local v4, "betaSettings":Lio/fabric/sdk/android/services/settings/g;
    ...
    invoke-virtual {p0, v4, v5}, Lcom/crashlytics/android/beta/Beta;->canCheckForUpdates(Lio/fabric/sdk/android/services/settings/g;Lcom/crashlytics/android/beta/BuildProperties;)Z
    ...
    new-instance v6, Lio/fabric/sdk/android/services/c/e;

    invoke-direct {v6, p0}, Lio/fabric/sdk/android/services/c/e;-><init>(Lio/fabric/sdk/android/i;)V

    new-instance v7, Lio/fabric/sdk/android/services/common/r;

    invoke-direct {v7}, Lio/fabric/sdk/android/services/common/r;-><init>()V
    ...
    .line 78
    invoke-interface/range {v0 .. v8}, Lcom/crashlytics/android/beta/UpdatesController;->initialize(Landroid/content/Context;Lcom/crashlytics/android/beta/Beta;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/settings/g;Lcom/crashlytics/android/beta/BuildProperties;Lio/fabric/sdk/android/services/c/d;Lio/fabric/sdk/android/services/common/k;Lio/fabric/sdk/android/services/network/c;)V
