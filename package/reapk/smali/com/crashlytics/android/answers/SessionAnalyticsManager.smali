...
.method constructor <init>(Lcom/crashlytics/android/answers/AnswersEventsHandler;Lio/fabric/sdk/android/a;Lcom/crashlytics/android/answers/BackgroundManager;Lcom/crashlytics/android/answers/AnswersPreferenceManager;J)V
    ...
    .param p2, "lifecycleManager"    # Lio/fabric/sdk/android/a;
...
.method public static build(Lio/fabric/sdk/android/i;Landroid/content/Context;Lio/fabric/sdk/android/services/common/IdManager;Ljava/lang/String;Ljava/lang/String;J)Lcom/crashlytics/android/answers/SessionAnalyticsManager;
    .locals 19
    .param p0, "kit"    # Lio/fabric/sdk/android/i;
    ...
    new-instance v5, Lio/fabric/sdk/android/services/c/b;

    move-object/from16 v0, p0

    invoke-direct {v5, v0}, Lio/fabric/sdk/android/services/c/b;-><init>(Lio/fabric/sdk/android/i;)V

    move-object/from16 v0, p1

    invoke-direct {v7, v0, v5}, Lcom/crashlytics/android/answers/AnswersFilesManagerProvider;-><init>(Landroid/content/Context;Lio/fabric/sdk/android/services/c/a;)V

    .line 41
    .local v7, "filesManagerProvider":Lcom/crashlytics/android/answers/AnswersFilesManagerProvider;
    new-instance v9, Lio/fabric/sdk/android/services/network/b;
    ...
    invoke-direct {v9, v5}, Lio/fabric/sdk/android/services/network/b;-><init>(Lio/fabric/sdk/android/l;)V

    .line 43
    .local v9, "httpRequestFactory":Lio/fabric/sdk/android/services/network/b;
    ...
    .line 44
    .local v13, "lifecycleManager":Lio/fabric/sdk/android/a;
    const-string v5, "Answers Events Handler"

    .line 45
    invoke-static {v5}, Lio/fabric/sdk/android/services/common/m;->b(Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct/range {v11 .. v17}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;-><init>(Lcom/crashlytics/android/answers/AnswersEventsHandler;Lio/fabric/sdk/android/a;Lcom/crashlytics/android/answers/BackgroundManager;Lcom/crashlytics/android/answers/AnswersPreferenceManager;J)V
