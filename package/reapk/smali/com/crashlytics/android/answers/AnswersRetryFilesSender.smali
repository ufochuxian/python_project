...
.method public static build(Lcom/crashlytics/android/answers/SessionAnalyticsFilesSender;)Lcom/crashlytics/android/answers/AnswersRetryFilesSender;
    ...
    new-instance v4, Lio/fabric/sdk/android/services/concurrency/a/d;

    const-wide/16 v6, 0x3e8

    const/16 v5, 0x8

    invoke-direct {v4, v6, v7, v5}, Lio/fabric/sdk/android/services/concurrency/a/d;-><init>(JI)V

    const-wide v6, 0x3fb999999999999aL    # 0.1

    invoke-direct {v0, v4, v6, v7}, Lcom/crashlytics/android/answers/RandomBackoff;-><init>(Lio/fabric/sdk/android/services/concurrency/a/b;D)V

    .line 33
    .local v0, "backoff":Lio/fabric/sdk/android/services/concurrency/a/b;
    new-instance v2, Lio/fabric/sdk/android/services/concurrency/a/c;

    const/4 v4, 0x5

    invoke-direct {v2, v4}, Lio/fabric/sdk/android/services/concurrency/a/c;-><init>(I)V

    .line 34
    .local v2, "retryPolicy":Lio/fabric/sdk/android/services/concurrency/a/f;
    new-instance v3, Lio/fabric/sdk/android/services/concurrency/a/g;

    invoke-direct {v3, v0, v2}, Lio/fabric/sdk/android/services/concurrency/a/g;-><init>(Lio/fabric/sdk/android/services/concurrency/a/b;Lio/fabric/sdk/android/services/concurrency/a/f;)V

    .line 35
    .local v3, "retryState":Lio/fabric/sdk/android/services/concurrency/a/g;
    new-instance v1, Lcom/crashlytics/android/answers/RetryManager;

    invoke-direct {v1, v3}, Lcom/crashlytics/android/answers/RetryManager;-><init>(Lio/fabric/sdk/android/services/concurrency/a/g;)V
