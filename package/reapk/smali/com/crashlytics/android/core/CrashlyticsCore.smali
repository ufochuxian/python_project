...
.method private finishInitSynchronously()V
    ...
    .line 685
    .local v0, "callable":Lio/fabric/sdk/android/services/concurrency/e;, "Lio/fabric/sdk/android/services/concurrency/e<Ljava/lang/Void;>;"
    ...
    check-cast v3, Lio/fabric/sdk/android/services/concurrency/k;

    .line 686
    .local v3, "task":Lio/fabric/sdk/android/services/concurrency/k;
    invoke-virtual {v0, v3}, Lio/fabric/sdk/android/services/concurrency/e;->addDependency(Lio/fabric/sdk/android/services/concurrency/k;)V

    goto :goto_0

    .line 689
    .end local v3    # "task":Lio/fabric/sdk/android/services/concurrency/k;
    :cond_0
    invoke-virtual {p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getFabric()Lio/fabric/sdk/android/d;

    move-result-object v4

    invoke-virtual {v4}, Lio/fabric/sdk/android/d;->f()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-interface {v4, v5, v6, v1}, Lio/fabric/sdk/android/l;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static formatLogMessage(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/fabric/sdk/android/services/common/i;->b(I)Ljava/lang/String;
...
.method static isBuildIdValid(Ljava/lang/String;Z)Z
    ...
    .line 881
    :cond_1
    invoke-static {p0}, Lio/fabric/sdk/android/services/common/i;->e(Ljava/lang/String;)Z
...
.method protected doInBackground()Ljava/lang/Void;
    ...
    invoke-virtual {v3}, Lio/fabric/sdk/android/services/settings/r;->c()Lio/fabric/sdk/android/services/settings/t;

    move-result-object v2

    .line 310
    .local v2, "settingsData":Lio/fabric/sdk/android/services/settings/t;
    if-nez v2, :cond_1
    ...
    .line 341
    .end local v2    # "settingsData":Lio/fabric/sdk/android/services/settings/t;
    :goto_0
    return-object v6

    .line 315
    .restart local v2    # "settingsData":Lio/fabric/sdk/android/services/settings/t;
    :cond_1
    :try_start_1
    ...
    invoke-virtual {v3, v4}, Lcom/crashlytics/android/core/CrashlyticsController;->finalizeSessions(Lio/fabric/sdk/android/services/settings/q;)Z
    ...
    invoke-virtual {v3, v4, v2}, Lcom/crashlytics/android/core/CrashlyticsController;->submitAllReports(FLio/fabric/sdk/android/services/settings/t;)V
    :try_end_2
...
.method internalVerifyPinning(Ljava/net/URL;)Z
    ...
    .line 778
    invoke-interface {v3, v4, v5}, Lio/fabric/sdk/android/services/network/c;->a(Lio/fabric/sdk/android/services/network/HttpMethod;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
...
.method public logException(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lio/fabric/sdk/android/l;->a(ILjava/lang/String;Ljava/lang/String;)V
...
.method onPreExecute(Landroid/content/Context;)Z
    ...
    .line 227
    :cond_1
    invoke-static/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/i;->n(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Lio/fabric/sdk/android/services/common/i;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    invoke-direct {v7, v0}, Lio/fabric/sdk/android/services/c/b;-><init>(Lio/fabric/sdk/android/i;)V

    .line 241
    .local v7, "fileStore":Lio/fabric/sdk/android/services/c/a;
    new-instance v1, Lcom/crashlytics/android/core/CrashlyticsFileMarker;

    const-string v2, "crash_marker"

    invoke-direct {v1, v2, v7}, Lcom/crashlytics/android/core/CrashlyticsFileMarker;-><init>(Ljava/lang/String;Lio/fabric/sdk/android/services/c/a;)V
    ...
    .line 245
    new-instance v15, Lio/fabric/sdk/android/services/c/e;
    ...
    invoke-direct {v15, v1, v2}, Lio/fabric/sdk/android/services/c/e;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 248
    .local v15, "preferenceStore":Lio/fabric/sdk/android/services/c/d;
    move-object/from16 v0, p0

    invoke-static {v15, v0}, Lcom/crashlytics/android/core/PreferenceManager;->create(Lio/fabric/sdk/android/services/c/d;Lcom/crashlytics/android/core/CrashlyticsCore;)Lcom/crashlytics/android/core/PreferenceManager;
    ...
    iput-object v1, v0, Lcom/crashlytics/android/core/CrashlyticsCore;->httpRequestFactory:Lio/fabric/sdk/android/services/network/c;

    .line 253
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/crashlytics/android/core/CrashlyticsCore;->httpRequestFactory:Lio/fabric/sdk/android/services/network/c;

    invoke-interface {v1, v13}, Lio/fabric/sdk/android/services/network/c;->a(Lio/fabric/sdk/android/services/network/e;)V
    ...
    iget-object v4, v0, Lcom/crashlytics/android/core/CrashlyticsCore;->httpRequestFactory:Lio/fabric/sdk/android/services/network/c;
    ...
    invoke-static/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/i;->o(Landroid/content/Context;)Z
    ...
    .end local v7    # "fileStore":Lio/fabric/sdk/android/services/c/a;
    .end local v15    # "preferenceStore":Lio/fabric/sdk/android/services/c/d;
    :catch_0
    move-exception v12
    ...
    invoke-interface {v1, v2, v3, v12}, Lio/fabric/sdk/android/l;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .restart local v7    # "fileStore":Lio/fabric/sdk/android/services/c/a;
    ...
    .restart local v15    # "preferenceStore":Lio/fabric/sdk/android/services/c/d;
    :cond_4
    invoke-static {}, Lio/fabric/sdk/android/d;->i()Lio/fabric/sdk/android/l;
...
.method public setString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lio/fabric/sdk/android/services/common/i;->j(Landroid/content/Context;)Z
