...
.field private final promptData:Lio/fabric/sdk/android/services/settings/p;


# direct methods
.method public constructor <init>(Lio/fabric/sdk/android/i;Lcom/crashlytics/android/core/PreferenceManager;Lio/fabric/sdk/android/services/settings/p;)V
    .locals 0
    .param p1, "kit"    # Lio/fabric/sdk/android/i;
    .param p2, "preferenceManager"    # Lcom/crashlytics/android/core/PreferenceManager;
    .param p3, "promptData"    # Lio/fabric/sdk/android/services/settings/p;
    ...
    .line 1438
    iput-object p1, p0, Lcom/crashlytics/android/core/CrashlyticsController$PrivacyDialogCheck;->kit:Lio/fabric/sdk/android/i;
    ...
    .line 1440
    iput-object p3, p0, Lcom/crashlytics/android/core/CrashlyticsController$PrivacyDialogCheck;->promptData:Lio/fabric/sdk/android/services/settings/p;
...
.method public canSendReports()Z
    ...
    .prologue
    .line 1445
    iget-object v3, p0, Lcom/crashlytics/android/core/CrashlyticsController$PrivacyDialogCheck;->kit:Lio/fabric/sdk/android/i;

    invoke-virtual {v3}, Lio/fabric/sdk/android/i;->getFabric()Lio/fabric/sdk/android/d;

    move-result-object v3

    invoke-virtual {v3}, Lio/fabric/sdk/android/d;->b()Landroid/app/Activity;
    ...
    iget-object v3, p0, Lcom/crashlytics/android/core/CrashlyticsController$PrivacyDialogCheck;->promptData:Lio/fabric/sdk/android/services/settings/p;

    .line 1460
    invoke-static {v0, v3, v1}, Lcom/crashlytics/android/core/CrashPromptDialog;->create(Landroid/app/Activity;Lio/fabric/sdk/android/services/settings/p;Lcom/crashlytics/android/core/CrashPromptDialog$AlwaysSendCallback;)Lcom/crashlytics/android/core/CrashPromptDialog;
