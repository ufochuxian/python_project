...
.method public constructor <init>(Lrx/l;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, Lrx/internal/producers/QueuedProducer;-><init>(Lrx/l;Ljava/util/Queue;)V
...
.method public constructor <init>(Lrx/l;Ljava/util/Queue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 62
    iput-object p1, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/l;
...
.method private checkTerminated(ZZ)Z
    ...
    .line 120
    iget-object v2, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/l;
    ...
    invoke-virtual {v2, v0}, Lrx/l;->onError(Ljava/lang/Throwable;)V
...
.method private drain()V
    ...
    .line 140
    iget-object v0, p0, Lrx/internal/producers/QueuedProducer;->child:Lrx/l;
    ...
    .line 148
    .restart local v0    # "c":Lrx/l;, "Lrx/l<-TT;>;"
    ...
    invoke-virtual {v0, v8}, Lrx/l;->onNext(Ljava/lang/Object;)V
    :try_end_0
    ...
    .end local v9    # "v":Ljava/lang/Object;
    :goto_4
    invoke-static {v4, v0, v9}, Lrx/exceptions/a;->a(Ljava/lang/Throwable;Lrx/f;Ljava/lang/Object;)V
