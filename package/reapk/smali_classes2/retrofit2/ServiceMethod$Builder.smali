...
.method private parseHeaders([Ljava/lang/String;)Lokhttp3/t;
    .locals 11
    ...
    .line 321
    :cond_2
    iput-object v5, p0, Lretrofit2/ServiceMethod$Builder;->contentType:Lokhttp3/w;

    .line 308
    .end local v5    # "type":Lokhttp3/w;
    :goto_1
...
.method private parseMethodAnnotation(Ljava/lang/annotation/Annotation;)V
    ...
    .line 264
    :cond_9
    invoke-direct {p0, v0}, Lretrofit2/ServiceMethod$Builder;->parseHeaders([Ljava/lang/String;)Lokhttp3/t;

    move-result-object v2

    iput-object v2, p0, Lretrofit2/ServiceMethod$Builder;->headers:Lokhttp3/t;
...
.method private parseParameterAnnotation(ILjava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljava/lang/annotation/Annotation;)Lretrofit2/ParameterHandler;
    ...
    .line 597
    invoke-static/range {v26 .. v26}, Lokhttp3/t;->a([Ljava/lang/String;)Lokhttp3/t;
    ...
    .line 615
    .local v6, "converter":Lretrofit2/Converter;, "Lretrofit2/Converter<*Lokhttp3/ab;>;"
    new-instance v26, Lretrofit2/ParameterHandler$Part;

    move-object/from16 v0, v26

    invoke-direct {v0, v11, v6}, Lretrofit2/ParameterHandler$Part;-><init>(Lokhttp3/t;Lretrofit2/Converter;)V
    ...
    .line 616
    .end local v6    # "converter":Lretrofit2/Converter;, "Lretrofit2/Converter<*Lokhttp3/ab;>;"
    .end local v12    # "iterableType":Ljava/lang/reflect/Type;
    .end local v16    # "parameterizedType":Ljava/lang/reflect/ParameterizedType;
    :cond_2f
    invoke-virtual/range {v22 .. v22}, Ljava/lang/Class;->isArray()Z
    ...
    .line 624
    .restart local v6    # "converter":Lretrofit2/Converter;, "Lretrofit2/Converter<*Lokhttp3/ab;>;"
    new-instance v26, Lretrofit2/ParameterHandler$Part;
    ...
    .local v24, "valueConverter":Lretrofit2/Converter;, "Lretrofit2/Converter<*Lokhttp3/ab;>;"
    ...
    .end local v22    # "rawParameterType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v24    # "valueConverter":Lretrofit2/Converter;, "Lretrofit2/Converter<*Lokhttp3/ab;>;"
    .end local v25    # "valueType":Ljava/lang/reflect/Type;
    :cond_39
    move-object/from16 v0, p4
