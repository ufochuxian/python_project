...
.method private createRawCall()Lokhttp3/e;
    ...
    invoke-virtual {v2, v3}, Lretrofit2/ServiceMethod;->toRequest([Ljava/lang/Object;)Lokhttp3/aa;

    move-result-object v1

    .line 179
    .local v1, "request":Lokhttp3/aa;
    iget-object v2, p0, Lretrofit2/OkHttpCall;->serviceMethod:Lretrofit2/ServiceMethod;

    iget-object v2, v2, Lretrofit2/ServiceMethod;->callFactory:Lokhttp3/e$a;

    invoke-interface {v2, v1}, Lokhttp3/e$a;->a(Lokhttp3/aa;)Lokhttp3/e;

    move-result-object v0

    .line 180
    .local v0, "call":Lokhttp3/e;
    if-nez v0, :cond_0
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    .end local v0    # "call":Lokhttp3/e;
    .local v1, "call":Lokhttp3/e;
    move-object v0, v1

    .line 90
    .end local v1    # "call":Lokhttp3/e;
    .restart local v0    # "call":Lokhttp3/e;
    :cond_2
    :goto_0
    :try_start_3
    monitor-exit p0
    ...
    invoke-interface {v0, v4}, Lokhttp3/e;->a(Lokhttp3/f;)V
...
.method public execute()Lretrofit2/Response;
    ...
    invoke-virtual {p0, v2}, Lretrofit2/OkHttpCall;->parseResponse(Lokhttp3/ac;)Lretrofit2/Response;
...
.method parseResponse(Lokhttp3/ac;)Lretrofit2/Response;
    .locals 12
    ...
    .line 191
    invoke-virtual {v5}, Lokhttp3/ad;->contentType()Lokhttp3/w;
    ...
    invoke-direct {v7, v8, v10, v11}, Lretrofit2/OkHttpCall$NoContentResponseBody;-><init>(Lokhttp3/w;J)V

    invoke-virtual {v6, v7}, Lokhttp3/ac$a;->a(Lokhttp3/ad;)Lokhttp3/ac$a;
    ...
    :cond_0
    :try_start_0
    invoke-static {v5}, Lretrofit2/Utils;->buffer(Lokhttp3/ad;)Lokhttp3/ad;

    move-result-object v1

    .line 199
    .local v1, "bufferedBody":Lokhttp3/ad;
    invoke-static {v1, p1}, Lretrofit2/Response;->error(Lokhttp3/ad;Lokhttp3/ac;)Lretrofit2/Response;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 201
    invoke-virtual {v5}, Lokhttp3/ad;->close()V

    .line 212
    .end local v1    # "bufferedBody":Lokhttp3/ad;
    :goto_0
    return-object v6
    ...
    invoke-static {v6, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lokhttp3/ac;)Lretrofit2/Response;
    ...
    invoke-direct {v2, v5}, Lretrofit2/OkHttpCall$ExceptionCatchingRequestBody;-><init>(Lokhttp3/ad;)V
    ...
    invoke-virtual {v6, v2}, Lretrofit2/ServiceMethod;->toResponse(Lokhttp3/ad;)Ljava/lang/Object;

    move-result-object v0

    .line 212
    .local v0, "body":Ljava/lang/Object;, "TT;"
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lokhttp3/ac;)Lretrofit2/Response;
    :try_end_1
...
.method public declared-synchronized request()Lokhttp3/aa;
    .locals 5
    ...
    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lokhttp3/e;
