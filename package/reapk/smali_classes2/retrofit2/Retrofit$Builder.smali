...
.method public baseUrl(Ljava/lang/String;)Lretrofit2/Retrofit$Builder;
    ...
    .line 439
    :cond_0
    invoke-virtual {p0, v0}, Lretrofit2/Retrofit$Builder;->baseUrl(Lokhttp3/u;)Lretrofit2/Retrofit$Builder;
...
.method public baseUrl(Lokhttp3/u;)Lretrofit2/Retrofit$Builder;
    ...
    .line 494
    invoke-virtual {p1}, Lokhttp3/u;->n()Ljava/util/List;
...
.method public build()Lretrofit2/Retrofit;
    ...
    .line 550
    .local v1, "callFactory":Lokhttp3/e$a;
    if-nez v1, :cond_1

    .line 551
    new-instance v1, Lokhttp3/y;

    .end local v1    # "callFactory":Lokhttp3/e$a;
    invoke-direct {v1}, Lokhttp3/y;-><init>()V

    .line 554
    .restart local v1    # "callFactory":Lokhttp3/e$a;
    :cond_1
    ...
    iget-object v2, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lokhttp3/u;

    iget-boolean v6, p0, Lretrofit2/Retrofit$Builder;->validateEagerly:Z

    invoke-direct/range {v0 .. v6}, Lretrofit2/Retrofit;-><init>(Lokhttp3/e$a;Lokhttp3/u;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
...
.method public client(Lokhttp3/y;)Lretrofit2/Retrofit$Builder;
    .locals 1
