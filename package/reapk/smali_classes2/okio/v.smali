...
.method constructor <init>(Lokio/c;I)V
    ...
    iput-boolean v0, v7, Lokio/t;->f:Z
...
.method private a(I)I
    ...
    .prologue
    .line 139
    iget-object v1, p0, Lokio/v;->b:[I

    const/4 v2, 0x0

    iget-object v3, p0, Lokio/v;->a:[[B
...
.method private a()Lokio/ByteString;
    ...
    invoke-virtual {p0}, Lokio/v;->toByteArray()[B
...
.method private b()Ljava/lang/Object;
    ...
    .prologue
    .line 279
    invoke-direct {p0}, Lokio/v;->a()Lokio/ByteString;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lokio/v;->size()I
    ...
    invoke-virtual {p0, v2, p1, v2, v0}, Lokio/v;->rangeEquals(ILokio/ByteString;II)Z
...
.method public getByte(I)B
    ...
    .line 130
    invoke-direct {p0, p1}, Lokio/v;->a(I)I
...
.method public hashCode()I
    ...
    .local v5, "s":I
    iget-object v11, p0, Lokio/v;->a:[[B
    ...
    .line 263
    .local v6, "segment":[B
    iget-object v11, p0, Lokio/v;->b:[I
...
.method public rangeEquals(I[BII)Z
    ...
    invoke-static {v7, v0, p2, p3, v5}, Lokio/z;->a([BI[BII)Z
...
.method write(Lokio/c;)V
    ...
    invoke-direct {v2, v6, v5, v7}, Lokio/t;-><init>([BII)V

    .line 182
    .local v2, "segment":Lokio/t;
    iget-object v6, p1, Lokio/c;->b:Lokio/t;

    if-nez v6, :cond_0

    .line 183
    iput-object v2, v2, Lokio/t;->i:Lokio/t;

    iput-object v2, v2, Lokio/t;->h:Lokio/t;

    iput-object v2, p1, Lokio/c;->b:Lokio/t;
    ...
    invoke-virtual {v6, v2}, Lokio/t;->a(Lokio/t;)Lokio/t;

    goto :goto_1

    .line 189
    .end local v0    # "nextSegmentOffset":I
    .end local v2    # "segment":Lokio/t;
    .end local v5    # "segmentPos":I
    :cond_1
    iget-wide v6, p1, Lokio/c;->c:J

    int-to-long v8, v4

    add-long/2addr v6, v8

    iput-wide v6, p1, Lokio/c;->c:J
