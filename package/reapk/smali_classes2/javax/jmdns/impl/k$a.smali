.class public Ljavax/jmdns/impl/k$a;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 27
    const-class v0, Ljavax/jmdns/impl/k$a;
    ...
    sput-object v0, Ljavax/jmdns/impl/k$a;->c:Ljava/util/logging/Logger;

    return-void
.end method

.method public constructor <init>(Ljavax/jmdns/e;Z)V
    .locals 2
    .param p1, "listener"    # Ljavax/jmdns/e;
    .param p2, "synch"    # Z
    ...
    iput-object v0, p0, Ljavax/jmdns/impl/k$a;->d:Ljava/util/concurrent/ConcurrentMap;
...
.method private static final a(Ljavax/jmdns/ServiceInfo;Ljavax/jmdns/ServiceInfo;)Z
    ...
    .line 120
    invoke-virtual {p0}, Ljavax/jmdns/ServiceInfo;->t()[B
...
.method a(Ljavax/jmdns/ServiceEvent;)V
    ...
    iget-object v2, p0, Ljavax/jmdns/impl/k$a;->d:Ljava/util/concurrent/ConcurrentMap;

    invoke-virtual {p1}, Ljavax/jmdns/ServiceEvent;->getInfo()Ljavax/jmdns/ServiceInfo;

    move-result-object v3

    invoke-virtual {v3}, Ljavax/jmdns/ServiceInfo;->F()Ljavax/jmdns/ServiceInfo;
    ...
    .line 60
    invoke-virtual {p0}, Ljavax/jmdns/impl/k$a;->a()Ljava/util/EventListener;

    move-result-object v2

    check-cast v2, Ljavax/jmdns/e;

    invoke-interface {v2, p1}, Ljavax/jmdns/e;->serviceAdded(Ljavax/jmdns/ServiceEvent;)V
    ...
    invoke-interface {v2, p1}, Ljavax/jmdns/e;->serviceResolved(Ljavax/jmdns/ServiceEvent;)V
    ...
    .line 66
    :cond_1
    sget-object v2, Ljavax/jmdns/impl/k$a;->c:Ljava/util/logging/Logger;
...
.method b(Ljavax/jmdns/ServiceEvent;)V
    ...
    iget-object v1, p0, Ljavax/jmdns/impl/k$a;->d:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-interface {v1, p1}, Ljavax/jmdns/e;->serviceRemoved(Ljavax/jmdns/ServiceEvent;)V
    ...
    .line 81
    :cond_0
    sget-object v1, Ljavax/jmdns/impl/k$a;->c:Ljava/util/logging/Logger;
...
.method declared-synchronized c(Ljavax/jmdns/ServiceEvent;)V
    .locals 6
    .param p1, "event"    # Ljavax/jmdns/ServiceEvent;
    ...
    iget-object v3, p0, Ljavax/jmdns/impl/k$a;->d:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-static {v0, v1}, Ljavax/jmdns/impl/k$a;->a(Ljavax/jmdns/ServiceInfo;Ljavax/jmdns/ServiceInfo;)Z
    ...
    check-cast v3, Ljavax/jmdns/e;

    invoke-interface {v3, p1}, Ljavax/jmdns/e;->serviceResolved(Ljavax/jmdns/ServiceEvent;)V
    :try_end_0
    ...
    :cond_2
    :try_start_2
    sget-object v3, Ljavax/jmdns/impl/k$a;->c:Ljava/util/logging/Logger;
