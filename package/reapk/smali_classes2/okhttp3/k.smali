...
.method public constructor <init>(IJLjava/util/concurrent/TimeUnit;)V
    ...
    iput-object v0, p0, Lokhttp3/k;->a:Lokhttp3/internal/connection/d;
...
.method private a(Lokhttp3/internal/connection/c;J)I
    ...
    .prologue
    .line 239
    iget-object v2, p1, Lokhttp3/internal/connection/c;->g:Ljava/util/List;

    .line 240
    .local v2, "references":Ljava/util/List;, "Ljava/util/List<Ljava/lang/ref/Reference<Lokhttp3/internal/connection/f;>;>;"
    const/4 v0, 0x0
    ...
    invoke-virtual {v6}, Lokhttp3/ae;->a()Lokhttp3/a;

    move-result-object v6

    invoke-virtual {v6}, Lokhttp3/a;->a()Lokhttp3/u;
    ...
    invoke-virtual {v3, v4, v5, v6}, Lokhttp3/internal/d/e;->a(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    iput-boolean v3, p1, Lokhttp3/internal/connection/c;->h:Z
    ...
    .line 256
    iget-wide v4, p0, Lokhttp3/k;->f:J

    sub-long v4, p2, v4

    iput-wide v4, p1, Lokhttp3/internal/connection/c;->i:J
...
.method public declared-synchronized a()I
    ...
    iget-object v3, v0, Lokhttp3/internal/connection/c;->g:Ljava/util/List;
...
.method a(J)J
    ...
    .line 185
    .local v6, "longestIdleConnection":Lokhttp3/internal/connection/c;
    ...
    .line 189
    :try_start_0
    iget-object v7, p0, Lokhttp3/k;->h:Ljava/util/Deque;

    invoke-interface {v7}, Ljava/util/Deque;->iterator()Ljava/util/Iterator;

    move-result-object v1

    .local v1, "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lokhttp3/internal/connection/c;>;"
    :cond_0
    :goto_0
    ...
    .line 193
    .local v0, "connection":Lokhttp3/internal/connection/c;
    invoke-direct {p0, v0, p1, p2}, Lokhttp3/k;->a(Lokhttp3/internal/connection/c;J)I
    ...
    .line 201
    iget-wide v10, v0, Lokhttp3/internal/connection/c;->i:J
    ...
    :cond_2
    iget-wide v10, p0, Lokhttp3/k;->f:J

    cmp-long v7, v8, v10

    if-gez v7, :cond_3

    iget v7, p0, Lokhttp3/k;->e:I
    ...
    .line 226
    invoke-virtual {v6}, Lokhttp3/internal/connection/c;->b()Ljava/net/Socket;

    move-result-object v7

    invoke-static {v7}, Lokhttp3/internal/c;->a(Ljava/net/Socket;)V
    ...
    .line 224
    .end local v1    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lokhttp3/internal/connection/c;>;"
    :catchall_0
    move-exception v7
    ...
    .line 216
    .restart local v1    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lokhttp3/internal/connection/c;>;"
    :cond_5
    if-lez v3, :cond_6
    ...
    iput-boolean v7, p0, Lokhttp3/k;->b:Z
...
.method a(Lokhttp3/a;Lokhttp3/internal/connection/f;)Lokhttp3/internal/connection/c;
    ...
    .prologue
    .line 119
    sget-boolean v1, Lokhttp3/k;->c:Z
...
.method public c()V
    ...
    .line 158
    .local v1, "evictedConnections":Ljava/util/List;, "Ljava/util/List<Lokhttp3/internal/connection/c;>;"
    monitor-enter p0

    .line 159
    :try_start_0
    iget-object v3, p0, Lokhttp3/k;->h:Ljava/util/Deque;

    invoke-interface {v3}, Ljava/util/Deque;->iterator()Ljava/util/Iterator;

    move-result-object v2

    .local v2, "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lokhttp3/internal/connection/c;>;"
    :cond_0
    :goto_0
    invoke-interface {v2}, Ljava/util/Iterator;->hasNext()Z
    ...
    iput-boolean v3, v0, Lokhttp3/internal/connection/c;->h:Z
    ...
    .line 167
    .end local v0    # "connection":Lokhttp3/internal/connection/c;
    .end local v2    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lokhttp3/internal/connection/c;>;"
    :catchall_0
    move-exception v3
    ...
    .restart local v2    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lokhttp3/internal/connection/c;>;"
    :cond_1
    :try_start_1
    monitor-exit p0
    :try_end_1
    ...
    .line 170
    .restart local v0    # "connection":Lokhttp3/internal/connection/c;
