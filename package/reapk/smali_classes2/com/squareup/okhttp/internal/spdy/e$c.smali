...
.method constructor <init>(Lokio/e;IZ)V
    ...
    invoke-direct {v0, p2, v1}, Lcom/squareup/okhttp/internal/spdy/d$a;-><init>(ILokio/x;)V
...
.method private a(Lcom/squareup/okhttp/internal/spdy/a$a;I)V
    .locals 5
    .param p1, "handler"    # Lcom/squareup/okhttp/internal/spdy/a$a;
    .param p2, "streamId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 244
    .local v3, "weight":I
    invoke-interface {p1, p2, v1, v3, v0}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(IIIZ)V
...
.method private a(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    .line 196
    :cond_1
    invoke-static {p2, p3, v7}, Lcom/squareup/okhttp/internal/spdy/e;->a(IBS)I

    move-result p2

    .line 198
    invoke-direct {p0, p2, v7, p3, p4}, Lcom/squareup/okhttp/internal/spdy/e$c;->a(ISBI)Ljava/util/List;

    move-result-object v5

    .line 200
    .local v5, "headerBlock":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp/internal/spdy/c;>;"
    const/4 v4, -0x1
    ...
    .end local v5    # "headerBlock":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp/internal/spdy/c;>;"
...
.method private b(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    invoke-static {v3, v4}, Lcom/squareup/okhttp/internal/spdy/e;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .local v2, "padding":S
    :cond_3
    invoke-static {p2, p3, v2}, Lcom/squareup/okhttp/internal/spdy/e;->a(IBS)I
    ...
    invoke-interface {p1, v1, p4, v3, p2}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(ZILokio/e;I)V
    ...
    invoke-interface {v3, v4, v5}, Lokio/e;->h(J)V
...
.method private d(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    .line 256
    :cond_2
    invoke-interface {p1, p4, v0}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(ILcom/squareup/okhttp/internal/spdy/ErrorCode;)V
...
.method private e(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    invoke-static {v4, v5}, Lcom/squareup/okhttp/internal/spdy/e;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    invoke-direct {v2}, Lcom/squareup/okhttp/internal/spdy/k;-><init>()V

    .line 270
    .local v2, "settings":Lcom/squareup/okhttp/internal/spdy/k;
    const/4 v0, 0x0
    ...
    invoke-interface {v4}, Lokio/e;->j()S
    ...
    :cond_5
    :pswitch_2
    invoke-virtual {v2, v1, v7, v3}, Lcom/squareup/okhttp/internal/spdy/k;->a(III)Lcom/squareup/okhttp/internal/spdy/k;
    ...
    :cond_7
    invoke-interface {p1, v7, v2}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(ZLcom/squareup/okhttp/internal/spdy/k;)V

    .line 304
    invoke-virtual {v2}, Lcom/squareup/okhttp/internal/spdy/k;->c()I
    ...
    .line 305
    iget-object v4, p0, Lcom/squareup/okhttp/internal/spdy/e$c;->a:Lcom/squareup/okhttp/internal/spdy/d$a;

    invoke-virtual {v2}, Lcom/squareup/okhttp/internal/spdy/k;->c()I

    move-result v5

    invoke-virtual {v4, v5}, Lcom/squareup/okhttp/internal/spdy/d$a;->a(I)V
...
.method private f(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    .line 317
    invoke-static {p2, p3, v1}, Lcom/squareup/okhttp/internal/spdy/e;->a(IBS)I

    move-result p2

    .line 318
    invoke-direct {p0, p2, v1, p3, p4}, Lcom/squareup/okhttp/internal/spdy/e$c;->a(ISBI)Ljava/util/List;

    move-result-object v0

    .line 319
    .local v0, "headerBlock":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp/internal/spdy/c;>;"
    invoke-interface {p1, p4, v2, v0}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(IILjava/util/List;)V
...
.method private g(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    invoke-static {v4, v3}, Lcom/squareup/okhttp/internal/spdy/e;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .local v0, "ack":Z
    :goto_0
    invoke-interface {p1, v0, v1, v2}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(ZII)V
...
.method private h(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
    ...
    invoke-static {v5, v6}, Lcom/squareup/okhttp/internal/spdy/e;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 336
    :cond_1
    iget-object v5, p0, Lcom/squareup/okhttp/internal/spdy/e$c;->b:Lokio/e;
    ...
    invoke-interface {v5, v6, v7}, Lokio/e;->d(J)Lokio/ByteString;

    move-result-object v0

    .line 347
    :cond_3
    invoke-interface {p1, v3, v1, v0}, Lcom/squareup/okhttp/internal/spdy/a$a;->a(ILcom/squareup/okhttp/internal/spdy/ErrorCode;Lokio/ByteString;)V
...
.method public a()V
    ...
    .line 103
    iget-boolean v1, p0, Lcom/squareup/okhttp/internal/spdy/e$c;->d:Z
...
.method public a(Lcom/squareup/okhttp/internal/spdy/a$a;)Z
    ...
    .line 113
    :try_start_0
    iget-object v7, p0, Lcom/squareup/okhttp/internal/spdy/e$c;->b:Lokio/e;

    const-wide/16 v8, 0x9

    invoke-interface {v7, v8, v9}, Lokio/e;->a(J)V
    :try_end_0
    ...
    invoke-static {v7}, Lcom/squareup/okhttp/internal/spdy/e;->a(Lokio/e;)I
    ...
    invoke-static {v7, v5}, Lcom/squareup/okhttp/internal/spdy/e;->a(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    :cond_1
    iget-object v6, p0, Lcom/squareup/okhttp/internal/spdy/e$c;->b:Lokio/e;

    invoke-interface {v6}, Lokio/e;->i()B
    ...
    invoke-static {v5, v3, v2, v4, v1}, Lcom/squareup/okhttp/internal/spdy/e$b;->a(ZIIBB)Ljava/lang/String;
    ...
    invoke-interface {v6, v8, v9}, Lokio/e;->h(J)V

    goto :goto_0

    .line 141
    :pswitch_0
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->b(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 145
    :pswitch_1
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->a(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 149
    :pswitch_2
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->c(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 153
    :pswitch_3
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->d(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 157
    :pswitch_4
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->e(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 161
    :pswitch_5
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->f(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 165
    :pswitch_6
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->g(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 169
    :pswitch_7
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->h(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V

    goto :goto_0

    .line 173
    :pswitch_8
    invoke-direct {p0, p1, v2, v1, v3}, Lcom/squareup/okhttp/internal/spdy/e$c;->i(Lcom/squareup/okhttp/internal/spdy/a$a;IBI)V
