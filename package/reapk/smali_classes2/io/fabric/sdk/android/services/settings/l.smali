...
.method private a(Lio/fabric/sdk/android/services/common/k;JLorg/json/JSONObject;)J
    .locals 6
    .param p1, "currentTimeProvider"    # Lio/fabric/sdk/android/services/common/k;
    ...
    .line 231
    :cond_0
    invoke-interface {p1}, Lio/fabric/sdk/android/services/common/k;->a()J
...
.method private a(Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/e;
    ...
    .line 88
    .local v6, "icon":Lio/fabric/sdk/android/services/settings/c;
...
.method private a(Lio/fabric/sdk/android/services/settings/b;)Lorg/json/JSONObject;
    .locals 3
    .param p1, "data"    # Lio/fabric/sdk/android/services/settings/b;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
...
.method private a(Lio/fabric/sdk/android/services/settings/c;)Lorg/json/JSONObject;
    .locals 3
    .param p1, "icon"    # Lio/fabric/sdk/android/services/settings/c;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
...
.method private a(Lio/fabric/sdk/android/services/settings/e;)Lorg/json/JSONObject;
    .locals 4
    .param p1, "appData"    # Lio/fabric/sdk/android/services/settings/e;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
    ...
    iget-object v3, p1, Lio/fabric/sdk/android/services/settings/e;->d:Ljava/lang/String;
    ...
    iget-object v3, p1, Lio/fabric/sdk/android/services/settings/e;->e:Ljava/lang/String;
    ...
    iget-object v3, p1, Lio/fabric/sdk/android/services/settings/e;->g:Ljava/lang/String;
    ...
    iget-boolean v3, p1, Lio/fabric/sdk/android/services/settings/e;->h:Z
...
.method private a(Lio/fabric/sdk/android/services/settings/g;)Lorg/json/JSONObject;
    .locals 3
    .param p1, "data"    # Lio/fabric/sdk/android/services/settings/g;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
...
.method private a(Lio/fabric/sdk/android/services/settings/n;)Lorg/json/JSONObject;
    .locals 3
    .param p1, "features"    # Lio/fabric/sdk/android/services/settings/n;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
...
.method private a(Lio/fabric/sdk/android/services/settings/p;)Lorg/json/JSONObject;
    .locals 3
    .param p1, "data"    # Lio/fabric/sdk/android/services/settings/p;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
...
.method private a(Lio/fabric/sdk/android/services/settings/q;)Lorg/json/JSONObject;
    .locals 3
    .param p1, "data"    # Lio/fabric/sdk/android/services/settings/q;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
        }
...
.method private b(Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/c;
    ...
    invoke-direct {v3, v0, v2, v1}, Lio/fabric/sdk/android/services/settings/c;-><init>(Ljava/lang/String;II)V
...
.method private c(Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/n;
    ...
    invoke-direct {v4, v3, v1, v2, v0}, Lio/fabric/sdk/android/services/settings/n;-><init>(ZZZZ)V
...
.method private e(Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/q;
    ...
    invoke-direct/range {v0 .. v7}, Lio/fabric/sdk/android/services/settings/q;-><init>(IIIIIZI)V
...
.method private g(Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/g;
    ...
    sget-object v3, Lio/fabric/sdk/android/services/settings/u;->E:Ljava/lang/String;
    ...
    invoke-direct {v2, v1, v0}, Lio/fabric/sdk/android/services/settings/g;-><init>(Ljava/lang/String;I)V
...
# virtual methods
.method public a(Lio/fabric/sdk/android/services/common/k;Lorg/json/JSONObject;)Lio/fabric/sdk/android/services/settings/t;
    .locals 12
    .param p1, "currentTimeProvider"    # Lio/fabric/sdk/android/services/common/k;
    ...
    .line 43
    .local v4, "appData":Lio/fabric/sdk/android/services/settings/e;
    ...
    .line 45
    .local v5, "settingsData":Lio/fabric/sdk/android/services/settings/q;
    ...
    .line 47
    .local v6, "promptData":Lio/fabric/sdk/android/services/settings/p;
    ...
    .line 49
    .local v7, "featureData":Lio/fabric/sdk/android/services/settings/n;
    ...
    .line 51
    .local v8, "analyticsData":Lio/fabric/sdk/android/services/settings/b;
    ...
    .line 54
    .local v9, "betaData":Lio/fabric/sdk/android/services/settings/g;
    int-to-long v0, v11

    invoke-direct {p0, p1, v0, v1, p2}, Lio/fabric/sdk/android/services/settings/l;->a(Lio/fabric/sdk/android/services/common/k;JLorg/json/JSONObject;)J
