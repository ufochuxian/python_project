...
.method getDayOfMonth(J)I
    ...
    .prologue
    .line 107
    invoke-virtual {p0, p1, p2}, Lorg/joda/time/chrono/d;->getDayOfYear(J)I
...
.method getMonthOfYear(JI)I
    ...
    .prologue
    .line 137
    invoke-virtual {p0, p3}, Lorg/joda/time/chrono/d;->getYearMillis(I)J
...
.method getYearDifference(JJ)J
    ...
    .prologue
    .line 85
    invoke-virtual {p0, p1, p2}, Lorg/joda/time/chrono/d;->getYear(J)I

    move-result v0

    .line 86
    invoke-virtual {p0, p3, p4}, Lorg/joda/time/chrono/d;->getYear(J)I

    move-result v1

    .line 89
    invoke-virtual {p0, v0}, Lorg/joda/time/chrono/d;->getYearMillis(I)J
    ...
    .line 90
    invoke-virtual {p0, v1}, Lorg/joda/time/chrono/d;->getYearMillis(I)J
...
.method setYear(JI)J
    ...
    .line 66
    invoke-virtual {p0, p1, p2, v0}, Lorg/joda/time/chrono/d;->getDayOfYear(JI)I

    move-result v0

    .line 67
    invoke-virtual {p0, p1, p2}, Lorg/joda/time/chrono/d;->getMillisOfDay(J)I
    ...
    invoke-virtual {p0, p3, v2, v0}, Lorg/joda/time/chrono/d;->getYearMonthDayMillis(III)J
