...
.method public copy()Lorg/chromium/content/browser/ChildProcessCreationParams;
    .locals 4

    .prologue
    .line 42
    new-instance v0, Lorg/chromium/content/browser/ChildProcessCreationParams;

    iget-object v1, p0, Lorg/chromium/content/browser/ChildProcessCreationParams;->mPackageName:Ljava/lang/String;

    iget v2, p0, Lorg/chromium/content/browser/ChildProcessCreationParams;->mExtraBindFlags:I

    iget v3, p0, Lorg/chromium/content/browser/ChildProcessCreationParams;->mLibraryProcessType:I

    invoke-direct {v0, v1, v2, v3}, Lorg/chromium/content/browser/ChildProcessCreationParams;-><init>(Ljava/lang/String;II)V

    return-object v0
.end method

.method public getExtraBindFlags()I
    .locals 1
...
.method public getLibraryProcessType()I
    .locals 1

    .prologue
    .line 54
    iget v0, p0, Lorg/chromium/content/browser/ChildProcessCreationParams;->mLibraryProcessType:I
