...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 21
    const-class v0, Lorg/chromium/device/gamepad/GamepadDevice;
    ...
    :goto_0
    sput-boolean v0, Lorg/chromium/device/gamepad/GamepadDevice;->$assertionsDisabled:Z
...
.method constructor <init>(ILandroid/view/InputDevice;)V
    ...
    iput-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mAxisValues:[F
    ...
    iput-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mButtonsValues:[F

    .line 53
    new-array v6, v8, [F

    iput-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mRawButtons:[F

    .line 54
    new-array v6, v8, [F

    iput-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mRawAxes:[F
    ...
    iput v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mDeviceId:I
    ...
    iput-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mDeviceName:Ljava/lang/String;
    ...
    iput-wide v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mTimestamp:J
    ...
    iput-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mAxes:[I
    ...
    .line 74
    .local v0, "axis":I
    sget-boolean v6, Lorg/chromium/device/gamepad/GamepadDevice;->$assertionsDisabled:Z
    ...
    .line 75
    :cond_1
    iget-object v6, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mAxes:[I
...
.method public handleKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 156
    .local v0, "keyCode":I
    sget-boolean v2, Lorg/chromium/device/gamepad/GamepadDevice;->$assertionsDisabled:Z
    ...
    .line 159
    iget-object v2, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mRawButtons:[F
    ...
    iput-wide v2, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mTimestamp:J
...
.method public handleMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    .local v1, "i":I
    :goto_1
    iget-object v2, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mAxes:[I
...
.method public isStandardGamepad()Z
    ...
    .prologue
    .line 99
    iget-boolean v0, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mIsStandardGamepad:Z
...
.method public updateButtonsAndAxesMapping()V
    ...
    iget-object v1, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mButtonsValues:[F

    iget-object v2, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mRawAxes:[F

    iget-object v3, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mRawButtons:[F

    iget-object v4, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mDeviceName:Ljava/lang/String;

    invoke-static {v0, v1, v2, v3, v4}, Lorg/chromium/device/gamepad/GamepadMappings;->mapToStandardGamepad([F[F[F[FLjava/lang/String;)Z

    move-result v0

    iput-boolean v0, p0, Lorg/chromium/device/gamepad/GamepadDevice;->mIsStandardGamepad:Z
