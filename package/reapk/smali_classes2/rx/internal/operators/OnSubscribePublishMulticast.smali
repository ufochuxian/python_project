...
.method static constructor <clinit>()V
    ...
    .line 86
    new-array v0, v1, [Lrx/internal/operators/OnSubscribePublishMulticast$b;

    sput-object v0, Lrx/internal/operators/OnSubscribePublishMulticast;->EMPTY:[Lrx/internal/operators/OnSubscribePublishMulticast$b;
...
.method public constructor <init>(IZ)V
    ...
    .line 112
    :goto_0
    sget-object v0, Lrx/internal/operators/OnSubscribePublishMulticast;->EMPTY:[Lrx/internal/operators/OnSubscribePublishMulticast$b;

    check-cast v0, [Lrx/internal/operators/OnSubscribePublishMulticast$b;

    iput-object v0, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->subscribers:[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    ...
    invoke-direct {v0, p1}, Lrx/internal/util/atomic/d;-><init>(I)V
...
.method add(Lrx/internal/operators/OnSubscribePublishMulticast$b;)Z
    ...
    .prologue
    .local p0, "this":Lrx/internal/operators/OnSubscribePublishMulticast;, "Lrx/internal/operators/OnSubscribePublishMulticast<TT;>;"
    .local p1, "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    const/4 v3, 0x0
    ...
    .line 317
    .local v0, "a":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    sget-object v4, Lrx/internal/operators/OnSubscribePublishMulticast;->TERMINATED:[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    ...
    new-array v1, v3, [Lrx/internal/operators/OnSubscribePublishMulticast$b;

    .line 329
    .local v1, "b":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    const/4 v3, 0x0
...
.method public bridge synthetic call(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lrx/internal/operators/OnSubscribePublishMulticast;->call(Lrx/l;)V
...
.method public call(Lrx/l;)V
    ...
    new-instance v1, Lrx/internal/operators/OnSubscribePublishMulticast$b;

    invoke-direct {v1, p1, p0}, Lrx/internal/operators/OnSubscribePublishMulticast$b;-><init>(Lrx/l;Lrx/internal/operators/OnSubscribePublishMulticast;)V

    .line 119
    .local v1, "pp":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    ...
    .line 122
    invoke-virtual {p0, v1}, Lrx/internal/operators/OnSubscribePublishMulticast;->add(Lrx/internal/operators/OnSubscribePublishMulticast$b;)Z
    ...
    .line 123
    invoke-virtual {v1}, Lrx/internal/operators/OnSubscribePublishMulticast$b;->isUnsubscribed()Z
    ...
    .line 124
    invoke-virtual {p0, v1}, Lrx/internal/operators/OnSubscribePublishMulticast;->remove(Lrx/internal/operators/OnSubscribePublishMulticast$b;)V
...
.method checkTerminated(ZZ)Z
    ...
    .local v1, "arr$":[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    array-length v5, v1
    ...
    .line 261
    .local v4, "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    iget-object v7, v4, Lrx/internal/operators/OnSubscribePublishMulticast$b;->a:Lrx/l;

    invoke-virtual {v7, v2}, Lrx/l;->onError(Ljava/lang/Throwable;)V
    ...
    .line 264
    .end local v1    # "arr$":[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    .end local v3    # "i$":I
    .end local v4    # "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    .end local v5    # "len$":I
    :cond_0
    move-object v1, v0

    .restart local v1    # "arr$":[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    array-length v5, v1
    ...
    .line 265
    .restart local v4    # "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    iget-object v7, v4, Lrx/internal/operators/OnSubscribePublishMulticast$b;->a:Lrx/l;

    invoke-virtual {v7}, Lrx/l;->onCompleted()V
    ...
    .line 271
    .end local v0    # "a":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    .end local v1    # "arr$":[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    ...
    .line 275
    .restart local v0    # "a":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    move-object v1, v0
...
.method drain()V
    ...
    iget-object v4, v0, Lrx/internal/operators/OnSubscribePublishMulticast;->subscribers:[Lrx/internal/operators/OnSubscribePublishMulticast$b;

    .line 191
    .local v4, "a":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    array-length v14, v4
    ...
    .local v5, "arr$":[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    array-length v12, v5
    ...
    .line 194
    .local v11, "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    invoke-virtual {v11}, Lrx/internal/operators/OnSubscribePublishMulticast$b;->get()J
    ...
    .line 197
    .end local v11    # "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    :cond_3
    if-eqz v14, :cond_a
    ...
    iget-object v15, v0, Lrx/internal/operators/OnSubscribePublishMulticast;->producer:Lrx/g;
    ...
    .line 231
    invoke-interface {v15, v8, v9}, Lrx/g;->request(J)V
    ...
    .line 234
    .restart local v11    # "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    invoke-static {v11, v8, v9}, Lrx/internal/operators/a;->b(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    .line 216
    .restart local v11    # "inner":Lrx/internal/operators/OnSubscribePublishMulticast$b;, "Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    iget-object v0, v11, Lrx/internal/operators/OnSubscribePublishMulticast$b;->a:Lrx/l;
...
.method remove(Lrx/internal/operators/OnSubscribePublishMulticast$b;)V
    ...
    .line 343
    .local v0, "a":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    sget-object v5, Lrx/internal/operators/OnSubscribePublishMulticast;->TERMINATED:[Lrx/internal/operators/OnSubscribePublishMulticast$b;

    if-eq v0, v5, :cond_0

    sget-object v5, Lrx/internal/operators/OnSubscribePublishMulticast;->EMPTY:[Lrx/internal/operators/OnSubscribePublishMulticast$b;
    ...
    check-cast v1, [Lrx/internal/operators/OnSubscribePublishMulticast$b;
    ...
    .line 370
    .end local v1    # "b":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    :cond_7
    add-int/lit8 v5, v4, -0x1

    new-array v1, v5, [Lrx/internal/operators/OnSubscribePublishMulticast$b;

    .line 371
    .restart local v1    # "b":[Lrx/internal/operators/OnSubscribePublishMulticast$b;, "[Lrx/internal/operators/OnSubscribePublishMulticast$b<TT;>;"
    const/4 v5, 0x0
...
.method setProducer(Lrx/g;)V
    ...
    .line 167
    .local p0, "this":Lrx/internal/operators/OnSubscribePublishMulticast;, "Lrx/internal/operators/OnSubscribePublishMulticast<TT;>;"
    iput-object p1, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->producer:Lrx/g;
...
.method public subscriber()Lrx/l;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
